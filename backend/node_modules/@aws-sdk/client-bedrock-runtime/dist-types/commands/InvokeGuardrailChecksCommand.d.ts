...
declare const InvokeGuardrailChecksCommand_base: {
    new (input: InvokeGuardrailChecksCommandInput): import("@smithy/core/client").CommandImpl<InvokeGuardrailChecksCommandInput, InvokeGuardrailChecksCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: InvokeGuardrailChecksCommandInput): import("@smithy/core/client").CommandImpl<InvokeGuardrailChecksCommandInput, InvokeGuardrailChecksCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
