...
declare const ConverseStreamCommand_base: {
    new (input: ConverseStreamCommandInput): import("@smithy/core/client").CommandImpl<ConverseStreamCommandInput, ConverseStreamCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ConverseStreamCommandInput): import("@smithy/core/client").CommandImpl<ConverseStreamCommandInput, ConverseStreamCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
