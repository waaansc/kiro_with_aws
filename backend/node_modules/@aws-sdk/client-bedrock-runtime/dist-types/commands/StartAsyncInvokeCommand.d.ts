...
declare const StartAsyncInvokeCommand_base: {
    new (input: StartAsyncInvokeCommandInput): import("@smithy/core/client").CommandImpl<StartAsyncInvokeCommandInput, StartAsyncInvokeCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartAsyncInvokeCommandInput): import("@smithy/core/client").CommandImpl<StartAsyncInvokeCommandInput, StartAsyncInvokeCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
