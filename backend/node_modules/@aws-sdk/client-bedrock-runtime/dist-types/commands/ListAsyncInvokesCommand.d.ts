...
declare const ListAsyncInvokesCommand_base: {
    new (input: ListAsyncInvokesCommandInput): import("@smithy/core/client").CommandImpl<ListAsyncInvokesCommandInput, ListAsyncInvokesCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAsyncInvokesCommandInput]): import("@smithy/core/client").CommandImpl<ListAsyncInvokesCommandInput, ListAsyncInvokesCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
