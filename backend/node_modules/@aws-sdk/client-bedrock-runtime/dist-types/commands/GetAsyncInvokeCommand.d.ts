...
declare const GetAsyncInvokeCommand_base: {
    new (input: GetAsyncInvokeCommandInput): import("@smithy/core/client").CommandImpl<GetAsyncInvokeCommandInput, GetAsyncInvokeCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAsyncInvokeCommandInput): import("@smithy/core/client").CommandImpl<GetAsyncInvokeCommandInput, GetAsyncInvokeCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
