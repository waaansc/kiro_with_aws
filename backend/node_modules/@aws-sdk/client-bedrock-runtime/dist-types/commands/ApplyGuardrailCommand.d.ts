...
declare const ApplyGuardrailCommand_base: {
    new (input: ApplyGuardrailCommandInput): import("@smithy/core/client").CommandImpl<ApplyGuardrailCommandInput, ApplyGuardrailCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ApplyGuardrailCommandInput): import("@smithy/core/client").CommandImpl<ApplyGuardrailCommandInput, ApplyGuardrailCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
