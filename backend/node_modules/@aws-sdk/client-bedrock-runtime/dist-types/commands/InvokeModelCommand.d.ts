...
declare const InvokeModelCommand_base: {
    new (input: InvokeModelCommandInput): import("@smithy/core/client").CommandImpl<InvokeModelCommandInput, InvokeModelCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: InvokeModelCommandInput): import("@smithy/core/client").CommandImpl<InvokeModelCommandInput, InvokeModelCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
