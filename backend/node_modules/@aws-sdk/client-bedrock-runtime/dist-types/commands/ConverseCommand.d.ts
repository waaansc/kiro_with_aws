...
declare const ConverseCommand_base: {
    new (input: ConverseCommandInput): import("@smithy/core/client").CommandImpl<ConverseCommandInput, ConverseCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ConverseCommandInput): import("@smithy/core/client").CommandImpl<ConverseCommandInput, ConverseCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
