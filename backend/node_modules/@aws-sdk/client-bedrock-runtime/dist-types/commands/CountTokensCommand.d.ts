...
declare const CountTokensCommand_base: {
    new (input: CountTokensCommandInput): import("@smithy/core/client").CommandImpl<CountTokensCommandInput, CountTokensCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CountTokensCommandInput): import("@smithy/core/client").CommandImpl<CountTokensCommandInput, CountTokensCommandOutput, import("..").BedrockRuntimeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
