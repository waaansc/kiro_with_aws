...
export declare const getRuntimeConfig: (config: BedrockRuntimeClientConfig) => {
    ...
    requestHandler: import("@smithy/types").FetchHttpHandlerOptions | import("@smithy/types").NodeHttpHandlerOptions | Record<string, unknown> | import("@aws-sdk/middleware-websocket").WebSocketFetchHandler | (import("@smithy/types").RequestHandler<any, any, import("@smithy/types").HttpHandlerOptions> & import("@smithy/types").RequestHandler<import("@smithy/core/transport").HttpRequest, import("@smithy/core/transport").HttpResponse, import("@smithy/types").HttpHandlerOptions> & {
