...
export declare class ItemCollectionSizeLimitExceededException extends __BaseException {
  ...
  readonly $fault: "client";
  constructor(
    opts: __ExceptionOptionType<ItemCollectionSizeLimitExceededException, __BaseException>,
  );
}
...
export declare class PointInTimeRecoveryUnavailableException extends __BaseException {
  ...
  readonly $fault: "client";
  constructor(
    opts: __ExceptionOptionType<PointInTimeRecoveryUnavailableException, __BaseException>,
  );
}
