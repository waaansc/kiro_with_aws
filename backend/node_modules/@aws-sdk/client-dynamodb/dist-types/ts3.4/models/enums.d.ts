...
export declare const VectorDistanceFunction: {
  readonly COSINE: "COSINE";
  readonly DOT_PRODUCT: "DOT_PRODUCT";
  readonly EUCLIDEAN: "EUCLIDEAN";
};
export type VectorDistanceFunction =
  (typeof VectorDistanceFunction)[keyof typeof VectorDistanceFunction];
export declare const SearchSchemaElementType: {
  readonly HASH: "HASH";
  readonly INLINE_FILTER: "INLINE_FILTER";
};
export type SearchSchemaElementType =
  (typeof SearchSchemaElementType)[keyof typeof SearchSchemaElementType];
