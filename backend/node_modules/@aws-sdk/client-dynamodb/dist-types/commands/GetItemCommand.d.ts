...
declare const GetItemCommand_base: {
    new (input: GetItemCommandInput): import("@smithy/core/client").CommandImpl<GetItemCommandInput, GetItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetItemCommandInput): import("@smithy/core/client").CommandImpl<GetItemCommandInput, GetItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
