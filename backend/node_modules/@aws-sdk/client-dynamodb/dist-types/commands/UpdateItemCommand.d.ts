...
declare const UpdateItemCommand_base: {
    new (input: UpdateItemCommandInput): import("@smithy/core/client").CommandImpl<UpdateItemCommandInput, UpdateItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateItemCommandInput): import("@smithy/core/client").CommandImpl<UpdateItemCommandInput, UpdateItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
