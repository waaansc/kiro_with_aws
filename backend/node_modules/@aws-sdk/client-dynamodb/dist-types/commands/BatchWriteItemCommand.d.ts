...
declare const BatchWriteItemCommand_base: {
    new (input: BatchWriteItemCommandInput): import("@smithy/core/client").CommandImpl<BatchWriteItemCommandInput, BatchWriteItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchWriteItemCommandInput): import("@smithy/core/client").CommandImpl<BatchWriteItemCommandInput, BatchWriteItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
