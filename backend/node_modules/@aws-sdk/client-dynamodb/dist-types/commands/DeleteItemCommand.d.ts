...
declare const DeleteItemCommand_base: {
    new (input: DeleteItemCommandInput): import("@smithy/core/client").CommandImpl<DeleteItemCommandInput, DeleteItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteItemCommandInput): import("@smithy/core/client").CommandImpl<DeleteItemCommandInput, DeleteItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
