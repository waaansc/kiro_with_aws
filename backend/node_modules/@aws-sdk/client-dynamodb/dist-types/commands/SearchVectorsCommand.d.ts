...
declare const SearchVectorsCommand_base: {
    new (input: SearchVectorsCommandInput): import("@smithy/core/client").CommandImpl<SearchVectorsCommandInput, SearchVectorsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchVectorsCommandInput): import("@smithy/core/client").CommandImpl<SearchVectorsCommandInput, SearchVectorsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchVectorsCommand extends SearchVectorsCommand_base {
