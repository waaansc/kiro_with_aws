...
declare const DescribeBackupCommand_base: {
    new (input: DescribeBackupCommandInput): import("@smithy/core/client").CommandImpl<DescribeBackupCommandInput, DescribeBackupCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeBackupCommandInput): import("@smithy/core/client").CommandImpl<DescribeBackupCommandInput, DescribeBackupCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
