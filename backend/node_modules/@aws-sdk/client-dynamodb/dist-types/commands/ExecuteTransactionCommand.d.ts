...
declare const ExecuteTransactionCommand_base: {
    new (input: ExecuteTransactionCommandInput): import("@smithy/core/client").CommandImpl<ExecuteTransactionCommandInput, ExecuteTransactionCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExecuteTransactionCommandInput): import("@smithy/core/client").CommandImpl<ExecuteTransactionCommandInput, ExecuteTransactionCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
