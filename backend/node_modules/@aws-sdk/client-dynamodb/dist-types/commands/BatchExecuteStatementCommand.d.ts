...
declare const BatchExecuteStatementCommand_base: {
    new (input: BatchExecuteStatementCommandInput): import("@smithy/core/client").CommandImpl<BatchExecuteStatementCommandInput, BatchExecuteStatementCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchExecuteStatementCommandInput): import("@smithy/core/client").CommandImpl<BatchExecuteStatementCommandInput, BatchExecuteStatementCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
