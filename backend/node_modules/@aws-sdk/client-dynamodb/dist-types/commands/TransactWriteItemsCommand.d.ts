...
declare const TransactWriteItemsCommand_base: {
    new (input: TransactWriteItemsCommandInput): import("@smithy/core/client").CommandImpl<TransactWriteItemsCommandInput, TransactWriteItemsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TransactWriteItemsCommandInput): import("@smithy/core/client").CommandImpl<TransactWriteItemsCommandInput, TransactWriteItemsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
