...
declare const TransactGetItemsCommand_base: {
    new (input: TransactGetItemsCommandInput): import("@smithy/core/client").CommandImpl<TransactGetItemsCommandInput, TransactGetItemsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TransactGetItemsCommandInput): import("@smithy/core/client").CommandImpl<TransactGetItemsCommandInput, TransactGetItemsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
