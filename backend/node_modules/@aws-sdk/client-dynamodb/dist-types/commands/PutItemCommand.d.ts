...
declare const PutItemCommand_base: {
    new (input: PutItemCommandInput): import("@smithy/core/client").CommandImpl<PutItemCommandInput, PutItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutItemCommandInput): import("@smithy/core/client").CommandImpl<PutItemCommandInput, PutItemCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
