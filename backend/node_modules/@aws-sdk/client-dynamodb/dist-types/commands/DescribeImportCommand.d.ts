...
declare const DescribeImportCommand_base: {
    new (input: DescribeImportCommandInput): import("@smithy/core/client").CommandImpl<DescribeImportCommandInput, DescribeImportCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImportCommandInput): import("@smithy/core/client").CommandImpl<DescribeImportCommandInput, DescribeImportCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
