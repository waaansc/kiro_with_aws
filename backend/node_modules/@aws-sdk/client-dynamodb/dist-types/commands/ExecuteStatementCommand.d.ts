...
declare const ExecuteStatementCommand_base: {
    new (input: ExecuteStatementCommandInput): import("@smithy/core/client").CommandImpl<ExecuteStatementCommandInput, ExecuteStatementCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExecuteStatementCommandInput): import("@smithy/core/client").CommandImpl<ExecuteStatementCommandInput, ExecuteStatementCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
