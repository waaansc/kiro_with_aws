...
declare const ImportTableCommand_base: {
    new (input: ImportTableCommandInput): import("@smithy/core/client").CommandImpl<ImportTableCommandInput, ImportTableCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportTableCommandInput): import("@smithy/core/client").CommandImpl<ImportTableCommandInput, ImportTableCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
