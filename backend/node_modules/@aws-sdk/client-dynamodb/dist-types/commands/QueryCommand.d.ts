...
declare const QueryCommand_base: {
    new (input: QueryCommandInput): import("@smithy/core/client").CommandImpl<QueryCommandInput, QueryCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: QueryCommandInput): import("@smithy/core/client").CommandImpl<QueryCommandInput, QueryCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
