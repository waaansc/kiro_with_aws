...
declare const ScanCommand_base: {
    new (input: ScanCommandInput): import("@smithy/core/client").CommandImpl<ScanCommandInput, ScanCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ScanCommandInput): import("@smithy/core/client").CommandImpl<ScanCommandInput, ScanCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
