...
declare const DescribeTableCommand_base: {
    new (input: DescribeTableCommandInput): import("@smithy/core/client").CommandImpl<DescribeTableCommandInput, DescribeTableCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTableCommandInput): import("@smithy/core/client").CommandImpl<DescribeTableCommandInput, DescribeTableCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
