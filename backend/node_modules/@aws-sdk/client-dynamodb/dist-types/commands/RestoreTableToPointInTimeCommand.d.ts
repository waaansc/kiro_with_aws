...
declare const RestoreTableToPointInTimeCommand_base: {
    new (input: RestoreTableToPointInTimeCommandInput): import("@smithy/core/client").CommandImpl<RestoreTableToPointInTimeCommandInput, RestoreTableToPointInTimeCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreTableToPointInTimeCommandInput): import("@smithy/core/client").CommandImpl<RestoreTableToPointInTimeCommandInput, RestoreTableToPointInTimeCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
