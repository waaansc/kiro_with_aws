...
import { AggregatorV2Reference, AutomationRuleReference, AutomationRuleV2Reference, ConfigurationPolicyReference, ConnectorReference, ConnectorV2Reference, DelegatedAdminReference, FindingAggregatorReference, HubReference, HubV2Reference, IAggregatorV2Ref, IAutomationRuleRef, IAutomationRuleV2Ref, IConfigurationPolicyRef, IConnectorRef, IConnectorV2Ref, IDelegatedAdminRef, IFindingAggregatorRef, IHubRef, IHubV2Ref, IInsightRef, InsightReference, IOrganizationConfigurationRef, IPolicyAssociationRef, IProductSubscriptionRef, ISecurityControlRef, IStandardRef, OrganizationConfigurationReference, PolicyAssociationReference, ProductSubscriptionReference, SecurityControlReference, StandardReference } from "../../interfaces/generated/aws-securityhub-interfaces.generated";
/**
...
export declare class CfnAutomationRule extends cdk.CfnResource implements cdk.IInspectable, IAutomationRuleRef, cdk.ITaggableV2 {
     ...
     * One or more actions to update finding fields if a finding matches the conditions specified in `Criteria` .
     */
    get actions(): Array<CfnAutomationRule.AutomationRulesActionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * One or more actions to update finding fields if a finding matches the conditions specified in `Criteria` .
     */
    set actions(value: Array<CfnAutomationRule.AutomationRulesActionProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * A set of [AWS Security Finding Format (ASFF)](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-findings-format.html) finding field attributes and corresponding expected values that Security Hub CSPM uses to filter findings. If a rule is enabled and a finding matches the criteria specified in this parameter, Security Hub CSPM applies the rule action to the finding.
     */
    get criteria(): CfnAutomationRule.AutomationRulesFindingFiltersProperty | cdk.IResolvable;
    /**
     * A set of [AWS Security Finding Format (ASFF)](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-findings-format.html) finding field attributes and corresponding expected values that Security Hub CSPM uses to filter findings. If a rule is enabled and a finding matches the criteria specified in this parameter, Security Hub CSPM applies the rule action to the finding.
     */
    set criteria(value: CfnAutomationRule.AutomationRulesFindingFiltersProperty | cdk.IResolvable);
    /**
     * A description of the rule.
     */
     ...
     * Specifies whether a rule is the last to be applied with respect to a finding that matches the rule criteria.
     */
    get isTerminal(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether a rule is the last to be applied with respect to a finding that matches the rule criteria.
     */
    set isTerminal(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the rule.
     */
    get ruleName(): string;
     ...
     * Whether the rule is active after it is created.
     */
    get ruleStatus(): string | undefined;
    /**
     * Whether the rule is active after it is created.
     */
    set ruleStatus(value: string | undefined);
    /**
     * User-defined tags associated with an automation rule.
     */
...
export declare class CfnHub extends cdk.CfnResource implements cdk.IInspectable, IHubRef, cdk.ITaggable {
     ...
     */
    static isCfnHub(x: any): x is CfnHub;
    static arnForHub(resource: IHubRef): string;
    /**
     ...
     * Whether to automatically enable new controls when they are added to standards that are enabled.
     */
    get autoEnableControls(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether to automatically enable new controls when they are added to standards that are enabled.
     */
    set autoEnableControls(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies whether an account has consolidated control findings turned on or off.
     */
    get controlFindingGenerator(): string | undefined;
    /**
     * Specifies whether an account has consolidated control findings turned on or off.
     */
    set controlFindingGenerator(value: string | undefined);
    /**
     * Whether to enable the security standards that Security Hub CSPM has designated as automatically enabled.
     */
    get enableDefaultStandards(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether to enable the security standards that Security Hub CSPM has designated as automatically enabled.
     */
    set enableDefaultStandards(value: boolean | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
...
export declare class CfnStandard extends cdk.CfnResource implements cdk.IInspectable, IStandardRef {
     ...
     */
    static isCfnStandard(x: any): x is CfnStandard;
    /**
     * Specifies which controls are to be disabled in a standard.
     */
    private _disabledStandardsControls?;
    /**
     ...
     * Specifies which controls are to be disabled in a standard.
     */
    get disabledStandardsControls(): Array<cdk.IResolvable | CfnStandard.StandardsControlProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies which controls are to be disabled in a standard.
     */
    set disabledStandardsControls(value: Array<cdk.IResolvable | CfnStandard.StandardsControlProperty> | cdk.IResolvable | undefined);
    /**
     * The ARN of the standard that you want to enable.
     */
     ...
     */
    get attrStandardsSubscriptionArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnAggregatorV2 extends cdk.CfnResource implements cdk.IInspectable, IAggregatorV2Ref, cdk.ITaggableV2 {
     ...
     */
    static isCfnAggregatorV2(x: any): x is CfnAggregatorV2;
    static arnForAggregatorV2(resource: IAggregatorV2Ref): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * The list of Regions that are linked to the aggregation Region.
     */
    get linkedRegions(): Array<string>;
    /**
     * The list of Regions that are linked to the aggregation Region.
     */
    set linkedRegions(value: Array<string>);
    /**
     * Determines how Regions are linked to an Aggregator V2.
     */
...
export declare class CfnAutomationRuleV2 extends cdk.CfnResource implements cdk.IInspectable, IAutomationRuleV2Ref, cdk.ITaggableV2 {
     ...
     */
    static isCfnAutomationRuleV2(x: any): x is CfnAutomationRuleV2;
    /**
     ...
     * A list of actions to be performed when the rule criteria is met.
     */
    get actions(): Array<CfnAutomationRuleV2.AutomationRulesActionV2Property | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A list of actions to be performed when the rule criteria is met.
     */
    set actions(value: Array<CfnAutomationRuleV2.AutomationRulesActionV2Property | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The filtering type and configuration of the automation rule.
     */
    get criteria(): CfnAutomationRuleV2.CriteriaProperty | cdk.IResolvable;
    /**
     * The filtering type and configuration of the automation rule.
     */
    set criteria(value: CfnAutomationRuleV2.CriteriaProperty | cdk.IResolvable);
    /**
     * A description of the V2 automation rule.
     */
    get description(): string;
...
export declare class CfnConfigurationPolicy extends cdk.CfnResource implements cdk.IInspectable, IConfigurationPolicyRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnConfigurationPolicy(x: any): x is CfnConfigurationPolicy;
    static arnForConfigurationPolicy(resource: IConfigurationPolicyRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * An object that defines how AWS Security Hub CSPM is configured.
     */
    get configurationPolicy(): cdk.IResolvable | CfnConfigurationPolicy.PolicyProperty;
    /**
     * An object that defines how AWS Security Hub CSPM is configured.
     */
    set configurationPolicy(value: cdk.IResolvable | CfnConfigurationPolicy.PolicyProperty);
    /**
     * The description of the configuration policy.
     */
     ...
     */
    get attrServiceEnabled(): cdk.IResolvable;
    /**
 ...
 *
 * @cloudformationResource AWS::SecurityHub::Connector
 * @stability external
...
export declare class CfnConnector extends cdk.CfnResource implements cdk.IInspectable, IConnectorRef, cdk.ITaggableV2 {
     ...
     */
    set name(value: string);
    get provider(): cdk.IResolvable | CfnConnector.ProviderProperty;
    set provider(value: cdk.IResolvable | CfnConnector.ProviderProperty);
    /**
     * A key-value pair to associate with a resource.
     */
    get tags(): Record<string, string> | undefined;
     ...
     */
    get attrEnablementStatus(): string;
    /**
     * @cloudformationAttribute Issues
     */
    get attrIssues(): cdk.IResolvable;
    /**
     * The timestamp formatted in ISO8601
     *
     * @cloudformationAttribute LastCheckedAt
     */
    get attrLastCheckedAt(): string;
    /**
     * The timestamp formatted in ISO8601
     *
...
export declare namespace CfnConnector {
    ...
    interface ProviderProperty {
         ...
         */
        readonly azure: CfnConnector.AzureProviderConfigurationProperty | cdk.IResolvable;
    }
    /**
     * The configuration for connecting to an Azure environment.
     *
    ...
    interface AzureProviderConfigurationProperty {
         ...
         */
        readonly azureRegions: Array<string>;
        /**
         ...
         */
        readonly scopeConfiguration: CfnConnector.AzureScopeConfigurationProperty | cdk.IResolvable;
    }
    /**
     * The scope configuration for an Azure connector, defining the tenant or subscription scope.
     *
    ...
    interface AzureScopeConfigurationProperty {
         ...
         */
        readonly scopeValues?: Array<string>;
    }
    /**
...
export interface CfnConnectorProps {
     ...
     */
    readonly provider: cdk.IResolvable | CfnConnector.ProviderProperty;
    /**
     * A key-value pair to associate with a resource.
     *
 ...
 */
export declare class CfnConnectorV2 extends cdk.CfnResource implements cdk.IInspectable, IConnectorV2Ref, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnConnectorV2 from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnConnectorV2;
    /**
     * Checks whether the given object is a CfnConnectorV2
     */
    static isCfnConnectorV2(x: any): x is CfnConnectorV2;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnConnectorV2Props);
    get connectorV2Ref(): ConnectorV2Reference;
    /**
     * The description of the connectorV2.
     */
    get description(): string | undefined;
     ...
     * The third-party provider detail for a service configuration.
     */
    get provider(): cdk.IResolvable | CfnConnectorV2.ProviderProperty;
    /**
     * The third-party provider detail for a service configuration.
     */
    set provider(value: cdk.IResolvable | CfnConnectorV2.ProviderProperty);
    /**
     * The tags to add to the connectorV2 when you create.
     */
    get tags(): Record<string, string> | undefined;
     ...
     */
    get attrEnablementStatusReason(): string;
    /**
...
export declare namespace CfnConnectorV2 {
    /**
     * The third-party provider detail for a service configuration.
     *
     * @struct
    ...
    interface ProviderProperty {
         ...
         */
        readonly azure?: CfnConnectorV2.AzureProviderConfigurationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly jiraCloud?: cdk.IResolvable | CfnConnectorV2.JiraCloudProviderConfigurationProperty;
        /**
         ...
         */
        readonly serviceNow?: cdk.IResolvable | CfnConnectorV2.ServiceNowProviderConfigurationProperty;
    }
    /**
     ...
     */
    interface JiraCloudProviderConfigurationProperty {
        /**
    ...
    interface AzureProviderConfigurationProperty {
         ...
         */
        readonly scopeConfiguration: CfnConnectorV2.AzureScopeConfigurationProperty | cdk.IResolvable;
    }
    /**
     * The scope configuration for an Azure connector.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-securityhub-connectorv2.html
 */
export interface CfnConnectorV2Props {
    /**
     * The description of the connectorV2.
     *
     ...
     */
    readonly provider: cdk.IResolvable | CfnConnectorV2.ProviderProperty;
    /**
     * The tags to add to the connectorV2 when you create.
     *
...
export declare class CfnDelegatedAdmin extends cdk.CfnResource implements cdk.IInspectable, IDelegatedAdminRef {
     ...
     */
    static isCfnDelegatedAdmin(x: any): x is CfnDelegatedAdmin;
    /**
     ...
     */
    get attrDelegatedAdminIdentifier(): string;
    /**
...
export declare class CfnFindingAggregator extends cdk.CfnResource implements cdk.IInspectable, IFindingAggregatorRef {
     ...
     */
    static isCfnFindingAggregator(x: any): x is CfnFindingAggregator;
    static arnForFindingAggregator(resource: IFindingAggregatorRef): string;
    /**
     ...
     * If `RegionLinkingMode` is `ALL_REGIONS_EXCEPT_SPECIFIED` , then this is a space-separated list of Regions that do not aggregate findings to the aggregation Region.
     */
    get regions(): Array<string> | undefined;
    /**
     * If `RegionLinkingMode` is `ALL_REGIONS_EXCEPT_SPECIFIED` , then this is a space-separated list of Regions that do not aggregate findings to the aggregation Region.
     */
    set regions(value: Array<string> | undefined);
    /**
     ...
     */
    get attrFindingAggregationRegion(): string;
    /**
     * The ARN of the finding aggregator. You use the finding aggregator ARN to retrieve details for, update, and delete the finding aggregator.
     *
     * @cloudformationAttribute FindingAggregatorArn
     */
    get attrFindingAggregatorArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnHubV2 extends cdk.CfnResource implements cdk.IInspectable, IHubV2Ref, cdk.ITaggableV2 {
     ...
     */
    static isCfnHubV2(x: any): x is CfnHubV2;
    static arnForHubV2(resource: IHubV2Ref): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
...
export declare class CfnInsight extends cdk.CfnResource implements cdk.IInspectable, IInsightRef {
     ...
     */
    static isCfnInsight(x: any): x is CfnInsight;
    static arnForInsight(resource: IInsightRef): string;
    /**
     ...
     * One or more attributes used to filter the findings included in the insight.
     */
    get filters(): CfnInsight.AwsSecurityFindingFiltersProperty | cdk.IResolvable;
    /**
     * One or more attributes used to filter the findings included in the insight.
     */
    set filters(value: CfnInsight.AwsSecurityFindingFiltersProperty | cdk.IResolvable);
    /**
     * The grouping attribute for the insight's findings.
     */
...
export declare class CfnOrganizationConfiguration extends cdk.CfnResource implements cdk.IInspectable, IOrganizationConfigurationRef {
     ...
     */
    static isCfnOrganizationConfiguration(x: any): x is CfnOrganizationConfiguration;
    /**
     ...
     * Whether to automatically enable Security Hub CSPM in new member accounts when they join the organization.
     */
    get autoEnable(): boolean | cdk.IResolvable;
    /**
     * Whether to automatically enable Security Hub CSPM in new member accounts when they join the organization.
     */
    set autoEnable(value: boolean | cdk.IResolvable);
    /**
     * Whether to automatically enable Security Hub CSPM [default standards](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-standards-enable-disable.html) in new member accounts when they join the organization.
     */
    get autoEnableStandards(): string | undefined;
    /**
     * Whether to automatically enable Security Hub CSPM [default standards](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-standards-enable-disable.html) in new member accounts when they join the organization.
     */
    set autoEnableStandards(value: string | undefined);
    /**
     * Indicates whether the organization uses local or central configuration.
     */
     ...
     * Indicates whether the organization uses local or central configuration.
     */
    set configurationType(value: string | undefined);
    /**
     ...
     */
    get attrMemberAccountLimitReached(): cdk.IResolvable;
    /**
     ...
     */
    get attrOrganizationConfigurationIdentifier(): string;
    /**
...
export declare class CfnPolicyAssociation extends cdk.CfnResource implements cdk.IInspectable, IPolicyAssociationRef {
     ...
     */
    static isCfnPolicyAssociation(x: any): x is CfnPolicyAssociation;
    /**
     * The universally unique identifier (UUID) of the configuration policy.
     */
    private _configurationPolicyId;
    /**
     ...
     * The universally unique identifier (UUID) of the configuration policy.
     */
    get configurationPolicyId(): string;
    /**
     * The universally unique identifier (UUID) of the configuration policy.
     */
    set configurationPolicyId(value: string);
    /**
     * The identifier of the target account, organizational unit, or the root.
     */
    get targetId(): string;
     ...
     */
    get attrAssociationType(): string;
    /**
...
export declare class CfnProductSubscription extends cdk.CfnResource implements cdk.IInspectable, IProductSubscriptionRef {
     ...
     */
    static isCfnProductSubscription(x: any): x is CfnProductSubscription;
    static arnForProductSubscription(resource: IProductSubscriptionRef): string;
    /**
     ...
     */
    get attrProductSubscriptionArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnSecurityControl extends cdk.CfnResource implements cdk.IInspectable, ISecurityControlRef {
     ...
     */
    static isCfnSecurityControl(x: any): x is CfnSecurityControl;
    /**
     ...
     * The most recent reason for updating the customizable properties of a security control.
     */
    get lastUpdateReason(): string | undefined;
    /**
     * The most recent reason for updating the customizable properties of a security control.
     */
    set lastUpdateReason(value: string | undefined);
    /**
     * An object that identifies the name of a control parameter, its current value, and whether it has been customized.
     */
    get parameters(): cdk.IResolvable | Record<string, cdk.IResolvable | CfnSecurityControl.ParameterConfigurationProperty>;
    /**
     * An object that identifies the name of a control parameter, its current value, and whether it has been customized.
     */
    set parameters(value: cdk.IResolvable | Record<string, cdk.IResolvable | CfnSecurityControl.ParameterConfigurationProperty>);
    /**
     * The Amazon Resource Name (ARN) for a security control across standards, such as `arn:aws:securityhub:eu-central-1:123456789012:security-control/S3.1` . This parameter doesn't mention a specific standard.
     */
    get securityControlArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) for a security control across standards, such as `arn:aws:securityhub:eu-central-1:123456789012:security-control/S3.1` . This parameter doesn't mention a specific standard.
     */
    set securityControlArn(value: string | undefined);
    /**
     * The unique identifier of a security control across standards.
     */
    get securityControlId(): string | undefined;
    /**
     * The unique identifier of a security control across standards.
     */
    set securityControlId(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IHubRef, HubReference };
export type { IStandardRef, StandardReference };
export type { IAggregatorV2Ref, AggregatorV2Reference };
export type { IAutomationRuleV2Ref, AutomationRuleV2Reference };
export type { IConfigurationPolicyRef, ConfigurationPolicyReference };
export type { IConnectorRef, ConnectorReference };
export type { IConnectorV2Ref, ConnectorV2Reference };
export type { IDelegatedAdminRef, DelegatedAdminReference };
export type { IFindingAggregatorRef, FindingAggregatorReference };
export type { IHubV2Ref, HubV2Reference };
export type { IInsightRef, InsightReference };
export type { IOrganizationConfigurationRef, OrganizationConfigurationReference };
export type { IPolicyAssociationRef, PolicyAssociationReference };
export type { IProductSubscriptionRef, ProductSubscriptionReference };
export type { ISecurityControlRef, SecurityControlReference };
