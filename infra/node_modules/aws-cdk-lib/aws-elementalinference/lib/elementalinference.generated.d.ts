...
import { DictionaryReference, FeedReference, IDictionaryRef, IFeedRef } from "../../interfaces/generated/aws-elementalinference-interfaces.generated";
/**
 ...
 */
export declare class CfnDictionary extends cdk.CfnResource implements cdk.IInspectable, IDictionaryRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnDictionary from CloudFormation properties
     *
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDictionary;
    /**
     * Checks whether the given object is a CfnDictionary
     */
    static isCfnDictionary(x: any): x is CfnDictionary;
    static arnForDictionary(resource: IDictionaryRef): string;
    /**
    ...
    get dictionaryRef(): DictionaryReference;
    get entries(): string | undefined;
    set entries(value: string | undefined);
    get language(): string;
 ...
 */
export declare class CfnFeed extends cdk.CfnResource implements cdk.IInspectable, IFeedRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnFeed from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnFeed;
    /**
     * Checks whether the given object is a CfnFeed
     */
    static isCfnFeed(x: any): x is CfnFeed;
    static arnForFeed(resource: IFeedRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnFeedProps);
    get feedRef(): FeedReference;
    get name(): string;
    set name(value: string);
    get outputs(): Array<CfnFeed.GetOutputProperty | cdk.IResolvable> | cdk.IResolvable;
    set outputs(value: Array<CfnFeed.GetOutputProperty | cdk.IResolvable> | cdk.IResolvable);
    get tags(): Record<string, string> | undefined;
    set tags(value: Record<string, string> | undefined);
    /**
     * @cloudformationAttribute Arn
     ...
     */
    get attrDataEndpoints(): Array<string>;
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare namespace CfnFeed {
    /**
     * @struct
     * @stability external
    ...
    interface GetOutputProperty {
         ...
         */
        readonly outputConfig: cdk.IResolvable | CfnFeed.OutputConfigProperty;
        /**
    ...
    interface OutputConfigProperty {
         ...
         */
        readonly clipping?: CfnFeed.ClippingConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly cropping?: any | cdk.IResolvable;
        /**
         ...
         */
        readonly subtitling?: cdk.IResolvable | CfnFeed.SubtitlingConfigProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface SubtitlingConfigProperty {
         ...
         */
        readonly aspectRatio?: CfnFeed.AspectRatioProperty | cdk.IResolvable;
        /**
...
export interface CfnFeedProps {
     ...
     */
    readonly outputs: Array<CfnFeed.GetOutputProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
...
export type { IDictionaryRef, DictionaryReference };
export type { IFeedRef, FeedReference };
