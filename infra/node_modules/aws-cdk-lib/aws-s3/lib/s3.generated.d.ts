...
export declare class CfnBucket extends cdk.CfnResource implements cdk.IInspectable, IBucketRef, cdk.ITaggable {
     ...
     */
    get attrMetadataConfigurationAnnotationTableConfigurationTableArn(): string;
    /**
     * The name of the annotation table.
     *
     * @cloudformationAttribute MetadataConfiguration.AnnotationTableConfiguration.TableName
     */
    get attrMetadataConfigurationAnnotationTableConfigurationTableName(): string;
    /**
...
export declare namespace CfnBucket {
    ...
    interface MetadataConfigurationProperty {
         ...
         */
        readonly annotationTableConfiguration?: CfnBucket.AnnotationTableConfigurationProperty | cdk.IResolvable;
        /**
         * The destination information for the S3 Metadata configuration.
         *
...
export declare class CfnBucketPolicy extends cdk.CfnResource implements cdk.IInspectable, IBucketPolicyRef {
     ...
     */
    static isCfnBucketPolicy(x: any): x is CfnBucketPolicy;
    /**
...
export declare class CfnMultiRegionAccessPoint extends cdk.CfnResource implements cdk.IInspectable, IMultiRegionAccessPointRef {
     ...
     */
    static isCfnMultiRegionAccessPoint(x: any): x is CfnMultiRegionAccessPoint;
    /**
     ...
     * The PublicAccessBlock configuration that you want to apply to this Multi-Region Access Point.
     */
    get publicAccessBlockConfiguration(): cdk.IResolvable | CfnMultiRegionAccessPoint.PublicAccessBlockConfigurationProperty | undefined;
    /**
     * The PublicAccessBlock configuration that you want to apply to this Multi-Region Access Point.
     */
    set publicAccessBlockConfiguration(value: cdk.IResolvable | CfnMultiRegionAccessPoint.PublicAccessBlockConfigurationProperty | undefined);
    /**
     * A collection of the Regions and buckets associated with the Multi-Region Access Point.
     */
    get regions(): Array<cdk.IResolvable | CfnMultiRegionAccessPoint.RegionProperty> | cdk.IResolvable;
    /**
     * A collection of the Regions and buckets associated with the Multi-Region Access Point.
     */
    set regions(value: Array<cdk.IResolvable | CfnMultiRegionAccessPoint.RegionProperty> | cdk.IResolvable);
    /**
...
export declare class CfnMultiRegionAccessPointPolicy extends cdk.CfnResource implements cdk.IInspectable, IMultiRegionAccessPointPolicyRef {
     ...
     */
    static isCfnMultiRegionAccessPointPolicy(x: any): x is CfnMultiRegionAccessPointPolicy;
    /**
     * The name of the Multi-Region Access Point.
     */
    private _mrapName;
     ...
     */
    get attrPolicyStatus(): cdk.IResolvable;
    /**
     * Specifies whether the policy is public or not.
     *
     * @cloudformationAttribute PolicyStatus.IsPublic
     */
    get attrPolicyStatusIsPublic(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnStorageLens extends cdk.CfnResource implements cdk.IInspectable, IStorageLensRef, cdk.ITaggable {
     ...
     */
    static isCfnStorageLens(x: any): x is CfnStorageLens;
    /**
     ...
     * This resource contains the details Amazon S3 Storage Lens configuration.
     */
    get storageLensConfiguration(): cdk.IResolvable | CfnStorageLens.StorageLensConfigurationProperty;
    /**
     * This resource contains the details Amazon S3 Storage Lens configuration.
     */
    set storageLensConfiguration(value: cdk.IResolvable | CfnStorageLens.StorageLensConfigurationProperty);
    /**
     * A set of tags (key–value pairs) to associate with the Storage Lens configuration.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrStorageLensConfigurationStorageLensArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnStorageLens {
    ...
    interface StorageLensConfigurationProperty {
         ...
         */
        readonly expandedPrefixesDataExport?: cdk.IResolvable | CfnStorageLens.StorageLensExpandedPrefixesDataExportProperty;
        /**
    ...
    interface AccountLevelProperty {
         ...
         */
        readonly advancedPerformanceMetrics?: CfnStorageLens.AdvancedPerformanceMetricsProperty | cdk.IResolvable;
        /**
    ...
    interface DataExportProperty {
         ...
         */
        readonly storageLensTableDestination?: cdk.IResolvable | CfnStorageLens.StorageLensTableDestinationProperty;
    }
    /**
     ...
     */
    interface StorageLensExpandedPrefixesDataExportProperty {
        /**
...
export declare class CfnAccessGrant extends cdk.CfnResource implements cdk.IInspectable, IAccessGrantRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnAccessGrant(x: any): x is CfnAccessGrant;
    static arnForAccessGrant(resource: IAccessGrantRef): string;
    /**
     ...
     * The configuration options of the grant location.
     */
    get accessGrantsLocationConfiguration(): CfnAccessGrant.AccessGrantsLocationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration options of the grant location.
     */
    set accessGrantsLocationConfiguration(value: CfnAccessGrant.AccessGrantsLocationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The ID of the registered location to which you are granting access.
     */
     ...
     * The Amazon Resource Name (ARN) of an AWS IAM Identity Center application associated with your Identity Center instance.
     */
    get applicationArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of an AWS IAM Identity Center application associated with your Identity Center instance.
     */
    set applicationArn(value: string | undefined);
    /**
     * The user, group, or role to which you are granting access.
     */
    get grantee(): CfnAccessGrant.GranteeProperty | cdk.IResolvable;
    /**
     * The user, group, or role to which you are granting access.
     */
    set grantee(value: CfnAccessGrant.GranteeProperty | cdk.IResolvable);
    /**
     * The type of access that you are granting to your S3 data, which can be set to one of the following values:  - `READ` – Grant read-only access to the S3 data.
     */
     ...
     * The type of `S3SubPrefix` .
     */
    get s3PrefixType(): string | undefined;
    /**
     * The type of `S3SubPrefix` .
     */
    set s3PrefixType(value: string | undefined);
    /**
     * The AWS resource tags that you are adding to the access grant.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnAccessGrantsInstance extends cdk.CfnResource implements cdk.IInspectable, IAccessGrantsInstanceRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnAccessGrantsInstance(x: any): x is CfnAccessGrantsInstance;
    static arnForAccessGrantsInstance(resource: IAccessGrantsInstanceRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * If you would like to associate your S3 Access Grants instance with an AWS IAM Identity Center instance, use this field to pass the Amazon Resource Name (ARN) of the AWS IAM Identity Center instance that you are associating with your S3 Access Grants instance.
     */
    get identityCenterArn(): string | undefined;
    /**
     * If you would like to associate your S3 Access Grants instance with an AWS IAM Identity Center instance, use this field to pass the Amazon Resource Name (ARN) of the AWS IAM Identity Center instance that you are associating with your S3 Access Grants instance.
     */
    set identityCenterArn(value: string | undefined);
    /**
     * The AWS resource tags that you are adding to the S3 Access Grants instance.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrAccessGrantsInstanceArn(): string;
    /**
     * The ID of the S3 Access Grants instance. The ID is `default` . You can have one S3 Access Grants instance per Region per account.
     *
     * @cloudformationAttribute AccessGrantsInstanceId
     */
    get attrAccessGrantsInstanceId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnAccessGrantsLocation extends cdk.CfnResource implements cdk.IInspectable, IAccessGrantsLocationRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnAccessGrantsLocation(x: any): x is CfnAccessGrantsLocation;
    static arnForAccessGrantsLocation(resource: IAccessGrantsLocationRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
...
export declare class CfnStorageLensGroup extends cdk.CfnResource implements cdk.IInspectable, IStorageLensGroupRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnStorageLensGroup(x: any): x is CfnStorageLensGroup;
    static arnForStorageLensGroup(resource: IStorageLensGroupRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * This property contains the criteria for the Storage Lens group data that is displayed.
     */
    get filter(): CfnStorageLensGroup.FilterProperty | cdk.IResolvable;
    /**
     * This property contains the criteria for the Storage Lens group data that is displayed.
     */
    set filter(value: CfnStorageLensGroup.FilterProperty | cdk.IResolvable);
    /**
     * This property contains the Storage Lens group name.
     */
    get name(): string;
     ...
     */
    get attrStorageLensGroupArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IBucketRef, BucketReference };
export type { IBucketPolicyRef, BucketPolicyReference };
export type { IMultiRegionAccessPointRef, MultiRegionAccessPointReference };
export type { IMultiRegionAccessPointPolicyRef, MultiRegionAccessPointPolicyReference };
export type { IStorageLensRef, StorageLensReference };
export type { IAccessGrantRef, AccessGrantReference };
export type { IAccessGrantsInstanceRef, AccessGrantsInstanceReference };
export type { IAccessGrantsLocationRef, AccessGrantsLocationReference };
export type { IStorageLensGroupRef, StorageLensGroupReference };
