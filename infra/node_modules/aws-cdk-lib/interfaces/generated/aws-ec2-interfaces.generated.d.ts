 ...
 * @stability experimental
 */
export interface ITransitGatewayPolicyTableRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a TransitGatewayPolicyTable resource.
     */
    readonly transitGatewayPolicyTableRef: TransitGatewayPolicyTableReference;
}
/**
 * A reference to a TransitGatewayPolicyTable resource.
 *
 ...
 * @stability external
 */
export interface TransitGatewayPolicyTableReference {
    /**
...
/**
 * Indicates that this resource can be referenced as a TransitGatewayPolicyTableAssociation.
 *
 * @stability experimental
 */
export interface ITransitGatewayPolicyTableAssociationRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a TransitGatewayPolicyTableAssociation resource.
     */
    readonly transitGatewayPolicyTableAssociationRef: TransitGatewayPolicyTableAssociationReference;
}
/**
 * A reference to a TransitGatewayPolicyTableAssociation resource.
 *
 ...
 * @stability external
 */
export interface TransitGatewayPolicyTableAssociationReference {
    /**
