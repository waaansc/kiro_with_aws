 ...
 * @stability experimental
 */
export interface IMicrovmImageRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a MicrovmImage resource.
     */
    readonly microvmImageRef: MicrovmImageReference;
}
/**
 * A reference to a MicrovmImage resource.
 *
 ...
 * @stability external
 */
export interface MicrovmImageReference {
    /**
 ...
 * @stability experimental
 */
export interface INetworkConnectorRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a NetworkConnector resource.
     */
    readonly networkConnectorRef: NetworkConnectorReference;
}
/**
 * A reference to a NetworkConnector resource.
 *
 ...
 * @stability external
 */
export interface NetworkConnectorReference {
    /**
