 ...
 * @stability experimental
 */
export interface IAllImageBuildVersionsRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a AllImageBuildVersions resource.
     */
    readonly allImageBuildVersionsRef: AllImageBuildVersionsReference;
}
/**
 * A reference to a AllImageBuildVersions resource.
 *
 ...
 * @stability external
 */
export interface AllImageBuildVersionsReference {
    /**
     * The Arn of the AllImageBuildVersions resource.
     */
    readonly allImageBuildVersionsArn: string;
}
/**
 * Indicates that this resource can be referenced as a AllWorkflowBuildVersions.
 *
 * @stability experimental
 */
export interface IAllWorkflowBuildVersionsRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a AllWorkflowBuildVersions resource.
     */
    readonly allWorkflowBuildVersionsRef: AllWorkflowBuildVersionsReference;
}
/**
 * A reference to a AllWorkflowBuildVersions resource.
 *
 ...
 * @stability external
 */
export interface AllWorkflowBuildVersionsReference {
    /**
     * The Arn of the AllWorkflowBuildVersions resource.
     */
    readonly allWorkflowBuildVersionsArn: string;
}
/**
 ...
 * @stability experimental
 */
export interface IWorkflowExecutionRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a WorkflowExecution resource.
     */
    readonly workflowExecutionRef: WorkflowExecutionReference;
}
/**
 * A reference to a WorkflowExecution resource.
 *
...
export interface WorkflowExecutionReference {
     ...
     */
    readonly workflowExecutionArn: string;
}
/**
 ...
 * @stability experimental
 */
export interface IWorkflowStepExecutionRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a WorkflowStepExecution resource.
     */
    readonly workflowStepExecutionRef: WorkflowStepExecutionReference;
}
/**
 * A reference to a WorkflowStepExecution resource.
 *
 ...
 * @stability external
 */
export interface WorkflowStepExecutionReference {
    /**
