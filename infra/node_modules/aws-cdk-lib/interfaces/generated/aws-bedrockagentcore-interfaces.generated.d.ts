 ...
 * @stability experimental
 */
export interface ICodeInterpreterRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a CodeInterpreter resource.
     */
    readonly codeInterpreterRef: CodeInterpreterReference;
}
/**
 * A reference to a CodeInterpreter resource.
 *
 ...
 * @stability external
 */
export interface CodeInterpreterReference {
    /**
 ...
 * @stability experimental
 */
export interface ITokenVaultRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a TokenVault resource.
     */
    readonly tokenVaultRef: TokenVaultReference;
}
/**
 * A reference to a TokenVault resource.
 *
 ...
 * @stability external
 */
export interface TokenVaultReference {
    /**
     * The Arn of the TokenVault resource.
     */
    readonly tokenVaultArn: string;
}
/**
