...
/**
 * Indicates that this resource can be referenced as a UserDefinedFunction.
 *
 * @stability experimental
 */
export interface IUserDefinedFunctionRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a UserDefinedFunction resource.
     */
    readonly userDefinedFunctionRef: UserDefinedFunctionReference;
}
/**
 * A reference to a UserDefinedFunction resource.
 *
 ...
 * @stability external
 */
export interface UserDefinedFunctionReference {
    /**
     * The Arn of the UserDefinedFunction resource.
     */
    readonly userDefinedFunctionArn: string;
}
