...
/**
 * Indicates that this resource can be referenced as a Replay.
 *
 * @stability experimental
 */
export interface IReplayRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a Replay resource.
     */
    readonly replayRef: ReplayReference;
}
/**
 * A reference to a Replay resource.
 *
