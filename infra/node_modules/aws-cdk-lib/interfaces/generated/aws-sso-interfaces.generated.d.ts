 ...
 * @stability experimental
 */
export interface IApplicationProviderRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ApplicationProvider resource.
     */
    readonly applicationProviderRef: ApplicationProviderReference;
}
/**
 * A reference to a ApplicationProvider resource.
 *
 ...
 * @stability external
 */
export interface ApplicationProviderReference {
    /**
