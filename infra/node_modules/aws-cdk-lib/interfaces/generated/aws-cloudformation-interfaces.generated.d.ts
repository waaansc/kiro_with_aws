 ...
 * @stability experimental
 */
export interface IGeneratedTemplateRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a GeneratedTemplate resource.
     */
    readonly generatedTemplateRef: GeneratedTemplateReference;
}
/**
 * A reference to a GeneratedTemplate resource.
 *
 ...
 * @stability external
 */
export interface GeneratedTemplateReference {
    /**
 ...
 * @stability experimental
 */
export interface IResourceScanRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ResourceScan resource.
     */
    readonly resourceScanRef: ResourceScanReference;
}
/**
 * A reference to a ResourceScan resource.
 *
 ...
 * @stability external
 */
export interface ResourceScanReference {
    /**
