 ...
 * @stability experimental
 */
export interface ISafetyLeverRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a SafetyLever resource.
     */
    readonly safetyLeverRef: SafetyLeverReference;
}
/**
 * A reference to a SafetyLever resource.
 *
 ...
 * @stability external
 */
export interface SafetyLeverReference {
    /**
     * The Arn of the SafetyLever resource.
     */
    readonly safetyLeverArn: string;
}
/**
