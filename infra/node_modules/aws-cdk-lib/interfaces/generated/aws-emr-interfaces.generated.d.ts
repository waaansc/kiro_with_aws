 ...
 * @stability experimental
 */
export interface INotebookExecutionRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a NotebookExecution resource.
     */
    readonly notebookExecutionRef: NotebookExecutionReference;
}
/**
 * A reference to a NotebookExecution resource.
 *
 ...
 * @stability external
 */
export interface NotebookExecutionReference {
    /**
     * The Arn of the NotebookExecution resource.
     */
    readonly notebookExecutionArn: string;
}
