 ...
 * @stability experimental
 */
export interface IReservedCacheNodeRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ReservedCacheNode resource.
     */
    readonly reservedCacheNodeRef: ReservedCacheNodeReference;
}
/**
 * A reference to a ReservedCacheNode resource.
 *
 ...
 * @stability external
 */
export interface ReservedCacheNodeReference {
    /**
