...
/**
 * Indicates that this resource can be referenced as a MultiRegionParameterGroup.
 *
 * @stability experimental
 */
export interface IMultiRegionParameterGroupRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a MultiRegionParameterGroup resource.
     */
    readonly multiRegionParameterGroupRef: MultiRegionParameterGroupReference;
}
/**
 * A reference to a MultiRegionParameterGroup resource.
 *
 ...
 * @stability external
 */
export interface MultiRegionParameterGroupReference {
    /**
     * The Arn of the MultiRegionParameterGroup resource.
     */
    readonly multiRegionParameterGroupArn: string;
}
/**
 ...
 * @stability experimental
 */
export interface IReservedNodeRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ReservedNode resource.
     */
    readonly reservedNodeRef: ReservedNodeReference;
}
/**
 * A reference to a ReservedNode resource.
 *
 ...
 * @stability external
 */
export interface ReservedNodeReference {
    /**
     * The Arn of the ReservedNode resource.
     */
    readonly reservedNodeArn: string;
}
