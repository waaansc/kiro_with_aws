 ...
 * @stability experimental
 */
export interface ISigningJobRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a SigningJob resource.
     */
    readonly signingJobRef: SigningJobReference;
}
/**
 * A reference to a SigningJob resource.
 *
 ...
 * @stability external
 */
export interface SigningJobReference {
    /**
