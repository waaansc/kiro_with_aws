 ...
 */
export interface ILensRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a Lens resource.
     */
    readonly lensRef: LensReference;
}
/**
 * A reference to a Lens resource.
 *
 ...
 * @stability experimental
 */
export interface IReviewTemplateRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ReviewTemplate resource.
     */
    readonly reviewTemplateRef: ReviewTemplateReference;
}
/**
 * A reference to a ReviewTemplate resource.
 *
 ...
 * @stability external
 */
export interface ReviewTemplateReference {
    /**
