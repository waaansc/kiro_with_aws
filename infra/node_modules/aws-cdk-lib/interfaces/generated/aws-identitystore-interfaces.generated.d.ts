 ...
 * @stability experimental
 */
export interface IAllGroupMembershipsRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a AllGroupMemberships resource.
     */
    readonly allGroupMembershipsRef: AllGroupMembershipsReference;
}
/**
 * A reference to a AllGroupMemberships resource.
 *
 ...
 * @stability external
 */
export interface AllGroupMembershipsReference {
    /**
     * The Arn of the AllGroupMemberships resource.
     */
    readonly allGroupMembershipsArn: string;
}
