...
/**
 * Indicates that this resource can be referenced as a HarvestJob.
 *
 * @stability experimental
 */
export interface IHarvestJobRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a HarvestJob resource.
     */
    readonly harvestJobRef: HarvestJobReference;
}
/**
 * A reference to a HarvestJob resource.
 *
 ...
 * @stability external
 */
export interface HarvestJobReference {
    /**
     * The Arn of the HarvestJob resource.
     */
    readonly harvestJobArn: string;
}
