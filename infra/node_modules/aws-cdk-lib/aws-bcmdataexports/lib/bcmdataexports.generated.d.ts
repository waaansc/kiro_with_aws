...
import { ExportReference, IExportRef, ITableRef, TableReference } from "../../interfaces/generated/aws-bcmdataexports-interfaces.generated";
/**
...
export declare class CfnExport extends cdk.CfnResource implements cdk.IInspectable, IExportRef, cdk.ITaggableV2 {
     ...
     * The details that are available for an export.
     */
    get export(): CfnExport.ExportProperty | cdk.IResolvable;
    /**
     * The details that are available for an export.
     */
    set export(value: CfnExport.ExportProperty | cdk.IResolvable);
    get tags(): Array<CfnExport.ResourceTagProperty> | undefined;
    set tags(value: Array<CfnExport.ResourceTagProperty> | undefined);
    /**
     ...
     */
    get attrExportExportArn(): string;
 ...
 *
 * @cloudformationResource AWS::BCMDataExports::Table
 * @stability external
...
export declare class CfnTable extends cdk.CfnResource implements cdk.IInspectable, ITableRef {
     ...
     */
    get attrSchema(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
