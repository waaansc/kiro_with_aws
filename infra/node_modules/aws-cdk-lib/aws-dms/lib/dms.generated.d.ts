...
import { CertificateReference, DataMigrationReference, DataProviderReference, EndpointReference, EventSubscriptionReference, ICertificateRef, IDataMigrationRef, IDataProviderRef, IEndpointRef, IEventSubscriptionRef, IInstanceProfileRef, IMigrationProjectRef, InstanceProfileReference, IReplicationConfigRef, IReplicationInstanceRef, IReplicationSubnetGroupRef, IReplicationTaskRef, MigrationProjectReference, ReplicationConfigReference, ReplicationInstanceReference, ReplicationSubnetGroupReference, ReplicationTaskReference } from "../../interfaces/generated/aws-dms-interfaces.generated";
/**
...
export declare class CfnCertificate extends cdk.CfnResource implements cdk.IInspectable, ICertificateRef {
     ...
     * A customer-assigned name for the certificate.
     */
    get certificateIdentifier(): string | undefined;
    /**
     * A customer-assigned name for the certificate.
     */
    set certificateIdentifier(value: string | undefined);
    /**
     * The contents of a `.pem` file, which contains an X.509 certificate.
     */
     ...
     * The location of an imported Oracle Wallet certificate for use with SSL.
     */
    get certificateWallet(): string | undefined;
    /**
     * The location of an imported Oracle Wallet certificate for use with SSL.
     */
    set certificateWallet(value: string | undefined);
    /**
     * The certificate Arn
     *
     * @cloudformationAttribute CertificateArn
     */
    get attrCertificateArn(): string;
...
export declare class CfnEndpoint extends cdk.CfnResource implements cdk.IInspectable, IEndpointRef, cdk.ITaggable {
     ...
     */
    static fromEndpointId(scope: constructs.Construct, id: string, endpointId: string): IEndpointRef;
     ...
     */
    private _docDbSettings?;
    /**
     * Settings in JSON format for the target Amazon DynamoDB endpoint.
     */
    private _dynamoDbSettings?;
    /**
     ...
     */
    private _gcpMySqlSettings?;
    /**
     * Settings in JSON format for the source IBM Db2 LUW endpoint.
     */
    private _ibmDb2Settings?;
    /**
     ...
     */
    private _microsoftSqlServerSettings?;
    /**
     ...
     * Settings in JSON format for the source and target DocumentDB endpoint.
     */
    get docDbSettings(): CfnEndpoint.DocDbSettingsProperty | cdk.IResolvable | undefined;
    /**
     * Settings in JSON format for the source and target DocumentDB endpoint.
     */
    set docDbSettings(value: CfnEndpoint.DocDbSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Settings in JSON format for the target Amazon DynamoDB endpoint.
     */
    get dynamoDbSettings(): CfnEndpoint.DynamoDbSettingsProperty | cdk.IResolvable | undefined;
    /**
     * Settings in JSON format for the target Amazon DynamoDB endpoint.
     */
    set dynamoDbSettings(value: CfnEndpoint.DynamoDbSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Settings in JSON format for the target OpenSearch endpoint.
     */
    get elasticsearchSettings(): CfnEndpoint.ElasticsearchSettingsProperty | cdk.IResolvable | undefined;
    /**
     * Settings in JSON format for the target OpenSearch endpoint.
     */
    set elasticsearchSettings(value: CfnEndpoint.ElasticsearchSettingsProperty | cdk.IResolvable | undefined);
    /**
     * The database endpoint identifier.
     */
    get endpointIdentifier(): string | undefined;
    /**
     * The database endpoint identifier.
     */
    set endpointIdentifier(value: string | undefined);
    /**
     * The type of endpoint.
     */
     ...
     * Settings in JSON format for the source GCP MySQL endpoint.
     */
    get gcpMySqlSettings(): CfnEndpoint.GcpMySQLSettingsProperty | cdk.IResolvable | undefined;
    /**
     * Settings in JSON format for the source GCP MySQL endpoint.
     */
    set gcpMySqlSettings(value: CfnEndpoint.GcpMySQLSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Settings in JSON format for the source IBM Db2 LUW endpoint.
     */
    get ibmDb2Settings(): CfnEndpoint.IbmDb2SettingsProperty | cdk.IResolvable | undefined;
    /**
     * Settings in JSON format for the source IBM Db2 LUW endpoint.
     */
    set ibmDb2Settings(value: CfnEndpoint.IbmDb2SettingsProperty | cdk.IResolvable | undefined);
    /**
     * Settings in JSON format for the target Apache Kafka endpoint.
     */
    get kafkaSettings(): cdk.IResolvable | CfnEndpoint.KafkaSettingsProperty | undefined;
    /**
     * Settings in JSON format for the target Apache Kafka endpoint.
     */
    set kafkaSettings(value: cdk.IResolvable | CfnEndpoint.KafkaSettingsProperty | undefined);
    /**
     * Settings in JSON format for the target endpoint for Amazon Kinesis Data Streams.
     */
    get kinesisSettings(): cdk.IResolvable | CfnEndpoint.KinesisSettingsProperty | undefined;
    /**
     * Settings in JSON format for the target endpoint for Amazon Kinesis Data Streams.
     */
    set kinesisSettings(value: cdk.IResolvable | CfnEndpoint.KinesisSettingsProperty | undefined);
    /**
     * An AWS  key identifier that is used to encrypt the connection parameters for the endpoint.
     */
     ...
     * Settings in JSON format for the source and target Microsoft SQL Server endpoint.
     */
    get microsoftSqlServerSettings(): cdk.IResolvable | CfnEndpoint.MicrosoftSqlServerSettingsProperty | undefined;
    /**
     * Settings in JSON format for the source and target Microsoft SQL Server endpoint.
     */
    set microsoftSqlServerSettings(value: cdk.IResolvable | CfnEndpoint.MicrosoftSqlServerSettingsProperty | undefined);
    /**
     * Settings in JSON format for the source MongoDB endpoint.
     */
    get mongoDbSettings(): cdk.IResolvable | CfnEndpoint.MongoDbSettingsProperty | undefined;
    /**
     * Settings in JSON format for the source MongoDB endpoint.
     */
    set mongoDbSettings(value: cdk.IResolvable | CfnEndpoint.MongoDbSettingsProperty | undefined);
    /**
     * Settings in JSON format for the source and target MySQL endpoint.
     */
    get mySqlSettings(): cdk.IResolvable | CfnEndpoint.MySqlSettingsProperty | undefined;
    /**
     * Settings in JSON format for the source and target MySQL endpoint.
     */
    set mySqlSettings(value: cdk.IResolvable | CfnEndpoint.MySqlSettingsProperty | undefined);
    /**
     * Settings in JSON format for the target Amazon Neptune endpoint.
     */
    get neptuneSettings(): cdk.IResolvable | CfnEndpoint.NeptuneSettingsProperty | undefined;
    /**
     * Settings in JSON format for the target Amazon Neptune endpoint.
     */
    set neptuneSettings(value: cdk.IResolvable | CfnEndpoint.NeptuneSettingsProperty | undefined);
    /**
     * Settings in JSON format for the source and target Oracle endpoint.
     */
    get oracleSettings(): cdk.IResolvable | CfnEndpoint.OracleSettingsProperty | undefined;
    /**
     * Settings in JSON format for the source and target Oracle endpoint.
     */
    set oracleSettings(value: cdk.IResolvable | CfnEndpoint.OracleSettingsProperty | undefined);
    /**
     * The password to be used to log in to the endpoint database.
     */
     ...
     * Settings in JSON format for the source and target PostgreSQL endpoint.
     */
    get postgreSqlSettings(): cdk.IResolvable | CfnEndpoint.PostgreSqlSettingsProperty | undefined;
    /**
     * Settings in JSON format for the source and target PostgreSQL endpoint.
     */
    set postgreSqlSettings(value: cdk.IResolvable | CfnEndpoint.PostgreSqlSettingsProperty | undefined);
    /**
     * Settings in JSON format for the target Redis endpoint.
     */
    get redisSettings(): cdk.IResolvable | CfnEndpoint.RedisSettingsProperty | undefined;
    /**
     * Settings in JSON format for the target Redis endpoint.
     */
    set redisSettings(value: cdk.IResolvable | CfnEndpoint.RedisSettingsProperty | undefined);
    /**
     * Settings in JSON format for the Amazon Redshift endpoint.
     */
    get redshiftSettings(): cdk.IResolvable | CfnEndpoint.RedshiftSettingsProperty | undefined;
    /**
     * Settings in JSON format for the Amazon Redshift endpoint.
     */
    set redshiftSettings(value: cdk.IResolvable | CfnEndpoint.RedshiftSettingsProperty | undefined);
    /**
     * A display name for the resource identifier at the end of the `EndpointArn` response parameter that is returned in the created `Endpoint` object.
     */
     ...
     * Settings in JSON format for the source and target Amazon S3 endpoint.
     */
    get s3Settings(): cdk.IResolvable | CfnEndpoint.S3SettingsProperty | undefined;
    /**
     * Settings in JSON format for the source and target Amazon S3 endpoint.
     */
    set s3Settings(value: cdk.IResolvable | CfnEndpoint.S3SettingsProperty | undefined);
    /**
     * The name of the server where the endpoint database resides.
     */
     ...
     * Settings in JSON format for the source and target SAP ASE endpoint.
     */
    get sybaseSettings(): cdk.IResolvable | CfnEndpoint.SybaseSettingsProperty | undefined;
    /**
     * Settings in JSON format for the source and target SAP ASE endpoint.
     */
    set sybaseSettings(value: cdk.IResolvable | CfnEndpoint.SybaseSettingsProperty | undefined);
    /**
     * One or more tags to be assigned to the endpoint.
     */
...
export declare class CfnReplicationConfig extends cdk.CfnResource implements cdk.IInspectable, IReplicationConfigRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnReplicationConfig(x: any): x is CfnReplicationConfig;
    static arnForReplicationConfig(resource: IReplicationConfigRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * Configuration parameters for provisioning an AWS DMS Serverless replication.
     */
    get computeConfig(): CfnReplicationConfig.ComputeConfigProperty | cdk.IResolvable;
    /**
     * Configuration parameters for provisioning an AWS DMS Serverless replication.
     */
    set computeConfig(value: CfnReplicationConfig.ComputeConfigProperty | cdk.IResolvable);
    /**
     * A unique identifier that you want to use to create a `ReplicationConfigArn` that is returned as part of the output from this action.
     */
     ...
     * Optional JSON settings for AWS DMS Serverless replications that are provisioned using this replication configuration.
     */
    get replicationSettings(): any | cdk.IResolvable | undefined;
    /**
     * Optional JSON settings for AWS DMS Serverless replications that are provisioned using this replication configuration.
     */
    set replicationSettings(value: any | cdk.IResolvable | undefined);
    /**
     * The type of AWS DMS Serverless replication to provision using this replication configuration.
     */
     ...
     * Optional JSON settings for specifying supplemental data.
     */
    get supplementalSettings(): any | cdk.IResolvable | undefined;
    /**
     * Optional JSON settings for specifying supplemental data.
     */
    set supplementalSettings(value: any | cdk.IResolvable | undefined);
    /**
     * JSON table mappings for AWS DMS Serverless replications that are provisioned using this replication configuration.
     */
    get tableMappings(): any | cdk.IResolvable;
    /**
     * JSON table mappings for AWS DMS Serverless replications that are provisioned using this replication configuration.
     */
    set tableMappings(value: any | cdk.IResolvable);
    /**
     * One or more optional tags associated with resources used by the AWS DMS Serverless replication.
     */
     ...
     */
    get attrReplicationConfigArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnReplicationInstance extends cdk.CfnResource implements cdk.IInspectable, IReplicationInstanceRef, cdk.ITaggable {
     ...
     */
    static isCfnReplicationInstance(x: any): x is CfnReplicationInstance;
    /**
     ...
     */
    private _replicationInstanceIdentifier?;
    /**
     * A subnet group to associate with the replication instance.
     */
    private _replicationSubnetGroupIdentifier?;
    /**
     * A display name for the resource identifier at the end of the `EndpointArn` response parameter that is returned in the created `Endpoint` object.
     */
    private _resourceIdentifier?;
     ...
     * The replication instance identifier. This parameter is stored as a lowercase string.
     */
    get replicationInstanceIdentifier(): string | undefined;
    /**
     * The replication instance identifier. This parameter is stored as a lowercase string.
     */
    set replicationInstanceIdentifier(value: string | undefined);
    /**
     * A subnet group to associate with the replication instance.
     */
    get replicationSubnetGroupIdentifier(): string | undefined;
    /**
     * A subnet group to associate with the replication instance.
     */
    set replicationSubnetGroupIdentifier(value: string | undefined);
    /**
     * A display name for the resource identifier at the end of the `EndpointArn` response parameter that is returned in the created `Endpoint` object.
     */
    get resourceIdentifier(): string | undefined;
     ...
     */
    get attrReplicationInstancePrivateIpAddresses(): string;
    /**
     * One or more public IP addresses for the replication instance.
     *
     * @cloudformationAttribute ReplicationInstancePublicIpAddresses
     */
    get attrReplicationInstancePublicIpAddresses(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnReplicationSubnetGroup extends cdk.CfnResource implements cdk.IInspectable, IReplicationSubnetGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnReplicationSubnetGroup(x: any): x is CfnReplicationSubnetGroup;
    /**
...
export declare class CfnReplicationTask extends cdk.CfnResource implements cdk.IInspectable, IReplicationTaskRef, cdk.ITaggable {
     ...
     */
    static isCfnReplicationTask(x: any): x is CfnReplicationTask;
    /**
     ...
     */
    private _replicationTaskIdentifier?;
    /**
     ...
     * Indicates when you want a change data capture (CDC) operation to start.
     */
    get cdcStartPosition(): string | undefined;
    /**
     * Indicates when you want a change data capture (CDC) operation to start.
     */
    set cdcStartPosition(value: string | undefined);
    /**
     * Indicates the start time for a change data capture (CDC) operation.
     */
    get cdcStartTime(): number | undefined;
    /**
     * Indicates the start time for a change data capture (CDC) operation.
     */
    set cdcStartTime(value: number | undefined);
    /**
     * Indicates when you want a change data capture (CDC) operation to stop.
     */
    get cdcStopPosition(): string | undefined;
    /**
     * Indicates when you want a change data capture (CDC) operation to stop.
     */
    set cdcStopPosition(value: string | undefined);
    /**
     * The migration type.
     */
     ...
     * An identifier for the replication task.
     */
    get replicationTaskIdentifier(): string | undefined;
    /**
     * An identifier for the replication task.
     */
    set replicationTaskIdentifier(value: string | undefined);
    /**
     * Overall settings for the task, in JSON format.
     */
     ...
     * Supplemental information that the task requires to migrate the data for certain source and target endpoints.
     */
    get taskData(): string | undefined;
    /**
     * Supplemental information that the task requires to migrate the data for certain source and target endpoints.
     */
    set taskData(value: string | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnDataMigration extends cdk.CfnResource implements cdk.IInspectable, IDataMigrationRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnDataMigration(x: any): x is CfnDataMigration;
    static arnForDataMigration(resource: IDataMigrationRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _dataMigrationIdentifier?;
    /**
     * The user-friendly name for the data migration.
     */
    private _dataMigrationName?;
    /**
     * Specifies CloudWatch settings and selection rules for the data migration.
     */
    private _dataMigrationSettings?;
    /**
     * Specifies whether the data migration is full-load only, change data capture (CDC) only, or full-load and CDC.
     */
    private _dataMigrationType;
    /**
     * The property describes an identifier for the migration project.
     */
    private _migrationProjectIdentifier;
    /**
     ...
     * The property describes an ARN of the data migration.
     */
    get dataMigrationIdentifier(): string | undefined;
    /**
     * The property describes an ARN of the data migration.
     */
    set dataMigrationIdentifier(value: string | undefined);
    /**
     * The user-friendly name for the data migration.
     */
    get dataMigrationName(): string | undefined;
    /**
     * The user-friendly name for the data migration.
     */
    set dataMigrationName(value: string | undefined);
    /**
     * Specifies CloudWatch settings and selection rules for the data migration.
     */
    get dataMigrationSettings(): CfnDataMigration.DataMigrationSettingsProperty | cdk.IResolvable | undefined;
    /**
     * Specifies CloudWatch settings and selection rules for the data migration.
     */
    set dataMigrationSettings(value: CfnDataMigration.DataMigrationSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Specifies whether the data migration is full-load only, change data capture (CDC) only, or full-load and CDC.
     */
    get dataMigrationType(): string;
    /**
     * Specifies whether the data migration is full-load only, change data capture (CDC) only, or full-load and CDC.
     */
    set dataMigrationType(value: string);
    /**
     * The property describes an identifier for the migration project.
     */
    get migrationProjectIdentifier(): string;
    /**
     * The property describes an identifier for the migration project.
     */
    set migrationProjectIdentifier(value: string);
    /**
     * The IAM role that the data migration uses to access AWS resources.
     */
     ...
     * Specifies information about the data migration's source data provider.
     */
    get sourceDataSettings(): Array<cdk.IResolvable | CfnDataMigration.SourceDataSettingsProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies information about the data migration's source data provider.
     */
    set sourceDataSettings(value: Array<cdk.IResolvable | CfnDataMigration.SourceDataSettingsProperty> | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrDataMigrationArn(): string;
    /**
     * The UTC time when DMS created the data migration.
     *
     * @cloudformationAttribute DataMigrationCreateTime
     */
    get attrDataMigrationCreateTime(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDataProvider extends cdk.CfnResource implements cdk.IInspectable, IDataProviderRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnDataProvider(x: any): x is CfnDataProvider;
    static arnForDataProvider(resource: IDataProviderRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _dataProviderIdentifier?;
    /**
     * The name of the data provider.
     */
    private _dataProviderName?;
    /**
     ...
     * The identifier of the data provider.
     */
    get dataProviderIdentifier(): string | undefined;
    /**
     * The identifier of the data provider.
     */
    set dataProviderIdentifier(value: string | undefined);
    /**
     * The name of the data provider.
     */
    get dataProviderName(): string | undefined;
    /**
     * The name of the data provider.
     */
    set dataProviderName(value: string | undefined);
    /**
     * A description of the data provider.
     */
     ...
     * The property describes the exact settings which can be modified.
     */
    get exactSettings(): boolean | cdk.IResolvable | undefined;
    /**
     * The property describes the exact settings which can be modified.
     */
    set exactSettings(value: boolean | cdk.IResolvable | undefined);
    /**
     * The settings in JSON format for a data provider.
     */
    get settings(): cdk.IResolvable | CfnDataProvider.SettingsProperty | undefined;
    /**
     * The settings in JSON format for a data provider.
     */
    set settings(value: cdk.IResolvable | CfnDataProvider.SettingsProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrDataProviderArn(): string;
    /**
     * The time the data provider was created.
     *
     * @cloudformationAttribute DataProviderCreationTime
     */
    get attrDataProviderCreationTime(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnDataProvider {
    ...
    interface SettingsProperty {
         ...
         */
        readonly sybaseAseSettings?: cdk.IResolvable | CfnDataProvider.SybaseAseSettingsProperty;
    }
    /**
     * Provides information that defines a PostgreSQL endpoint.
     *
    ...
    interface SybaseAseSettingsProperty {
         ...
         */
        readonly encryptPassword?: boolean | cdk.IResolvable;
        /**
...
export declare class CfnInstanceProfile extends cdk.CfnResource implements cdk.IInspectable, IInstanceProfileRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnInstanceProfile(x: any): x is CfnInstanceProfile;
    static arnForInstanceProfile(resource: IInstanceProfileRef): string;
    /**
     ...
     */
    private _instanceProfileIdentifier?;
    /**
     ...
     */
    private _subnetGroupIdentifier?;
    /**
     * An array of key-value pairs to apply to this resource.
     */
    private _tags?;
     ...
     * The identifier of the instance profile.
     */
    get instanceProfileIdentifier(): string | undefined;
    /**
     * The identifier of the instance profile.
     */
    set instanceProfileIdentifier(value: string | undefined);
    /**
     * The user-friendly name for the instance profile.
     */
    get instanceProfileName(): string | undefined;
    /**
     * The user-friendly name for the instance profile.
     */
    set instanceProfileName(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the AWS  key that is used to encrypt the connection parameters for the instance profile.
     */
     ...
     * The identifier of the subnet group that is associated with the instance profile.
     */
    get subnetGroupIdentifier(): string | undefined;
    /**
     * The identifier of the subnet group that is associated with the instance profile.
     */
    set subnetGroupIdentifier(value: string | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrInstanceProfileArn(): string;
    /**
     * The time the instance profile was created.
     *
     * @cloudformationAttribute InstanceProfileCreationTime
     */
    get attrInstanceProfileCreationTime(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnMigrationProject extends cdk.CfnResource implements cdk.IInspectable, IMigrationProjectRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnMigrationProject(x: any): x is CfnMigrationProject;
    static arnForMigrationProject(resource: IMigrationProjectRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _migrationProjectCreationTime?;
    /**
     ...
     */
    private _targetDataProviderDescriptors?;
    /**
     ...
     * @deprecated this property has been deprecated
     */
    get migrationProjectCreationTime(): string | undefined;
    /**
     * The property describes a creating time of the migration project.
     *
     * @deprecated this property has been deprecated
     */
    set migrationProjectCreationTime(value: string | undefined);
    /**
     * The identifier of the migration project.
     */
    get migrationProjectIdentifier(): string | undefined;
    /**
     * The identifier of the migration project.
     */
    set migrationProjectIdentifier(value: string | undefined);
    /**
     * The name of the migration project.
     */
    get migrationProjectName(): string | undefined;
    /**
     * The name of the migration project.
     */
    set migrationProjectName(value: string | undefined);
    /**
     * The schema conversion application attributes, including the Amazon S3 bucket name and Amazon S3 role ARN.
     */
    get schemaConversionApplicationAttributes(): cdk.IResolvable | CfnMigrationProject.SchemaConversionApplicationAttributesProperty | undefined;
    /**
     * The schema conversion application attributes, including the Amazon S3 bucket name and Amazon S3 role ARN.
     */
    set schemaConversionApplicationAttributes(value: cdk.IResolvable | CfnMigrationProject.SchemaConversionApplicationAttributesProperty | undefined);
    /**
     * Information about the source data provider, including the name or ARN, and AWS Secrets Manager parameters.
     */
    get sourceDataProviderDescriptors(): Array<CfnMigrationProject.DataProviderDescriptorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Information about the source data provider, including the name or ARN, and AWS Secrets Manager parameters.
     */
    set sourceDataProviderDescriptors(value: Array<CfnMigrationProject.DataProviderDescriptorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * Information about the target data provider, including the name or ARN, and AWS Secrets Manager parameters.
     */
    get targetDataProviderDescriptors(): Array<CfnMigrationProject.DataProviderDescriptorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Information about the target data provider, including the name or ARN, and AWS Secrets Manager parameters.
     */
    set targetDataProviderDescriptors(value: Array<CfnMigrationProject.DataProviderDescriptorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The settings in JSON format for migration rules.
     */
    get transformationRules(): string | undefined;
    /**
     * The settings in JSON format for migration rules.
     */
    set transformationRules(value: string | undefined);
    /**
     * The ARN string that uniquely identifies the migration project.
     *
     * @cloudformationAttribute MigrationProjectArn
     */
    get attrMigrationProjectArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IReplicationConfigRef, ReplicationConfigReference };
export type { IReplicationInstanceRef, ReplicationInstanceReference };
export type { IReplicationSubnetGroupRef, ReplicationSubnetGroupReference };
export type { IReplicationTaskRef, ReplicationTaskReference };
export type { IDataMigrationRef, DataMigrationReference };
export type { IDataProviderRef, DataProviderReference };
export type { IInstanceProfileRef, InstanceProfileReference };
export type { IMigrationProjectRef, MigrationProjectReference };
