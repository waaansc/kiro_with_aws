...
import { BlueprintReference, CatalogReference, ClassifierReference, ConnectionReference, CrawlerReference, CustomEntityTypeReference, DatabaseReference, DataCatalogEncryptionSettingsReference, DataQualityRulesetReference, DevEndpointReference, IBlueprintRef, ICatalogRef, IClassifierRef, IConnectionRef, ICrawlerRef, ICustomEntityTypeRef, IDatabaseRef, IDataCatalogEncryptionSettingsRef, IDataQualityRulesetRef, IdentityCenterConfigurationReference, IDevEndpointRef, IIdentityCenterConfigurationRef, IIntegrationRef, IIntegrationResourcePropertyRef, IJobRef, IMLTransformRef, IntegrationReference, IntegrationResourcePropertyReference, IPartitionRef, IRegistryRef, ISchemaRef, ISchemaVersionMetadataRef, ISchemaVersionRef, ISecurityConfigurationRef, ITableOptimizerRef, ITableRef, ITriggerRef, IUsageProfileRef, IUserDefinedFunctionRef, IWorkflowRef, JobReference, MLTransformReference, PartitionReference, RegistryReference, SchemaReference, SchemaVersionMetadataReference, SchemaVersionReference, SecurityConfigurationReference, TableOptimizerReference, TableReference, TriggerReference, UsageProfileReference, UserDefinedFunctionReference, WorkflowReference } from "../../interfaces/generated/aws-glue-interfaces.generated";
...
export declare class CfnBlueprint extends cdk.CfnResource implements cdk.IInspectable, IBlueprintRef, cdk.ITaggableV2 {
     ...
     * Specifies a path in Amazon S3 where the blueprint is published.
     */
    get blueprintLocation(): string;
    /**
     * Specifies a path in Amazon S3 where the blueprint is published.
     */
    set blueprintLocation(value: string);
    /**
     * A description of the blueprint.
     */
    get description(): string | undefined;
     ...
     */
    get attrLastModifiedOn(): string;
    /**
     * A JSON string that indicates the list of parameter specifications for the blueprint.
     *
     * @cloudformationAttribute ParameterSpec
     */
    get attrParameterSpec(): string;
    /**
 ...
 */
export declare class CfnUserDefinedFunction extends cdk.CfnResource implements cdk.IInspectable, IUserDefinedFunctionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnUserDefinedFunction from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnUserDefinedFunction;
    /**
     * Checks whether the given object is a CfnUserDefinedFunction
     */
    static isCfnUserDefinedFunction(x: any): x is CfnUserDefinedFunction;
    static arnForUserDefinedFunction(resource: IUserDefinedFunctionRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnUserDefinedFunctionProps);
    get userDefinedFunctionRef(): UserDefinedFunctionReference;
    /**
     * The Java class that contains the function code.
     */
     ...
     * The type of the function.
     */
    get functionType(): string | undefined;
    /**
     * The type of the function.
     */
    set functionType(value: string | undefined);
    /**
     * The owner of the function.
     */
     ...
     * The owner type.
     */
    get ownerType(): string | undefined;
    /**
     * The owner type.
     */
    set ownerType(value: string | undefined);
    /**
     * The resource URIs for the function.
     */
    get resourceUris(): Array<cdk.IResolvable | CfnUserDefinedFunction.ResourceUriProperty> | cdk.IResolvable | undefined;
    /**
     * The resource URIs for the function.
     */
    set resourceUris(value: Array<cdk.IResolvable | CfnUserDefinedFunction.ResourceUriProperty> | cdk.IResolvable | undefined);
    /**
...
export declare namespace CfnUserDefinedFunction {
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-userdefinedfunction.html
 */
export interface CfnUserDefinedFunctionProps {
    /**
     * The Java class that contains the function code.
     *
     ...
     */
    readonly resourceUris?: Array<cdk.IResolvable | CfnUserDefinedFunction.ResourceUriProperty> | cdk.IResolvable;
}
...
export type { IUserDefinedFunctionRef, UserDefinedFunctionReference };
