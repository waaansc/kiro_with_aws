...
import { ComponentReference, ComponentVersionReference, CoreDeviceReference, DeploymentReference, IComponentRef, IComponentVersionRef, ICoreDeviceRef, IDeploymentRef } from "../../interfaces/generated/aws-greengrassv2-interfaces.generated";
/**
 * Creates a component.
 *
...
export declare class CfnComponentVersion extends cdk.CfnResource implements cdk.IInspectable, IComponentVersionRef, cdk.ITaggable {
     ...
     */
    static isCfnComponentVersion(x: any): x is CfnComponentVersion;
    static arnForComponentVersion(resource: IComponentVersionRef): string;
    /**
     ...
     * The recipe to use to create the component.
     */
    get inlineRecipe(): string | undefined;
    /**
     * The recipe to use to create the component.
     */
    set inlineRecipe(value: string | undefined);
    /**
     * The parameters to create a component from a Lambda function.
     */
    get lambdaFunction(): cdk.IResolvable | CfnComponentVersion.LambdaFunctionRecipeSourceProperty | undefined;
    /**
     * The parameters to create a component from a Lambda function.
     */
    set lambdaFunction(value: cdk.IResolvable | CfnComponentVersion.LambdaFunctionRecipeSourceProperty | undefined);
    /**
     * Application-specific metadata to attach to the component version.
     */
     ...
     */
    get attrComponentName(): string;
    /**
     * The version of the component.
     *
     * @cloudformationAttribute ComponentVersion
     */
    get attrComponentVersion(): string;
...
export declare class CfnDeployment extends cdk.CfnResource implements cdk.IInspectable, IDeploymentRef, cdk.ITaggable {
     ...
     */
    static fromDeploymentId(scope: constructs.Construct, id: string, deploymentId: string): IDeploymentRef;
     ...
     * The components to deploy.
     */
    get components(): cdk.IResolvable | Record<string, CfnDeployment.ComponentDeploymentSpecificationProperty | cdk.IResolvable> | undefined;
    /**
     * The components to deploy.
     */
    set components(value: cdk.IResolvable | Record<string, CfnDeployment.ComponentDeploymentSpecificationProperty | cdk.IResolvable> | undefined);
    /**
     * The name of the deployment.
     */
     ...
     * The deployment policies for the deployment.
     */
    get deploymentPolicies(): CfnDeployment.DeploymentPoliciesProperty | cdk.IResolvable | undefined;
    /**
     * The deployment policies for the deployment.
     */
    set deploymentPolicies(value: CfnDeployment.DeploymentPoliciesProperty | cdk.IResolvable | undefined);
    /**
     * The job configuration for the deployment configuration.
     */
    get iotJobConfiguration(): CfnDeployment.DeploymentIoTJobConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The job configuration for the deployment configuration.
     */
    set iotJobConfiguration(value: CfnDeployment.DeploymentIoTJobConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The parent deployment's [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) for a subdeployment.
     */
    get parentTargetArn(): string | undefined;
    /**
     * The parent deployment's [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) for a subdeployment.
     */
    set parentTargetArn(value: string | undefined);
    /**
     * Application-specific metadata to attach to the deployment.
     */
    get tagsRaw(): Record<string, string> | undefined;
 ...
 *
 * @cloudformationResource AWS::GreengrassV2::Component
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrassv2-component.html
 */
export declare class CfnComponent extends cdk.CfnResource implements cdk.IInspectable, IComponentRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     * Create a new `AWS::GreengrassV2::Component`.
     *
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
     ...
     * Tags associated with the component.
     */
    get tags(): Array<CfnComponent.TagsItemsProperty> | undefined;
    /**
     * Tags associated with the component.
     */
    set tags(value: Array<CfnComponent.TagsItemsProperty> | undefined);
    /**
...
export interface CfnComponentProps {
     ...
     */
    readonly tags?: Array<CfnComponent.TagsItemsProperty>;
}
/**
 * Represents a Greengrass core device, which is an IoT thing that runs the IoT Greengrass Core software.
 *
 * @cloudformationResource AWS::GreengrassV2::CoreDevice
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrassv2-coredevice.html
 */
export declare class CfnCoreDevice extends cdk.CfnResource implements cdk.IInspectable, ICoreDeviceRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnCoreDevice from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnCoreDevice;
    /**
     * Checks whether the given object is a CfnCoreDevice
     */
    static isCfnCoreDevice(x: any): x is CfnCoreDevice;
    static arnForCoreDevice(resource: ICoreDeviceRef): string;
    /**
     * The name of the core device.
     */
    private _coreDeviceThingName?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnCoreDeviceProps);
    get coreDeviceRef(): CoreDeviceReference;
    /**
     * The name of the core device.
     */
    get coreDeviceThingName(): string | undefined;
    /**
     * The name of the core device.
     */
    set coreDeviceThingName(value: string | undefined);
    /**
     * The computer architecture of the core device.
     *
     * @cloudformationAttribute Architecture
     */
    get attrArchitecture(): string;
    /**
     ...
     *
     * @cloudformationAttribute CoreVersion
     */
    get attrCoreVersion(): string;
    /**
     * The time at which the core device's status last updated, expressed in ISO 8601 format.
     *
     * @cloudformationAttribute LastStatusUpdateTimestamp
     */
    get attrLastStatusUpdateTimestamp(): string;
    /**
     ...
     *
     * @cloudformationAttribute Runtime
     */
    get attrRuntime(): string;
    /**
...
export declare namespace CfnCoreDevice {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrassv2-coredevice.html
 */
export interface CfnCoreDeviceProps {
    /**
     * The name of the core device.
     *
...
export type { IComponentVersionRef, ComponentVersionReference };
export type { IDeploymentRef, DeploymentReference };
export type { IComponentRef, ComponentReference };
export type { ICoreDeviceRef, CoreDeviceReference };
