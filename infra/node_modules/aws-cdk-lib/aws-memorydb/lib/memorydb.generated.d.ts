...
import { ACLReference, ClusterReference, IACLRef, IClusterRef, IMultiRegionClusterRef, IMultiRegionParameterGroupRef, IParameterGroupRef, IReservedNodeRef, ISubnetGroupRef, IUserRef, MultiRegionClusterReference, MultiRegionParameterGroupReference, ParameterGroupReference, ReservedNodeReference, SubnetGroupReference, UserReference } from "../../interfaces/generated/aws-memorydb-interfaces.generated";
 ...
 */
export declare class CfnMultiRegionParameterGroup extends cdk.CfnResource implements cdk.IInspectable, IMultiRegionParameterGroupRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnMultiRegionParameterGroup from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnMultiRegionParameterGroup;
    /**
     * Checks whether the given object is a CfnMultiRegionParameterGroup
     */
    static isCfnMultiRegionParameterGroup(x: any): x is CfnMultiRegionParameterGroup;
    static arnForMultiRegionParameterGroup(resource: IMultiRegionParameterGroupRef): string;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnMultiRegionParameterGroupProps);
    get multiRegionParameterGroupRef(): MultiRegionParameterGroupReference;
    /**
     ...
     */
    get attrMultiRegionParameterGroupName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-memorydb-multiregionparametergroup.html
 */
export interface CfnMultiRegionParameterGroupProps {
}
/**
 ...
 */
export declare class CfnReservedNode extends cdk.CfnResource implements cdk.IInspectable, IReservedNodeRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnReservedNode from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnReservedNode;
    /**
     * Checks whether the given object is a CfnReservedNode
     */
    static isCfnReservedNode(x: any): x is CfnReservedNode;
    static arnForReservedNode(resource: IReservedNodeRef): string;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnReservedNodeProps);
    get reservedNodeRef(): ReservedNodeReference;
    /**
     ...
     */
    get attrReservationId(): string;
    /**
     * The ID of the reserved node offering to purchase.
     *
     * @cloudformationAttribute ReservedNodesOfferingId
     */
    get attrReservedNodesOfferingId(): string;
    /**
...
export declare namespace CfnReservedNode {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-memorydb-reservednode.html
 */
export interface CfnReservedNodeProps {
}
...
export type { IMultiRegionParameterGroupRef, MultiRegionParameterGroupReference };
export type { IReservedNodeRef, ReservedNodeReference };
