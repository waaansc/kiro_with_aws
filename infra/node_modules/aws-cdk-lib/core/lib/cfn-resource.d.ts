...
export declare class CfnResource extends CfnRefElement {
     ...
     */
    private dependsOn;
    private _crossStackReferenceStrength?;
     ...
     */
    applyCrossStackReferenceStrength(strength: ReferenceStrength): void;
    /**
     * @internal
     */
    get _crossStackReferenceStrengthOverride(): ReferenceStrength | undefined;
    /**
     ...
     */
    addResourceDependency(target: CfnResource, reason?: string): void;
    /**
     * Indicates that this resource depends on another resource and cannot be
     * provisioned unless the other resource has been successfully provisioned.
     *
     ...
     */
    removeResourceDependency(target: CfnResource): void;
    /**
     * Indicates that this resource no longer depends on another resource.
     *
     * This can be used for resources across stacks (including nested stacks)
     ...
     * @internal
     */
    _obtainResourceDependencies(): CfnResource[];
    /**
 ...
 */
export declare function traceProperty(node: Node, propertyName: string): void;
