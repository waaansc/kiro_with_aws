...
export declare class Stack extends Construct implements ITaggable {
     ...
     */
    static consumeReference(value: string, strength?: ReferenceStrength): string;
    /**
     ...
     * @returns A token that resolves to the same value but uses the overridden strength.
     */
    static consumeListReference(value: string[], strength?: ReferenceStrength): string[];
    /**
     ...
     */
    addStackDependency(target: Stack, reason?: string): void;
    /**
