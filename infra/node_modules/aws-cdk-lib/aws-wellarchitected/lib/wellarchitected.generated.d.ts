...
import { ILensRef, IProfileRef, IReviewTemplateRef, LensReference, ProfileReference, ReviewTemplateReference } from "../../interfaces/generated/aws-wellarchitected-interfaces.generated";
/**
 ...
 */
export declare class CfnLens extends cdk.CfnResource implements cdk.IInspectable, ILensRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnLens from CloudFormation properties
     *
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnLens;
    /**
     * Checks whether the given object is a CfnLens
     */
    static isCfnLens(x: any): x is CfnLens;
    static arnForLens(resource: ILensRef): string;
    /**
     ...
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnLensProps);
    get lensRef(): LensReference;
    /**
     * The JSON representation of a lens.
     */
    get jsonString(): string | undefined;
    /**
     * The JSON representation of a lens.
     */
    set jsonString(value: string | undefined);
    /**
     * The version of the lens.
     */
     ...
     * The tags assigned to the lens.
     */
    get tags(): Array<CfnLens.TagsItemsProperty> | undefined;
    /**
     * The tags assigned to the lens.
     */
    set tags(value: Array<CfnLens.TagsItemsProperty> | undefined);
    /**
...
export declare namespace CfnLens {
    /**
     * @struct
     * @stability external
...
export interface CfnLensProps {
     ...
     */
    readonly tags?: Array<CfnLens.TagsItemsProperty>;
}
/**
...
export declare class CfnProfile extends cdk.CfnResource implements cdk.IInspectable, IProfileRef, cdk.ITaggableV2 {
     ...
     * The profile questions.
     */
    get profileQuestions(): Array<cdk.IResolvable | CfnProfile.ProfileQuestionUpdateProperty> | cdk.IResolvable;
    /**
     * The profile questions.
     */
    set profileQuestions(value: Array<cdk.IResolvable | CfnProfile.ProfileQuestionUpdateProperty> | cdk.IResolvable);
    /**
     * The tags assigned to the profile.
     */
...
export declare namespace CfnProfile {
    ...
    interface ProfileQuestionUpdateProperty {
         ...
         */
        readonly selectedChoiceIds?: Array<string>;
    }
}
/**
...
export interface CfnProfileProps {
     ...
     */
    readonly profileQuestions: Array<cdk.IResolvable | CfnProfile.ProfileQuestionUpdateProperty> | cdk.IResolvable;
    /**
     * The tags assigned to the profile.
     *
 ...
 */
export declare class CfnReviewTemplate extends cdk.CfnResource implements cdk.IInspectable, IReviewTemplateRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnReviewTemplate from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnReviewTemplate;
    /**
     * Checks whether the given object is a CfnReviewTemplate
     */
    static isCfnReviewTemplate(x: any): x is CfnReviewTemplate;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnReviewTemplateProps);
    get reviewTemplateRef(): ReviewTemplateReference;
    /**
     * The review template description.
     */
     ...
     * The lenses applied to the review template.
     */
    get lenses(): Array<string>;
    /**
     * The lenses applied to the review template.
     */
    set lenses(value: Array<string>);
    /**
     * The notes associated with the review template.
     */
     ...
     * The tags assigned to the review template.
     */
    get tags(): Array<CfnReviewTemplate.TagsItemsProperty> | undefined;
    /**
     * The tags assigned to the review template.
     */
    set tags(value: Array<CfnReviewTemplate.TagsItemsProperty> | undefined);
    /**
     * The name of the review template.
     */
...
export declare namespace CfnReviewTemplate {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wellarchitected-reviewtemplate.html
 */
export interface CfnReviewTemplateProps {
    /**
     * The review template description.
     *
     ...
     */
    readonly tags?: Array<CfnReviewTemplate.TagsItemsProperty>;
    /**
     * The name of the review template.
     *
...
export type { ILensRef, LensReference };
export type { IProfileRef, ProfileReference };
export type { IReviewTemplateRef, ReviewTemplateReference };
