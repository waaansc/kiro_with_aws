...
import { AnnotationStoreReference, ConfigurationReference, IAnnotationStoreRef, IConfigurationRef, IReferenceRef, IReferenceStoreRef, IRunGroupRef, ISequenceStoreRef, IVariantStoreRef, IWorkflowRef, IWorkflowVersionRef, ReferenceReference, ReferenceStoreReference, RunGroupReference, SequenceStoreReference, VariantStoreReference, WorkflowReference, WorkflowVersionReference } from "../../interfaces/generated/aws-omics-interfaces.generated";
/**
 ...
 */
export declare class CfnReference extends cdk.CfnResource implements cdk.IInspectable, IReferenceRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnReference from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnReference;
    /**
     * Checks whether the given object is a CfnReference
     */
    static isCfnReference(x: any): x is CfnReference;
    static arnForReference(resource: IReferenceRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnReferenceProps);
    get referenceRef(): ReferenceReference;
    /**
     * The reference's description.
     */
    get description(): string | undefined;
     ...
     * The reference's reference store ID.
     */
    get referenceStoreId(): string | undefined;
    /**
     * The reference's reference store ID.
     */
    set referenceStoreId(value: string | undefined);
    /**
     * Tags for the reference.
     */
    get tags(): Array<CfnReference.TagsItemsProperty> | undefined;
    /**
     * Tags for the reference.
     */
    set tags(value: Array<CfnReference.TagsItemsProperty> | undefined);
    /**
     * The reference's ARN.
     *
     * @cloudformationAttribute Arn
...
export declare namespace CfnReference {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-omics-reference.html
 */
export interface CfnReferenceProps {
    /**
     * The reference's description.
     *
     ...
     */
    readonly tags?: Array<CfnReference.TagsItemsProperty>;
}
/**
...
export type { IReferenceRef, ReferenceReference };
