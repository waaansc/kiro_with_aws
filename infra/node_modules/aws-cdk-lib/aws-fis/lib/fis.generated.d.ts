...
import { ExperimentTemplateReference, IExperimentTemplateRef, ISafetyLeverRef, ITargetAccountConfigurationRef, SafetyLeverReference, TargetAccountConfigurationReference } from "../../interfaces/generated/aws-fis-interfaces.generated";
/**
...
export declare class CfnExperimentTemplate extends cdk.CfnResource implements cdk.IInspectable, IExperimentTemplateRef, cdk.ITaggable {
     ...
     */
    static isCfnExperimentTemplate(x: any): x is CfnExperimentTemplate;
    static arnForExperimentTemplate(resource: IExperimentTemplateRef): string;
    /**
     ...
     * The actions for the experiment.
     */
    get actions(): cdk.IResolvable | Record<string, CfnExperimentTemplate.ExperimentTemplateActionProperty | cdk.IResolvable> | undefined;
    /**
     * The actions for the experiment.
     */
    set actions(value: cdk.IResolvable | Record<string, CfnExperimentTemplate.ExperimentTemplateActionProperty | cdk.IResolvable> | undefined);
    /**
     * The description for the experiment template.
     */
     ...
     * The experiment options for an experiment template.
     */
    get experimentOptions(): CfnExperimentTemplate.ExperimentTemplateExperimentOptionsProperty | cdk.IResolvable | undefined;
    /**
     * The experiment options for an experiment template.
     */
    set experimentOptions(value: CfnExperimentTemplate.ExperimentTemplateExperimentOptionsProperty | cdk.IResolvable | undefined);
    /**
     * Describes the report configuration for the experiment template.
     */
    get experimentReportConfiguration(): CfnExperimentTemplate.ExperimentTemplateExperimentReportConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Describes the report configuration for the experiment template.
     */
    set experimentReportConfiguration(value: CfnExperimentTemplate.ExperimentTemplateExperimentReportConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The configuration for experiment logging.
     */
    get logConfiguration(): CfnExperimentTemplate.ExperimentTemplateLogConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration for experiment logging.
     */
    set logConfiguration(value: CfnExperimentTemplate.ExperimentTemplateLogConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of an IAM role.
     */
    get roleArn(): string;
     ...
     * The stop conditions for the experiment.
     */
    get stopConditions(): Array<CfnExperimentTemplate.ExperimentTemplateStopConditionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The stop conditions for the experiment.
     */
    set stopConditions(value: Array<CfnExperimentTemplate.ExperimentTemplateStopConditionProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The tags for the experiment template.
     */
     ...
     * The targets for the experiment.
     */
    get targets(): cdk.IResolvable | Record<string, CfnExperimentTemplate.ExperimentTemplateTargetProperty | cdk.IResolvable>;
    /**
     * The targets for the experiment.
     */
    set targets(value: cdk.IResolvable | Record<string, CfnExperimentTemplate.ExperimentTemplateTargetProperty | cdk.IResolvable>);
    /**
 ...
 *
 * @cloudformationResource AWS::FIS::SafetyLever
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fis-safetylever.html
 */
export declare class CfnSafetyLever extends cdk.CfnResource implements cdk.IInspectable, ISafetyLeverRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnSafetyLever from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnSafetyLever;
    /**
     * Checks whether the given object is a CfnSafetyLever
     */
    static isCfnSafetyLever(x: any): x is CfnSafetyLever;
    static arnForSafetyLever(resource: ISafetyLeverRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnSafetyLeverProps);
    get safetyLeverRef(): SafetyLeverReference;
    /**
     * The ID of the safety lever.
     */
     ...
     *
     * @cloudformationAttribute Reason
     */
    get attrReason(): string;
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fis-safetylever.html
 */
export interface CfnSafetyLeverProps {
    /**
     * The ID of the safety lever.
     *
...
export declare class CfnTargetAccountConfiguration extends cdk.CfnResource implements cdk.IInspectable, ITargetAccountConfigurationRef {
     ...
     */
    static isCfnTargetAccountConfiguration(x: any): x is CfnTargetAccountConfiguration;
    /**
...
export type { IExperimentTemplateRef, ExperimentTemplateReference };
export type { ISafetyLeverRef, SafetyLeverReference };
export type { ITargetAccountConfigurationRef, TargetAccountConfigurationReference };
