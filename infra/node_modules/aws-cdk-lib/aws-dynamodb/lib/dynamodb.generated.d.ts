...
import { ExportReference, GlobalTableReference, IExportRef, IGlobalTableRef, ITableRef, TableReference } from "../../interfaces/generated/aws-dynamodb-interfaces.generated";
/**
 ...
 */
export declare class CfnExport extends cdk.CfnResource implements cdk.IInspectable, IExportRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnExport(x: any): x is CfnExport;
    static arnForExport(resource: IExportRef): string;
    /**
     ...
     * The format of the exported data.
     */
    get exportFormat(): string | undefined;
    /**
     * The format of the exported data.
     */
    set exportFormat(value: string | undefined);
    /**
     * The type of export that was performed.
     */
    get exportType(): string | undefined;
    /**
     * The type of export that was performed.
     */
    set exportType(value: string | undefined);
    /**
     * The name of the Amazon S3 bucket containing the export.
     */
    get s3Bucket(): string;
     ...
     * The ID of the Amazon Web Services account that owns the bucket containing the export.
     */
    get s3BucketOwner(): string | undefined;
    /**
     * The ID of the Amazon Web Services account that owns the bucket containing the export.
     */
    set s3BucketOwner(value: string | undefined);
    /**
     * The Amazon S3 bucket prefix used as the file name and path of the exported snapshot.
     */
     ...
     * The Amazon S3 bucket prefix used as the file name and path of the exported snapshot.
     */
    set s3Prefix(value: string | undefined);
    /**
     * Type of encryption used on the bucket where export data is stored.
     */
    get s3SseAlgorithm(): string | undefined;
    /**
     * Type of encryption used on the bucket where export data is stored.
     */
    set s3SseAlgorithm(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the table that was exported.
     */
    get tableArn(): string;
     ...
     */
    get attrBilledSizeBytes(): number;
    /**
...
export type { IExportRef, ExportReference };
