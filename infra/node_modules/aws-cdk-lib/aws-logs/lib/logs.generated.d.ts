...
import { AccountPolicyReference, DeliveryDestinationReference, DeliveryReference, DeliverySourceReference, DestinationReference, IAccountPolicyRef, IDeliveryDestinationRef, IDeliveryRef, IDeliverySourceRef, IDestinationRef, IIntegrationRef, ILogAnomalyDetectorRef, ILogGroupRef, ILogStreamRef, IMetricFilterRef, IntegrationReference, IQueryDefinitionRef, IResourcePolicyRef, IScheduledQueryRef, ISubscriptionFilterRef, ITransformerRef, LogAnomalyDetectorReference, LogGroupReference, LogStreamReference, MetricFilterReference, QueryDefinitionReference, ResourcePolicyReference, ScheduledQueryReference, SubscriptionFilterReference, TransformerReference } from "../../interfaces/generated/aws-logs-interfaces.generated";
import { aws_iam as iamRefs, aws_kinesis as kinesisRefs, aws_kinesisfirehose as kinesisFirehoseRefs, aws_kms as kmsRefs, aws_lambda as lambdaRefs, aws_logs as logsRefs } from "../../interfaces";
/**
 ...
 */
export declare class CfnAccountPolicy extends cdk.CfnResource implements cdk.IInspectable, IAccountPolicyRef {
    /**
     ...
     */
    static isCfnAccountPolicy(x: any): x is CfnAccountPolicy;
    /**
    ...
    get accountPolicyRef(): AccountPolicyReference;
    /**
     * Specify the policy, in JSON.
     */
     ...
     * Use this parameter to apply the new policy to a subset of log groups in the account.
     */
    get selectionCriteria(): string | undefined;
    /**
     * Use this parameter to apply the new policy to a subset of log groups in the account.
     */
    set selectionCriteria(value: string | undefined);
    /**
 ...
 */
export declare class CfnDestination extends cdk.CfnResource implements cdk.IInspectable, IDestinationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDestination(x: any): x is CfnDestination;
    /**
     * Creates a new IDestinationRef from an ARN
     */
    static fromDestinationArn(scope: constructs.Construct, id: string, arn: string): IDestinationRef;
    /**
     * Creates a new IDestinationRef from a destinationName
     */
    static fromDestinationName(scope: constructs.Construct, id: string, destinationName: string): IDestinationRef;
    static arnForDestination(resource: IDestinationRef): string;
    /**
     ...
     * An IAM policy document that governs which AWS accounts can create subscription filters against this destination.
     */
    get destinationPolicy(): string | undefined;
    /**
     * An IAM policy document that governs which AWS accounts can create subscription filters against this destination.
     */
    set destinationPolicy(value: string | undefined);
    /**
     * The ARN of an IAM role that permits CloudWatch Logs to send data to the specified AWS resource.
     */
    get roleArn(): string;
...
export interface CfnDestinationProps {
     ...
     */
    readonly targetArn: kinesisFirehoseRefs.IDeliveryStreamRef | kinesisRefs.IStreamRef | lambdaRefs.IFunctionRef | string;
}
/**
 ...
 */
export declare class CfnLogGroup extends cdk.CfnResource implements cdk.IInspectable, ILogGroupRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnLogGroup(x: any): x is CfnLogGroup;
    /**
     * Creates a new ILogGroupRef from an ARN
     */
    static fromLogGroupArn(scope: constructs.Construct, id: string, arn: string): ILogGroupRef;
    /**
     * Creates a new ILogGroupRef from a logGroupName
     */
    static fromLogGroupName(scope: constructs.Construct, id: string, logGroupName: string): ILogGroupRef;
    static arnForLogGroup(resource: ILogGroupRef): string;
    /**
     * Indicates whether bearer token authentication is enabled for this log group.
     */
    private _bearerTokenAuthenticationEnabled?;
    /**
     ...
     */
    private _resourcePolicyDocument?;
    /**
     ...
     * Indicates whether bearer token authentication is enabled for this log group.
     */
    get bearerTokenAuthenticationEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether bearer token authentication is enabled for this log group.
     */
    set bearerTokenAuthenticationEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * Creates a data protection policy and assigns it to the log group.
     */
     ...
     * Creates or updates a *field index policy* for the specified log group.
     */
    get fieldIndexPolicies(): Array<any | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Creates or updates a *field index policy* for the specified log group.
     */
    set fieldIndexPolicies(value: Array<any | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the AWS  key to use when encrypting log data.
     */
     ...
     * Specifies the log group class for this log group. There are two classes:.
     */
    get logGroupClass(): string | undefined;
    /**
     * Specifies the log group class for this log group. There are two classes:.
     */
    set logGroupClass(value: string | undefined);
    /**
     * The name of the log group.
     */
     ...
     * Creates or updates a resource policy for the specified log group that allows other services to put log events to this account.
     */
    get resourcePolicyDocument(): any | cdk.IResolvable | undefined;
    /**
     * Creates or updates a resource policy for the specified log group that allows other services to put log events to this account.
     */
    set resourcePolicyDocument(value: any | cdk.IResolvable | undefined);
    /**
     * The number of days to retain the log events in the specified log group.
     */
...
export interface CfnLogGroupProps {
     ...
     */
    readonly bearerTokenAuthenticationEnabled?: boolean | cdk.IResolvable;
    /**
     * Creates a data protection policy and assigns it to the log group.
     *
     ...
     */
    readonly logGroupName?: lambdaRefs.IFunctionRef | string;
    /**
     * Creates or updates a resource policy for the specified log group that allows other services to put log events to this account.
     *
 ...
 */
export declare class CfnLogStream extends cdk.CfnResource implements cdk.IInspectable, ILogStreamRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnLogStream(x: any): x is CfnLogStream;
    /**
     ...
     * The name of the log stream.
     */
    get logStreamName(): string | undefined;
    /**
     * The name of the log stream.
     */
    set logStreamName(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnLogStreamProps {
     ...
     */
    readonly logGroupName: logsRefs.ILogGroupRef | string;
    /**
     * The name of the log stream.
     *
 ...
 */
export declare class CfnMetricFilter extends cdk.CfnResource implements cdk.IInspectable, IMetricFilterRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnMetricFilter(x: any): x is CfnMetricFilter;
    /**
     ...
     */
    private _metricTransformations;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
    ...
    get metricFilterRef(): MetricFilterReference;
    /**
     * This parameter is valid only for log groups that have an active log transformer.
     */
     ...
     * The list of system fields that are emitted as additional dimensions in the generated metrics.
     */
    get emitSystemFieldDimensions(): Array<string> | undefined;
    /**
     * The list of system fields that are emitted as additional dimensions in the generated metrics.
     */
    set emitSystemFieldDimensions(value: Array<string> | undefined);
    /**
     * The filter expression that specifies which log events are processed by this metric filter based on system fields.
     */
    get fieldSelectionCriteria(): string | undefined;
    /**
     * The filter expression that specifies which log events are processed by this metric filter based on system fields.
     */
    set fieldSelectionCriteria(value: string | undefined);
    /**
     * The name of the metric filter.
     */
     ...
     * The name of the metric filter.
     */
    set filterName(value: string | undefined);
    /**
     * A filter pattern for extracting metric data out of ingested log events.
     */
     ...
     * The metric transformations.
     */
    get metricTransformations(): Array<cdk.IResolvable | CfnMetricFilter.MetricTransformationProperty> | cdk.IResolvable;
    /**
     * The metric transformations.
     */
    set metricTransformations(value: Array<cdk.IResolvable | CfnMetricFilter.MetricTransformationProperty> | cdk.IResolvable);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnMetricFilterProps {
     ...
     */
    readonly emitSystemFieldDimensions?: Array<string>;
    /**
     * The filter expression that specifies which log events are processed by this metric filter based on system fields.
     *
 ...
 */
export declare class CfnQueryDefinition extends cdk.CfnResource implements cdk.IInspectable, IQueryDefinitionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnQueryDefinition(x: any): x is CfnQueryDefinition;
    /**
    ...
    get queryDefinitionRef(): QueryDefinitionReference;
    /**
     * Use this parameter if you want the query to query only certain log groups.
     */
    get logGroupNames(): Array<string> | undefined;
    /**
     * Use this parameter if you want the query to query only certain log groups.
     */
    set logGroupNames(value: Array<string> | undefined);
    /**
     * A name for the query definition.
     */
    get name(): string;
     ...
     * Use this parameter to include specific query parameters as part of your query definition.
     */
    get parameters(): Array<cdk.IResolvable | CfnQueryDefinition.QueryParameterProperty> | cdk.IResolvable | undefined;
    /**
     * Use this parameter to include specific query parameters as part of your query definition.
     */
    set parameters(value: Array<cdk.IResolvable | CfnQueryDefinition.QueryParameterProperty> | cdk.IResolvable | undefined);
    /**
     * The query language used for this query.
     */
     ...
     * The query language used for this query.
     */
    set queryLanguage(value: string | undefined);
    /**
     * The query string to use for this query definition.
     */
     ...
     */
    get attrQueryDefinitionId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnQueryDefinition {
    /**
...
export interface CfnQueryDefinitionProps {
     ...
     */
    readonly logGroupNames?: Array<logsRefs.ILogGroupRef | string>;
    /**
     * A name for the query definition.
     *
     ...
     */
    readonly parameters?: Array<cdk.IResolvable | CfnQueryDefinition.QueryParameterProperty> | cdk.IResolvable;
    /**
     * The query language used for this query.
     *
 ...
 */
export declare class CfnSubscriptionFilter extends cdk.CfnResource implements cdk.IInspectable, ISubscriptionFilterRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnSubscriptionFilter(x: any): x is CfnSubscriptionFilter;
    /**
     * This parameter is valid only for log groups that have an active log transformer.
     */
    private _applyOnTransformedLogs?;
    ...
    get subscriptionFilterRef(): SubscriptionFilterReference;
    /**
     * This parameter is valid only for log groups that have an active log transformer.
     */
    get applyOnTransformedLogs(): boolean | cdk.IResolvable | undefined;
     ...
     * The list of system fields that are included in the log events sent to the subscription destination.
     */
    get emitSystemFields(): Array<string> | undefined;
    /**
     * The list of system fields that are included in the log events sent to the subscription destination.
     */
    set emitSystemFields(value: Array<string> | undefined);
    /**
     * The filter expression that specifies which log events are processed by this subscription filter based on system fields.
     */
    get fieldSelectionCriteria(): string | undefined;
...
export interface CfnSubscriptionFilterProps {
     ...
     */
    readonly destinationArn: kinesisFirehoseRefs.IDeliveryStreamRef | kinesisRefs.IStreamRef | lambdaRefs.IFunctionRef | string;
    /**
     * The method used to distribute log data to the destination, which can be either random or grouped by log stream.
     *
     ...
     */
    readonly emitSystemFields?: Array<string>;
    /**
     * The filter expression that specifies which log events are processed by this subscription filter based on system fields.
     *
 ...
 */
export declare class CfnDelivery extends cdk.CfnResource implements cdk.IInspectable, IDeliveryRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDelivery(x: any): x is CfnDelivery;
    static arnForDelivery(resource: IDeliveryRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
    ...
    get deliveryRef(): DeliveryReference;
    /**
     * The ARN of the delivery destination that is associated with this delivery.
     */
     ...
     * The list of record fields to be delivered to the destination, in order.
     */
    get recordFields(): Array<string> | undefined;
    /**
     * The list of record fields to be delivered to the destination, in order.
     */
    set recordFields(value: Array<string> | undefined);
    /**
     * Use this parameter to cause the S3 objects that contain delivered logs to use a prefix structure that allows for integration with Apache Hive.
     */
    get s3EnableHiveCompatiblePath(): boolean | cdk.IResolvable | undefined;
    /**
     * Use this parameter to cause the S3 objects that contain delivered logs to use a prefix structure that allows for integration with Apache Hive.
     */
    set s3EnableHiveCompatiblePath(value: boolean | cdk.IResolvable | undefined);
    /**
     * Use this to reconfigure the S3 object prefix to contain either static or variable sections.
     */
    get s3SuffixPath(): string | undefined;
    /**
     * Use this to reconfigure the S3 object prefix to contain either static or variable sections.
     */
    set s3SuffixPath(value: string | undefined);
    /**
     * An array of key-value pairs to apply to the delivery.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrDeliveryDestinationType(): string;
    /**
     * The unique ID that identifies this delivery in your account.
     *
     * @cloudformationAttribute DeliveryId
     */
    get attrDeliveryId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnDeliveryDestination extends cdk.CfnResource implements cdk.IInspectable, IDeliveryDestinationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDeliveryDestination(x: any): x is CfnDeliveryDestination;
    /**
     * Creates a new IDeliveryDestinationRef from an ARN
     */
    static fromDeliveryDestinationArn(scope: constructs.Construct, id: string, arn: string): IDeliveryDestinationRef;
    /**
     * Creates a new IDeliveryDestinationRef from a deliveryDestinationName
     */
    static fromDeliveryDestinationName(scope: constructs.Construct, id: string, deliveryDestinationName: string): IDeliveryDestinationRef;
    static arnForDeliveryDestination(resource: IDeliveryDestinationRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
    ...
    get deliveryDestinationRef(): DeliveryDestinationReference;
    /**
     * An IAM policy that grants permissions to CloudWatch Logs to deliver logs cross-account to a specified destination in this account.
     */
    get deliveryDestinationPolicy(): CfnDeliveryDestination.DestinationPolicyProperty | cdk.IResolvable | undefined;
    /**
     * An IAM policy that grants permissions to CloudWatch Logs to deliver logs cross-account to a specified destination in this account.
     */
    set deliveryDestinationPolicy(value: CfnDeliveryDestination.DestinationPolicyProperty | cdk.IResolvable | undefined);
    /**
     * Displays whether this delivery destination is CloudWatch Logs, Amazon S3, Firehose, or X-Ray.
     */
    get deliveryDestinationType(): string | undefined;
    /**
     * Displays whether this delivery destination is CloudWatch Logs, Amazon S3, Firehose, or X-Ray.
     */
    set deliveryDestinationType(value: string | undefined);
    /**
     * The ARN of the AWS destination that this delivery destination represents.
     */
    get destinationResourceArn(): string | undefined;
    /**
     * The ARN of the AWS destination that this delivery destination represents.
     */
    set destinationResourceArn(value: string | undefined);
    /**
     * The name of this delivery destination.
     */
    get name(): string;
 ...
 */
export declare class CfnDeliverySource extends cdk.CfnResource implements cdk.IInspectable, IDeliverySourceRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDeliverySource(x: any): x is CfnDeliverySource;
    /**
     * Creates a new IDeliverySourceRef from an ARN
     */
    static fromDeliverySourceArn(scope: constructs.Construct, id: string, arn: string): IDeliverySourceRef;
    /**
     * Creates a new IDeliverySourceRef from a deliverySourceName
     */
    static fromDeliverySourceName(scope: constructs.Construct, id: string, deliverySourceName: string): IDeliverySourceRef;
    static arnForDeliverySource(resource: IDeliverySourceRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _deliverySourceConfiguration?;
    /**
    ...
    get deliverySourceRef(): DeliverySourceReference;
    /**
     * A map of key-value pairs to configure the delivery source.
     */
    get deliverySourceConfiguration(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * A map of key-value pairs to configure the delivery source.
     */
    set deliverySourceConfiguration(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The type of log that the source is sending.
     */
    get logType(): string | undefined;
    /**
     * The type of log that the source is sending.
     */
    set logType(value: string | undefined);
    /**
     * The unique name of the delivery source.
     */
    get name(): string;
     ...
     * The ARN of the AWS resource that is generating and sending logs.
     */
    get resourceArn(): string | undefined;
    /**
     * The ARN of the AWS resource that is generating and sending logs.
     */
    set resourceArn(value: string | undefined);
    /**
     * An array of key-value pairs to apply to the delivery source.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrResourceArns(): Array<string>;
    /**
     * The AWS service that is sending logs.
     *
     * @cloudformationAttribute Service
     */
    get attrService(): string;
    /**
...
export interface CfnDeliverySourceProps {
     ...
     */
    readonly deliverySourceConfiguration?: cdk.IResolvable | Record<string, string>;
    /**
     * The type of log that the source is sending.
     *
...
export declare class CfnIntegration extends cdk.CfnResource implements cdk.IInspectable, IIntegrationRef {
     ...
     * This structure contains configuration details about an integration between CloudWatch Logs and another entity.
     */
    get resourceConfig(): cdk.IResolvable | CfnIntegration.ResourceConfigProperty;
    /**
     * This structure contains configuration details about an integration between CloudWatch Logs and another entity.
     */
    set resourceConfig(value: cdk.IResolvable | CfnIntegration.ResourceConfigProperty);
    /**
     * The current status of this integration.
     *
     * @cloudformationAttribute IntegrationStatus
     */
    get attrIntegrationStatus(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnLogAnomalyDetector extends cdk.CfnResource implements cdk.IInspectable, ILogAnomalyDetectorRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnLogAnomalyDetector(x: any): x is CfnLogAnomalyDetector;
    /**
    ...
    get logAnomalyDetectorRef(): LogAnomalyDetectorReference;
    /**
     * The ID of the account to create the anomaly detector in.
     */
     ...
     * The number of days to have visibility on an anomaly.
     */
    get anomalyVisibilityTime(): number | undefined;
    /**
     * The number of days to have visibility on an anomaly.
     */
    set anomalyVisibilityTime(value: number | undefined);
    /**
     * A name for this anomaly detector.
     */
    get detectorName(): string | undefined;
    /**
     * A name for this anomaly detector.
     */
    set detectorName(value: string | undefined);
    /**
     * Specifies how often the anomaly detector is to run and look for anomalies.
     */
    get evaluationFrequency(): string | undefined;
    /**
     * Specifies how often the anomaly detector is to run and look for anomalies.
     */
    set evaluationFrequency(value: string | undefined);
    /**
     * You can use this parameter to limit the anomaly detection model to examine only log events that match the pattern you specify here.
     */
    get filterPattern(): string | undefined;
    /**
     * You can use this parameter to limit the anomaly detection model to examine only log events that match the pattern you specify here.
     */
    set filterPattern(value: string | undefined);
    /**
     * Optionally assigns a AWS  key to secure this anomaly detector and its findings.
     */
    get kmsKeyId(): string | undefined;
 ...
 */
export declare class CfnScheduledQuery extends cdk.CfnResource implements cdk.IInspectable, IScheduledQueryRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnScheduledQuery(x: any): x is CfnScheduledQuery;
    static arnForScheduledQuery(resource: IScheduledQueryRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
    ...
    get destinationConfiguration(): CfnScheduledQuery.DestinationConfigurationProperty | cdk.IResolvable | undefined;
    set destinationConfiguration(value: CfnScheduledQuery.DestinationConfigurationProperty | cdk.IResolvable | undefined);
    get executionRoleArn(): string;
    set executionRoleArn(value: string);
    get logGroupIdentifiers(): Array<string> | undefined;
    set logGroupIdentifiers(value: Array<string> | undefined);
    get name(): string;
    set name(value: string);
    get queryLanguage(): string;
    set queryLanguage(value: string);
    get queryString(): string;
    set queryString(value: string);
    get scheduleEndTime(): number | undefined;
    set scheduleEndTime(value: number | undefined);
    get scheduleExpression(): string;
    set scheduleExpression(value: string);
    get scheduleStartTime(): number | undefined;
    set scheduleStartTime(value: number | undefined);
    get startTimeOffset(): number | undefined;
    set startTimeOffset(value: number | undefined);
    get state(): string | undefined;
    set state(value: string | undefined);
    get tags(): Array<CfnScheduledQuery.TagsItemsProperty> | undefined;
    set tags(value: Array<CfnScheduledQuery.TagsItemsProperty> | undefined);
    get timezone(): string | undefined;
    set timezone(value: string | undefined);
    /**
     * @cloudformationAttribute CreationTime
     */
    get attrCreationTime(): cdk.IResolvable;
    /**
     * @cloudformationAttribute LastExecutionStatus
     */
    get attrLastExecutionStatus(): string;
    /**
     * @cloudformationAttribute LastTriggeredTime
     */
    get attrLastTriggeredTime(): cdk.IResolvable;
    /**
     ...
     */
    get attrScheduledQueryArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnScheduledQueryProps {
     ...
     */
    readonly destinationConfiguration?: CfnScheduledQuery.DestinationConfigurationProperty | cdk.IResolvable;
    /**
     ...
     */
    readonly tags?: Array<CfnScheduledQuery.TagsItemsProperty>;
    /**
 ...
 */
export declare class CfnTransformer extends cdk.CfnResource implements cdk.IInspectable, ITransformerRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnTransformer(x: any): x is CfnTransformer;
    /**
     * Specify either the name or ARN of the log group to create the transformer for.
     */
    private _logGroupIdentifier;
    /**
     ...
     * Specify either the name or ARN of the log group to create the transformer for.
     */
    get logGroupIdentifier(): string;
    /**
     * Specify either the name or ARN of the log group to create the transformer for.
     */
    set logGroupIdentifier(value: string);
    /**
     * This structure is an array that contains the configuration of this log transformer.
     */
    get transformerConfig(): Array<cdk.IResolvable | CfnTransformer.ProcessorProperty> | cdk.IResolvable;
    /**
     * This structure is an array that contains the configuration of this log transformer.
     */
    set transformerConfig(value: Array<cdk.IResolvable | CfnTransformer.ProcessorProperty> | cdk.IResolvable);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IAccountPolicyRef, AccountPolicyReference };
export type { IDestinationRef, DestinationReference };
export type { ILogGroupRef, LogGroupReference };
export type { ILogStreamRef, LogStreamReference };
export type { IMetricFilterRef, MetricFilterReference };
export type { IQueryDefinitionRef, QueryDefinitionReference };
export type { IResourcePolicyRef, ResourcePolicyReference };
export type { ISubscriptionFilterRef, SubscriptionFilterReference };
export type { IDeliveryRef, DeliveryReference };
export type { IDeliveryDestinationRef, DeliveryDestinationReference };
export type { IDeliverySourceRef, DeliverySourceReference };
export type { IIntegrationRef, IntegrationReference };
export type { ILogAnomalyDetectorRef, LogAnomalyDetectorReference };
export type { IScheduledQueryRef, ScheduledQueryReference };
export type { ITransformerRef, TransformerReference };
