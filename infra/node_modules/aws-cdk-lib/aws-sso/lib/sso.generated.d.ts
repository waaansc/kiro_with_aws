...
import { ApplicationAssignmentReference, ApplicationProviderReference, ApplicationReference, AssignmentReference, IApplicationAssignmentRef, IApplicationProviderRef, IApplicationRef, IAssignmentRef, IInstanceAccessControlAttributeConfigurationRef, IInstanceRef, InstanceAccessControlAttributeConfigurationReference, InstanceReference, IPermissionSetRef, PermissionSetReference } from "../../interfaces/generated/aws-sso-interfaces.generated";
/**
...
export declare class CfnInstanceAccessControlAttributeConfiguration extends cdk.CfnResource implements cdk.IInspectable, IInstanceAccessControlAttributeConfigurationRef {
     ...
     * Lists the attributes that are configured for ABAC in the specified  instance.
     */
    get accessControlAttributes(): Array<CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Lists the attributes that are configured for ABAC in the specified  instance.
     */
    set accessControlAttributes(value: Array<CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The InstanceAccessControlAttributeConfiguration property has been deprecated but is still supported for backwards compatibility purposes.
     *
     * @deprecated this property has been deprecated
     */
    get instanceAccessControlAttributeConfiguration(): CfnInstanceAccessControlAttributeConfiguration.InstanceAccessControlAttributeConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The InstanceAccessControlAttributeConfiguration property has been deprecated but is still supported for backwards compatibility purposes.
     *
     * @deprecated this property has been deprecated
     */
    set instanceAccessControlAttributeConfiguration(value: CfnInstanceAccessControlAttributeConfiguration.InstanceAccessControlAttributeConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The ARN of the  instance under which the operation will be executed.
     */
    get instanceArn(): string;
...
export declare class CfnPermissionSet extends cdk.CfnResource implements cdk.IInspectable, IPermissionSetRef, cdk.ITaggable {
     ...
     */
    private _customerManagedPolicyReferences?;
    /**
     ...
     * Specifies the names and paths of the customer managed policies that you have attached to your permission set.
     */
    get customerManagedPolicyReferences(): Array<CfnPermissionSet.CustomerManagedPolicyReferenceProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Specifies the names and paths of the customer managed policies that you have attached to your permission set.
     */
    set customerManagedPolicyReferences(value: Array<CfnPermissionSet.CustomerManagedPolicyReferenceProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The description of the `PermissionSet` .
     */
     ...
     * The inline policy that is attached to the permission set.
     */
    get inlinePolicy(): any | cdk.IResolvable | undefined;
    /**
     * The inline policy that is attached to the permission set.
     */
    set inlinePolicy(value: any | cdk.IResolvable | undefined);
    /**
     * The ARN of the  instance under which the operation will be executed.
     */
    get instanceArn(): string;
     ...
     * A structure that stores a list of managed policy ARNs that describe the associated AWS managed policy.
     */
    get managedPolicies(): Array<string> | undefined;
    /**
     * A structure that stores a list of managed policy ARNs that describe the associated AWS managed policy.
     */
    set managedPolicies(value: Array<string> | undefined);
    /**
     * The name of the permission set.
     */
    get name(): string;
     ...
     * Specifies the configuration of the AWS managed or customer managed policy that you want to set as a permissions boundary.
     */
    get permissionsBoundary(): cdk.IResolvable | CfnPermissionSet.PermissionsBoundaryProperty | undefined;
    /**
     * Specifies the configuration of the AWS managed or customer managed policy that you want to set as a permissions boundary.
     */
    set permissionsBoundary(value: cdk.IResolvable | CfnPermissionSet.PermissionsBoundaryProperty | undefined);
    /**
     * Used to redirect users within the application during the federation authentication process.
     */
    get relayStateType(): string | undefined;
    /**
     * Used to redirect users within the application during the federation authentication process.
     */
    set relayStateType(value: string | undefined);
    /**
     * The length of time that the application user sessions are valid for in the ISO-8601 standard.
     */
    get sessionDuration(): string | undefined;
    /**
     * The length of time that the application user sessions are valid for in the ISO-8601 standard.
     */
    set sessionDuration(value: string | undefined);
    /**
     * The tags to attach to the new `PermissionSet` .
     */
     ...
     */
    get attrPermissionSetArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef, cdk.ITaggableV2 {
     ...
     * A structure that describes the options for the access portal associated with this application.
     */
    get portalOptions(): cdk.IResolvable | CfnApplication.PortalOptionsConfigurationProperty | undefined;
    /**
     * A structure that describes the options for the access portal associated with this application.
     */
    set portalOptions(value: cdk.IResolvable | CfnApplication.PortalOptionsConfigurationProperty | undefined);
    /**
     * The current status of the application in this instance of IAM Identity Center.
     */
     ...
     */
    get attrIdentityStoreArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 *
 * @cloudformationResource AWS::SSO::ApplicationProvider
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sso-applicationprovider.html
 */
export declare class CfnApplicationProvider extends cdk.CfnResource implements cdk.IInspectable, IApplicationProviderRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnApplicationProvider from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnApplicationProvider;
    /**
     * Checks whether the given object is a CfnApplicationProvider
     */
    static isCfnApplicationProvider(x: any): x is CfnApplicationProvider;
    static arnForApplicationProvider(resource: IApplicationProviderRef): string;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnApplicationProviderProps);
    get applicationProviderRef(): ApplicationProviderReference;
    /**
     * The ARN of the application provider.
     *
     * @cloudformationAttribute ApplicationProviderArn
     */
    get attrApplicationProviderArn(): string;
    /**
     * A structure that describes how IAM Identity Center represents the application provider in the portal.
     *
     * @cloudformationAttribute DisplayData
     */
    get attrDisplayData(): cdk.IResolvable;
    /**
     * The protocol used to federate to the application provider.
     *
     * @cloudformationAttribute FederationProtocol
     */
    get attrFederationProtocol(): string;
    /**
     * A structure that describes the configuration of a resource server.
     *
     * @cloudformationAttribute ResourceServerConfig
     */
    get attrResourceServerConfig(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnApplicationProvider {
    /**
     * A structure that describes how IAM Identity Center represents the application provider in the portal.
     *
     * @struct
    ...
    interface ResourceServerConfigProperty {
         ...
         */
        readonly scopes?: cdk.IResolvable | Record<string, cdk.IResolvable | CfnApplicationProvider.ResourceServerScopeDetailsProperty>;
    }
    /**
     ...
     */
    interface ResourceServerScopeDetailsProperty {
        /**
...
/**
 * Properties for defining a `CfnApplicationProvider`
 *
 * @struct
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sso-applicationprovider.html
 */
export interface CfnApplicationProviderProps {
}
/**
...
export declare class CfnInstance extends cdk.CfnResource implements cdk.IInspectable, IInstanceRef, cdk.ITaggableV2 {
     ...
     */
    get attrIdentityStoreId(): string;
    /**
...
export type { IApplicationProviderRef, ApplicationProviderReference };
