...
import { CapacityReservationReference, DataCatalogReference, ICapacityReservationRef, IDataCatalogRef, INamedQueryRef, IPreparedStatementRef, ISessionRef, IWorkGroupRef, NamedQueryReference, PreparedStatementReference, SessionReference, WorkGroupReference } from "../../interfaces/generated/aws-athena-interfaces.generated";
...
export declare class CfnSession extends cdk.CfnResource implements cdk.IInspectable, ISessionRef {
     ...
     * Contains engine data processing unit (DPU) configuration settings.
     */
    get engineConfiguration(): CfnSession.EngineConfigurationProperty | cdk.IResolvable;
    /**
     * Contains engine data processing unit (DPU) configuration settings.
     */
    set engineConfiguration(value: CfnSession.EngineConfigurationProperty | cdk.IResolvable);
    /**
     * The ARN of the execution role used to access user resources for Spark sessions and Identity Center enabled workgroups.
     */
...
export declare namespace CfnSession {
    /**
     * Contains engine data processing unit (DPU) configuration settings.
     *
     * @struct
...
export interface CfnSessionProps {
     ...
     */
    readonly engineConfiguration: CfnSession.EngineConfigurationProperty | cdk.IResolvable;
    /**
     * The ARN of the execution role used to access user resources for Spark sessions and Identity Center enabled workgroups.
     *
