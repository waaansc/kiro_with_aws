...
export declare class CfnWorkspace extends cdk.CfnResource implements cdk.IInspectable, IWorkspaceRef, cdk.ITaggable {
     ...
     */
    private _alertManagerDefinition?;
    /**
     ...
     */
    private _queryLoggingConfiguration?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * The alert manager definition, a YAML configuration for the alert manager in your Amazon Managed Service for Prometheus workspace.
     */
    get alertManagerDefinition(): string | undefined;
    /**
     * The alert manager definition, a YAML configuration for the alert manager in your Amazon Managed Service for Prometheus workspace.
     */
    set alertManagerDefinition(value: string | undefined);
    /**
     * The alias that is assigned to this workspace to help identify it.
     */
     ...
     * Contains information about the logging configuration for the workspace.
     */
    get loggingConfiguration(): cdk.IResolvable | CfnWorkspace.LoggingConfigurationProperty | undefined;
    /**
     * Contains information about the logging configuration for the workspace.
     */
    set loggingConfiguration(value: cdk.IResolvable | CfnWorkspace.LoggingConfigurationProperty | undefined);
    /**
     * The definition of logging configuration in an Amazon Managed Service for Prometheus workspace.
     */
    get queryLoggingConfiguration(): cdk.IResolvable | CfnWorkspace.QueryLoggingConfigurationProperty | undefined;
    /**
     * The definition of logging configuration in an Amazon Managed Service for Prometheus workspace.
     */
    set queryLoggingConfiguration(value: cdk.IResolvable | CfnWorkspace.QueryLoggingConfigurationProperty | undefined);
    /**
     * The list of tag keys and values that are associated with the workspace.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * Use this structure to define label sets and the ingestion limits for time series that match label sets, and to specify the retention period of the workspace.
     */
    get workspaceConfiguration(): cdk.IResolvable | CfnWorkspace.WorkspaceConfigurationProperty | undefined;
    /**
     * Use this structure to define label sets and the ingestion limits for time series that match label sets, and to specify the retention period of the workspace.
     */
    set workspaceConfiguration(value: cdk.IResolvable | CfnWorkspace.WorkspaceConfigurationProperty | undefined);
    /**
     ...
     */
    get attrPrometheusEndpoint(): string;
    /**
...
export declare class CfnAnomalyDetector extends cdk.CfnResource implements cdk.IInspectable, IAnomalyDetectorRef, cdk.ITaggableV2 {
     ...
     * The algorithm configuration of the anomaly detector.
     */
    get configuration(): CfnAnomalyDetector.AnomalyDetectorConfigurationProperty | cdk.IResolvable;
    /**
     * The algorithm configuration of the anomaly detector.
     */
    set configuration(value: CfnAnomalyDetector.AnomalyDetectorConfigurationProperty | cdk.IResolvable);
    /**
     * The frequency, in seconds, at which the anomaly detector evaluates metrics.
     */
    get evaluationIntervalInSeconds(): number | undefined;
    /**
     * The frequency, in seconds, at which the anomaly detector evaluates metrics.
     */
    set evaluationIntervalInSeconds(value: number | undefined);
    /**
     * The Amazon Managed Service for Prometheus metric labels associated with the anomaly detector.
     */
    get labels(): Array<cdk.IResolvable | CfnAnomalyDetector.LabelProperty> | cdk.IResolvable | undefined;
    /**
     * The Amazon Managed Service for Prometheus metric labels associated with the anomaly detector.
     */
    set labels(value: Array<cdk.IResolvable | CfnAnomalyDetector.LabelProperty> | cdk.IResolvable | undefined);
    /**
     * The action taken when data is missing during evaluation.
     */
    get missingDataAction(): cdk.IResolvable | CfnAnomalyDetector.MissingDataActionProperty | undefined;
    /**
     * The action taken when data is missing during evaluation.
     */
    set missingDataAction(value: cdk.IResolvable | CfnAnomalyDetector.MissingDataActionProperty | undefined);
    /**
     * The tags applied to the anomaly detector.
     */
...
export declare class CfnScraper extends cdk.CfnResource implements cdk.IInspectable, IScraperRef, cdk.ITaggableV2 {
     ...
     * The definition of logging configuration in an Amazon Managed Service for Prometheus workspace.
     */
    private _scraperLoggingConfiguration?;
    /**
     ...
     * The Amazon Managed Service for Prometheus workspace the scraper sends metrics to.
     */
    get destination(): CfnScraper.DestinationProperty | cdk.IResolvable;
    /**
     * The Amazon Managed Service for Prometheus workspace the scraper sends metrics to.
     */
    set destination(value: CfnScraper.DestinationProperty | cdk.IResolvable);
    /**
     * The role configuration in an Amazon Managed Service for Prometheus scraper.
     */
    get roleConfiguration(): cdk.IResolvable | CfnScraper.RoleConfigurationProperty | undefined;
    /**
     * The role configuration in an Amazon Managed Service for Prometheus scraper.
     */
    set roleConfiguration(value: cdk.IResolvable | CfnScraper.RoleConfigurationProperty | undefined);
    /**
     * The configuration in use by the scraper.
     */
    get scrapeConfiguration(): cdk.IResolvable | CfnScraper.ScrapeConfigurationProperty;
    /**
     * The configuration in use by the scraper.
     */
    set scrapeConfiguration(value: cdk.IResolvable | CfnScraper.ScrapeConfigurationProperty);
    /**
     * The definition of logging configuration in an Amazon Managed Service for Prometheus workspace.
     */
    get scraperLoggingConfiguration(): cdk.IResolvable | CfnScraper.ScraperLoggingConfigurationProperty | undefined;
    /**
     * The definition of logging configuration in an Amazon Managed Service for Prometheus workspace.
     */
    set scraperLoggingConfiguration(value: cdk.IResolvable | CfnScraper.ScraperLoggingConfigurationProperty | undefined);
    /**
     * The Amazon EKS cluster from which the scraper collects metrics.
     */
    get source(): cdk.IResolvable | CfnScraper.SourceProperty;
    /**
     * The Amazon EKS cluster from which the scraper collects metrics.
     */
    set source(value: cdk.IResolvable | CfnScraper.SourceProperty);
    /**
     * (Optional) The list of tag keys and values associated with the scraper.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare namespace CfnScraper {
    ...
    interface SourceProperty {
         ...
         */
        readonly vpcConfiguration?: cdk.IResolvable | CfnScraper.VpcConfigurationProperty;
    }
    /**
...
export interface CfnScraperProps {
     ...
     */
    readonly scraperLoggingConfiguration?: cdk.IResolvable | CfnScraper.ScraperLoggingConfigurationProperty;
    /**
     * The Amazon EKS cluster from which the scraper collects metrics.
     *
...
export type { IRuleGroupsNamespaceRef, RuleGroupsNamespaceReference };
...
export type { IScraperRef, ScraperReference };
