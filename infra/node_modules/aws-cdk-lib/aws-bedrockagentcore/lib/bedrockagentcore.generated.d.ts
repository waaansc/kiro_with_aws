...
import { ApiKeyCredentialProviderReference, BrowserCustomReference, BrowserProfileReference, BrowserReference, CodeInterpreterCustomReference, CodeInterpreterReference, ConfigurationBundleReference, DatasetReference, EvaluatorReference, GatewayReference, GatewayTargetReference, HarnessReference, IApiKeyCredentialProviderRef, IBrowserCustomRef, IBrowserProfileRef, IBrowserRef, ICodeInterpreterCustomRef, ICodeInterpreterRef, IConfigurationBundleRef, IDatasetRef, IEvaluatorRef, IGatewayRef, IGatewayTargetRef, IHarnessRef, IMemoryRef, IOAuth2CredentialProviderRef, IOnlineEvaluationConfigRef, IPaymentConnectorRef, IPaymentCredentialProviderRef, IPaymentManagerRef, IPolicyEngineRef, IPolicyRef, IResourcePolicyRef, IRuntimeEndpointRef, IRuntimeRef, ITokenVaultRef, IWorkloadIdentityRef, MemoryReference, OAuth2CredentialProviderReference, OnlineEvaluationConfigReference, PaymentConnectorReference, PaymentCredentialProviderReference, PaymentManagerReference, PolicyEngineReference, PolicyReference, ResourcePolicyReference, RuntimeEndpointReference, RuntimeReference, TokenVaultReference, WorkloadIdentityReference } from "../../interfaces/generated/aws-bedrockagentcore-interfaces.generated";
/**
 ...
 *
 * @cloudformationResource AWS::BedrockAgentCore::CodeInterpreter
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-codeinterpreter.html
 */
export declare class CfnCodeInterpreter extends cdk.CfnResource implements cdk.IInspectable, ICodeInterpreterRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnCodeInterpreter from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnCodeInterpreter;
    /**
     * Checks whether the given object is a CfnCodeInterpreter
     */
    static isCfnCodeInterpreter(x: any): x is CfnCodeInterpreter;
    static arnForCodeInterpreter(resource: ICodeInterpreterRef): string;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnCodeInterpreterProps);
    get codeInterpreterRef(): CodeInterpreterReference;
    /**
...
/**
 * Properties for defining a `CfnCodeInterpreter`
 *
 * @struct
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-codeinterpreter.html
 */
export interface CfnCodeInterpreterProps {
}
/**
...
export declare namespace CfnGateway {
    ...
    interface CustomJWTAuthorizerConfigurationProperty {
         ...
         */
        readonly privateEndpoint?: cdk.IResolvable | CfnGateway.PrivateEndpointProperty;
    }
    /**
    ...
    interface PrivateEndpointProperty {
         ...
         */
        readonly managedVpcResource?: cdk.IResolvable | CfnGateway.ManagedVpcResourceProperty;
        /**
         ...
         */
        readonly selfManagedLatticeResource?: cdk.IResolvable | CfnGateway.SelfManagedLatticeResourceProperty;
    }
    /**
     * @struct
     * @stability external
...
export declare namespace CfnGatewayTarget {
    ...
    interface TargetConfigurationProperty {
         ...
         */
        readonly inference?: CfnGatewayTarget.InferenceTargetConfigurationProperty | cdk.IResolvable;
        /**
    ...
    interface InferenceTargetConfigurationProperty {
         ...
         */
        readonly connector?: CfnGatewayTarget.InferenceConnectorTargetConfigurationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly provider?: CfnGatewayTarget.InferenceProviderTargetConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface InferenceConnectorTargetConfigurationProperty {
         ...
         */
        readonly source: CfnGatewayTarget.InferenceConnectorSourceProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface InferenceProviderTargetConfigurationProperty {
         ...
         */
        readonly modelMapping?: cdk.IResolvable | CfnGatewayTarget.ModelMappingProperty;
        /**
         ...
         */
        readonly operations?: Array<CfnGatewayTarget.InferenceOperationConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface ModelMappingProperty {
         ...
         */
        readonly providerPrefix?: cdk.IResolvable | CfnGatewayTarget.ProviderPrefixProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface InferenceOperationConfigurationProperty {
         ...
         */
        readonly models?: Array<cdk.IResolvable | CfnGatewayTarget.ModelEntryProperty> | cdk.IResolvable;
        /**
...
export declare namespace CfnRuntime {
    ...
    interface CustomJWTAuthorizerConfigurationProperty {
         ...
         */
        readonly allowedWorkloadConfiguration?: CfnRuntime.AllowedWorkloadConfigurationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly privateEndpoint?: cdk.IResolvable | CfnRuntime.PrivateEndpointProperty;
        /**
         ...
         */
        readonly privateEndpointOverrides?: Array<cdk.IResolvable | CfnRuntime.PrivateEndpointOverrideProperty> | cdk.IResolvable;
    }
    /**
     * Required custom claim.
     *
    ...
    interface AllowedWorkloadConfigurationProperty {
         ...
         */
        readonly hostingEnvironments?: Array<CfnRuntime.HostingEnvironmentProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
    ...
    interface PrivateEndpointProperty {
         ...
         */
        readonly managedVpcResource?: cdk.IResolvable | CfnRuntime.ManagedVpcResourceProperty;
        /**
         ...
         */
        readonly selfManagedLatticeResource?: cdk.IResolvable | CfnRuntime.SelfManagedLatticeResourceProperty;
    }
    /**
     * Self-managed VPC Lattice resource configuration.
     *
 ...
 *
 * @cloudformationResource AWS::BedrockAgentCore::TokenVault
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-tokenvault.html
 */
export declare class CfnTokenVault extends cdk.CfnResource implements cdk.IInspectable, ITokenVaultRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnTokenVault from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnTokenVault;
    /**
     * Checks whether the given object is a CfnTokenVault
     */
    static isCfnTokenVault(x: any): x is CfnTokenVault;
    static arnForTokenVault(resource: ITokenVaultRef): string;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnTokenVaultProps);
    get tokenVaultRef(): TokenVaultReference;
    /**
     ...
     *
     * @cloudformationAttribute KmsConfiguration
     */
    get attrKmsConfiguration(): cdk.IResolvable;
    /**
     ...
     *
     * @cloudformationAttribute TokenVaultId
     */
    get attrTokenVaultId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnTokenVault {
    /**
     * Contains the KMS configuration for a resource.
     *
     * @struct
...
/**
 * Properties for defining a `CfnTokenVault`
 *
 * @struct
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-tokenvault.html
 */
export interface CfnTokenVaultProps {
}
/**
...
export type { ICodeInterpreterRef, CodeInterpreterReference };
...
export type { ITokenVaultRef, TokenVaultReference };
