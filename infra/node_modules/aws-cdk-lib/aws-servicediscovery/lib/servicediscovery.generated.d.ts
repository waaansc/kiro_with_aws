...
import { HttpNamespaceReference, IHttpNamespaceRef, IInstanceRef, InstanceReference, IPrivateDnsNamespaceRef, IPublicDnsNamespaceRef, IServiceRef, PrivateDnsNamespaceReference, PublicDnsNamespaceReference, ServiceReference } from "../../interfaces/generated/aws-servicediscovery-interfaces.generated";
/**
...
export declare class CfnHttpNamespace extends cdk.CfnResource implements cdk.IInspectable, IHttpNamespaceRef, cdk.ITaggable {
     ...
     */
    static isCfnHttpNamespace(x: any): x is CfnHttpNamespace;
    static arnForHttpNamespace(resource: IHttpNamespaceRef): string;
    /**
...
export declare class CfnInstance extends cdk.CfnResource implements cdk.IInspectable, IInstanceRef {
     ...
     * A string map that contains the following information for the service that you specify in `ServiceId` :.
     */
    get instanceAttributes(): any | cdk.IResolvable;
    /**
     * A string map that contains the following information for the service that you specify in `ServiceId` :.
     */
    set instanceAttributes(value: any | cdk.IResolvable);
    /**
     * An identifier that you want to associate with the instance. Note the following:.
     */
...
export declare class CfnPrivateDnsNamespace extends cdk.CfnResource implements cdk.IInspectable, IPrivateDnsNamespaceRef, cdk.ITaggable {
     ...
     */
    static isCfnPrivateDnsNamespace(x: any): x is CfnPrivateDnsNamespace;
    static arnForPrivateDnsNamespace(resource: IPrivateDnsNamespaceRef): string;
    /**
     * A description for the namespace.
     */
    private _description?;
     ...
     * Properties for the private DNS namespace.
     */
    get properties(): cdk.IResolvable | CfnPrivateDnsNamespace.PropertiesProperty | undefined;
    /**
     * Properties for the private DNS namespace.
     */
    set properties(value: cdk.IResolvable | CfnPrivateDnsNamespace.PropertiesProperty | undefined);
    /**
     * The tags for the namespace.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnPublicDnsNamespace extends cdk.CfnResource implements cdk.IInspectable, IPublicDnsNamespaceRef, cdk.ITaggable {
     ...
     */
    static isCfnPublicDnsNamespace(x: any): x is CfnPublicDnsNamespace;
    static arnForPublicDnsNamespace(resource: IPublicDnsNamespaceRef): string;
    /**
     * A description for the namespace.
     */
    private _description?;
     ...
     * Properties for the public DNS namespace.
     */
    get properties(): cdk.IResolvable | CfnPublicDnsNamespace.PropertiesProperty | undefined;
    /**
     * Properties for the public DNS namespace.
     */
    set properties(value: cdk.IResolvable | CfnPublicDnsNamespace.PropertiesProperty | undefined);
    /**
     * The tags for the namespace.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnService extends cdk.CfnResource implements cdk.IInspectable, IServiceRef, cdk.ITaggable {
     ...
     * A complex type that contains information about the Route 53 DNS records that you want AWS Cloud Map to create when you register an instance.
     */
    get dnsConfig(): CfnService.DnsConfigProperty | cdk.IResolvable | undefined;
    /**
     * A complex type that contains information about the Route 53 DNS records that you want AWS Cloud Map to create when you register an instance.
     */
    set dnsConfig(value: CfnService.DnsConfigProperty | cdk.IResolvable | undefined);
    /**
     * *Public DNS and HTTP namespaces only.* A complex type that contains settings for an optional health check. If you specify settings for a health check, AWS Cloud Map associates the health check with the records that you specify in `DnsConfig` .
     */
    get healthCheckConfig(): CfnService.HealthCheckConfigProperty | cdk.IResolvable | undefined;
    /**
     * *Public DNS and HTTP namespaces only.* A complex type that contains settings for an optional health check. If you specify settings for a health check, AWS Cloud Map associates the health check with the records that you specify in `DnsConfig` .
     */
    set healthCheckConfig(value: CfnService.HealthCheckConfigProperty | cdk.IResolvable | undefined);
    /**
     * A complex type that contains information about an optional custom health check.
     */
    get healthCheckCustomConfig(): CfnService.HealthCheckCustomConfigProperty | cdk.IResolvable | undefined;
    /**
     * A complex type that contains information about an optional custom health check.
     */
    set healthCheckCustomConfig(value: CfnService.HealthCheckCustomConfigProperty | cdk.IResolvable | undefined);
    /**
     * The name of the service.
     */
     ...
     * A complex type that contains information about attributes associated with a specific service.
     */
    get serviceAttributes(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * A complex type that contains information about attributes associated with a specific service.
     */
    set serviceAttributes(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The tags for the service.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export interface CfnServiceProps {
     ...
     */
    readonly serviceAttributes?: cdk.IResolvable | Record<string, string>;
    /**
     * The tags for the service.
     *
     * Each tag consists of a key and an optional value, both of which you define. Tag keys can have a maximum character length of 128 characters, and tag values can have a maximum length of 256 characters.
...
export type { IHttpNamespaceRef, HttpNamespaceReference };
export type { IInstanceRef, InstanceReference };
export type { IPrivateDnsNamespaceRef, PrivateDnsNamespaceReference };
export type { IPublicDnsNamespaceRef, PublicDnsNamespaceReference };
