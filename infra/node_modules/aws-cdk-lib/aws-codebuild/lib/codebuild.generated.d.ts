...
import { FleetReference, IFleetRef, IProjectRef, IReportGroupRef, ISandboxRef, ISourceCredentialRef, ProjectReference, ReportGroupReference, SandboxReference, SourceCredentialReference } from "../../interfaces/generated/aws-codebuild-interfaces.generated";
/**
 ...
 */
export declare class CfnSandbox extends cdk.CfnResource implements cdk.IInspectable, ISandboxRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnSandbox from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnSandbox;
    /**
     * Checks whether the given object is a CfnSandbox
     */
    static isCfnSandbox(x: any): x is CfnSandbox;
    static arnForSandbox(resource: ISandboxRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnSandboxProps);
    get sandboxRef(): SandboxReference;
    /**
     * The CodeBuild project name.
     */
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codebuild-sandbox.html
 */
export interface CfnSandboxProps {
    /**
     * The CodeBuild project name.
     *
...
export type { ISandboxRef, SandboxReference };
