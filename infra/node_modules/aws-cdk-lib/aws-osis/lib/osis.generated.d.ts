...
import { IPipelineBlueprintRef, IPipelineRef, PipelineBlueprintReference, PipelineReference } from "../../interfaces/generated/aws-osis-interfaces.generated";
/**
 ...
 */
export declare class CfnPipelineBlueprint extends cdk.CfnResource implements cdk.IInspectable, IPipelineBlueprintRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnPipelineBlueprint from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnPipelineBlueprint;
    /**
     * Checks whether the given object is a CfnPipelineBlueprint
     */
    static isCfnPipelineBlueprint(x: any): x is CfnPipelineBlueprint;
    static arnForPipelineBlueprint(resource: IPipelineBlueprintRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnPipelineBlueprintProps);
    get pipelineBlueprintRef(): PipelineBlueprintReference;
    /**
     * The name of the blueprint.
     */
     ...
     * The name of the blueprint.
     */
    set blueprintName(value: string | undefined);
    /**
     ...
     */
    get attrDisplayDescription(): string;
    /**
     * The display name of the blueprint.
     *
     * @cloudformationAttribute DisplayName
     */
    get attrDisplayName(): string;
    /**
     * The YAML configuration of the blueprint.
     *
     * @cloudformationAttribute PipelineConfigurationBody
     */
    get attrPipelineConfigurationBody(): string;
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-osis-pipelineblueprint.html
 */
export interface CfnPipelineBlueprintProps {
    /**
     * The name of the blueprint.
     *
...
export type { IPipelineBlueprintRef, PipelineBlueprintReference };
