...
import { DataDeletionJobReference, DatasetGroupReference, DatasetReference, IDataDeletionJobRef, IDatasetGroupRef, IDatasetRef, IRecipeRef, ISchemaRef, ISolutionRef, RecipeReference, SchemaReference, SolutionReference } from "../../interfaces/generated/aws-personalize-interfaces.generated";
/**
 ...
 */
export declare class CfnRecipe extends cdk.CfnResource implements cdk.IInspectable, IRecipeRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnRecipe(x: any): x is CfnRecipe;
    static arnForRecipe(resource: IRecipeRef): string;
    /**
     ...
     */
    get attrFeatureTransformationArn(): string;
    /**
...
export type { IRecipeRef, RecipeReference };
