...
import { AllGroupMembershipsReference, GroupMembershipReference, GroupReference, IAllGroupMembershipsRef, IGroupMembershipRef, IGroupRef } from "../../interfaces/generated/aws-identitystore-interfaces.generated";
/**
...
export declare class CfnGroupMembership extends cdk.CfnResource implements cdk.IInspectable, IGroupMembershipRef {
     ...
     */
    static isCfnGroupMembership(x: any): x is CfnGroupMembership;
    static arnForGroupMembership(resource: IGroupMembershipRef): string;
    /**
     ...
     * An object containing the identifier of a group member.
     */
    get memberId(): cdk.IResolvable | CfnGroupMembership.MemberIdProperty;
    /**
     * An object containing the identifier of a group member.
     */
    set memberId(value: cdk.IResolvable | CfnGroupMembership.MemberIdProperty);
    /**
     * The identifier for a `GroupMembership` in the identity store.
     *
     * @cloudformationAttribute MembershipId
     */
    get attrMembershipId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnAllGroupMemberships extends cdk.CfnResource implements cdk.IInspectable, IAllGroupMembershipsRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnAllGroupMemberships from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAllGroupMemberships;
    /**
     * Checks whether the given object is a CfnAllGroupMemberships
     */
    static isCfnAllGroupMemberships(x: any): x is CfnAllGroupMemberships;
    static arnForAllGroupMemberships(resource: IAllGroupMembershipsRef): string;
    /**
     * The identifier for a group in the identity store.
     */
    private _groupId?;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnAllGroupMembershipsProps);
    get allGroupMembershipsRef(): AllGroupMembershipsReference;
    /**
     * The identifier for a group in the identity store.
     */
     ...
     * The globally unique identifier for the identity store.
     */
    get identityStoreId(): string | undefined;
    /**
     * The globally unique identifier for the identity store.
     */
    set identityStoreId(value: string | undefined);
    /**
     * An object containing the identifier of a group member.
     */
    get memberId(): cdk.IResolvable | CfnAllGroupMemberships.MemberIdProperty | undefined;
    /**
     * An object containing the identifier of a group member.
     */
    set memberId(value: cdk.IResolvable | CfnAllGroupMemberships.MemberIdProperty | undefined);
    /**
...
export declare namespace CfnAllGroupMemberships {
    /**
     * An object containing the identifier of a group member.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-identitystore-allgroupmemberships.html
 */
export interface CfnAllGroupMembershipsProps {
    /**
     * The identifier for a group in the identity store.
     *
     ...
     */
    readonly memberId?: cdk.IResolvable | CfnAllGroupMemberships.MemberIdProperty;
}
export type { IGroupRef, GroupReference };
export type { IGroupMembershipRef, GroupMembershipReference };
export type { IAllGroupMembershipsRef, AllGroupMembershipsReference };
