...
import { CustomResourceReference, GeneratedTemplateReference, GuardHookReference, HookDefaultVersionReference, HookTypeConfigReference, HookVersionReference, ICustomResourceRef, IGeneratedTemplateRef, IGuardHookRef, IHookDefaultVersionRef, IHookTypeConfigRef, IHookVersionRef, ILambdaHookRef, IMacroRef, IModuleDefaultVersionRef, IModuleVersionRef, IPublicTypeVersionRef, IPublisherRef, IResourceDefaultVersionRef, IResourceScanRef, IResourceVersionRef, IStackRef, IStackSetRef, ITypeActivationRef, IWaitConditionHandleRef, IWaitConditionRef, LambdaHookReference, MacroReference, ModuleDefaultVersionReference, ModuleVersionReference, PublicTypeVersionReference, PublisherReference, ResourceDefaultVersionReference, ResourceScanReference, ResourceVersionReference, StackReference, StackSetReference, TypeActivationReference, WaitConditionHandleReference, WaitConditionReference } from "../../interfaces/generated/aws-cloudformation-interfaces.generated";
import { aws_cloudformation as cloudFormationRefs, aws_iam as iamRefs } from "../../interfaces";
/**
...
export declare class CfnCustomResource extends cdk.CfnResource implements cdk.IInspectable, ICustomResourceRef {
     ...
     */
    static isCfnCustomResource(x: any): x is CfnCustomResource;
    /**
     * The maximum time, in seconds, that can elapse before a custom resource operation times out.
     */
    private _serviceTimeout?;
    /**
     ...
     * The maximum time, in seconds, that can elapse before a custom resource operation times out.
     */
    get serviceTimeout(): number | undefined;
    /**
     * The maximum time, in seconds, that can elapse before a custom resource operation times out.
     */
    set serviceTimeout(value: number | undefined);
    /**
     * The service token, such as an Amazon  topic ARN or Lambda function ARN.
     */
...
export declare class CfnHookDefaultVersion extends cdk.CfnResource implements cdk.IInspectable, IHookDefaultVersionRef {
     ...
     */
    static isCfnHookDefaultVersion(x: any): x is CfnHookDefaultVersion;
    static arnForHookDefaultVersion(resource: IHookDefaultVersionRef): string;
    /**
     ...
     * The version ID of the type configuration.
     */
    get typeVersionArn(): string | undefined;
    /**
     * The version ID of the type configuration.
     */
    set typeVersionArn(value: string | undefined);
    /**
     * The version ID of the type specified.
     */
...
export declare class CfnHookTypeConfig extends cdk.CfnResource implements cdk.IInspectable, IHookTypeConfigRef {
     ...
     */
    static isCfnHookTypeConfig(x: any): x is CfnHookTypeConfig;
    /**
     ...
     * An alias by which to refer to this configuration data.
     */
    get configurationAlias(): string | undefined;
    /**
     * An alias by which to refer to this configuration data.
     */
    set configurationAlias(value: string | undefined);
    /**
     * The Amazon Resource Number (ARN) for the Hook to set `Configuration` for.
     */
    get typeArn(): string | undefined;
    /**
     * The Amazon Resource Number (ARN) for the Hook to set `Configuration` for.
     */
    set typeArn(value: string | undefined);
    /**
     * The unique name for your Hook.
     */
    get typeName(): string | undefined;
     ...
     */
    get attrConfigurationArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnHookVersion extends cdk.CfnResource implements cdk.IInspectable, IHookVersionRef {
     ...
     */
    static isCfnHookVersion(x: any): x is CfnHookVersion;
    static arnForHookVersion(resource: IHookVersionRef): string;
    /**
     ...
     * Contains logging configuration information for an extension.
     */
    get loggingConfig(): cdk.IResolvable | CfnHookVersion.LoggingConfigProperty | undefined;
    /**
     * Contains logging configuration information for an extension.
     */
    set loggingConfig(value: cdk.IResolvable | CfnHookVersion.LoggingConfigProperty | undefined);
    /**
     * A URL to the Amazon S3 bucket for the Hook project package that contains the necessary files for the Hook you want to register.
     */
...
export declare class CfnMacro extends cdk.CfnResource implements cdk.IInspectable, IMacroRef {
     ...
     */
    static isCfnMacro(x: any): x is CfnMacro;
    /**
     ...
     * The ARN of the role CloudFormation should assume when sending log entries to CloudWatch Logs .
     */
    get logRoleArn(): string | undefined;
    /**
     * The ARN of the role CloudFormation should assume when sending log entries to CloudWatch Logs .
     */
    set logRoleArn(value: string | undefined);
    /**
     * The name of the macro.
     */
    get name(): string;
...
export declare class CfnModuleDefaultVersion extends cdk.CfnResource implements cdk.IInspectable, IModuleDefaultVersionRef {
     ...
     */
    static isCfnModuleDefaultVersion(x: any): x is CfnModuleDefaultVersion;
    /**
     ...
     * The name of the module.
     */
    set moduleName(value: string | undefined);
    /**
     * The ID for the specific version of the module.
     */
    get versionId(): string | undefined;
...
export interface CfnModuleDefaultVersionProps {
     ...
     */
    readonly arn?: cloudFormationRefs.IModuleVersionRef | string;
    /**
     * The name of the module.
     *
     * Conditional: You must specify either `Arn` , or `ModuleName` and `VersionId` .
...
export declare class CfnModuleVersion extends cdk.CfnResource implements cdk.IInspectable, IModuleVersionRef {
     ...
     */
    static isCfnModuleVersion(x: any): x is CfnModuleVersion;
    static arnForModuleVersion(resource: IModuleVersionRef): string;
    /**
     ...
     */
    get attrDocumentationUrl(): string;
    /**
...
export declare class CfnPublicTypeVersion extends cdk.CfnResource implements cdk.IInspectable, IPublicTypeVersionRef {
     ...
     */
    static isCfnPublicTypeVersion(x: any): x is CfnPublicTypeVersion;
    /**
     ...
     * The S3 bucket to which CloudFormation delivers the contract test execution logs.
     */
    get logDeliveryBucket(): string | undefined;
    /**
     * The S3 bucket to which CloudFormation delivers the contract test execution logs.
     */
    set logDeliveryBucket(value: string | undefined);
    /**
     * The version number to assign to this version of the extension.
     */
    get publicVersionNumber(): string | undefined;
    /**
     * The version number to assign to this version of the extension.
     */
    set publicVersionNumber(value: string | undefined);
    /**
     * The type of the extension to test.
     */
...
export declare class CfnPublisher extends cdk.CfnResource implements cdk.IInspectable, IPublisherRef {
     ...
     */
    static isCfnPublisher(x: any): x is CfnPublisher;
    /**
     ...
     * Whether you accept the [Terms and Conditions](https://docs.aws.amazon.com/https://cloudformation-registry-documents.s3.amazonaws.com/Terms_and_Conditions_for_AWS_CloudFormation_Registry_Publishers.pdf) for publishing extensions in the CloudFormation registry. You must accept the terms and conditions in order to register to publish public extensions to the CloudFormation registry.
     */
    get acceptTermsAndConditions(): boolean | cdk.IResolvable;
    /**
     * Whether you accept the [Terms and Conditions](https://docs.aws.amazon.com/https://cloudformation-registry-documents.s3.amazonaws.com/Terms_and_Conditions_for_AWS_CloudFormation_Registry_Publishers.pdf) for publishing extensions in the CloudFormation registry. You must accept the terms and conditions in order to register to publish public extensions to the CloudFormation registry.
     */
    set acceptTermsAndConditions(value: boolean | cdk.IResolvable);
    /**
     * If you are using a Bitbucket or GitHub account for identity verification, the Amazon Resource Name (ARN) for your connection to that account.
     */
     ...
     */
    get attrIdentityProvider(): string;
    /**
     ...
     */
    get attrPublisherProfile(): string;
    /**
     * Whether the publisher is verified. Currently, all registered publishers are verified.
     *
     * @cloudformationAttribute PublisherStatus
     */
    get attrPublisherStatus(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnResourceDefaultVersion extends cdk.CfnResource implements cdk.IInspectable, IResourceDefaultVersionRef {
     ...
     */
    static isCfnResourceDefaultVersion(x: any): x is CfnResourceDefaultVersion;
    static arnForResourceDefaultVersion(resource: IResourceDefaultVersionRef): string;
    /**
...
export interface CfnResourceDefaultVersionProps {
     ...
     */
    readonly typeVersionArn?: cloudFormationRefs.IResourceVersionRef | string;
    /**
     * The ID of a specific version of the resource.
     *
...
export declare class CfnResourceVersion extends cdk.CfnResource implements cdk.IInspectable, IResourceVersionRef {
     ...
     */
    static isCfnResourceVersion(x: any): x is CfnResourceVersion;
    static arnForResourceVersion(resource: IResourceVersionRef): string;
    /**
     ...
     * Logging configuration information for a resource.
     */
    get loggingConfig(): cdk.IResolvable | CfnResourceVersion.LoggingConfigProperty | undefined;
    /**
     * Logging configuration information for a resource.
     */
    set loggingConfig(value: cdk.IResolvable | CfnResourceVersion.LoggingConfigProperty | undefined);
    /**
     * A URL to the S3 bucket for the resource project package that contains the necessary files for the resource you want to register.
     */
    get schemaHandlerPackage(): string;
     ...
     */
    get attrProvisioningType(): string;
    /**
...
export declare class CfnStackSet extends cdk.CfnResource implements cdk.IInspectable, IStackSetRef, cdk.ITaggable {
     ...
     */
    static isCfnStackSet(x: any): x is CfnStackSet;
    /**
     ...
     * The Amazon Resource Number (ARN) of the IAM role to use to create this StackSet.
     */
    get administrationRoleArn(): string | undefined;
    /**
     * The Amazon Resource Number (ARN) of the IAM role to use to create this StackSet.
     */
    set administrationRoleArn(value: string | undefined);
    /**
     * Describes whether StackSets automatically deploys to AWS Organizations accounts that are added to a target organization or organizational unit (OU).
     */
    get autoDeployment(): CfnStackSet.AutoDeploymentProperty | cdk.IResolvable | undefined;
    /**
     * Describes whether StackSets automatically deploys to AWS Organizations accounts that are added to a target organization or organizational unit (OU).
     */
    set autoDeployment(value: CfnStackSet.AutoDeploymentProperty | cdk.IResolvable | undefined);
    /**
     * Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.
     */
    get callAs(): string | undefined;
    /**
     * Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.
     */
    set callAs(value: string | undefined);
    /**
     * The capabilities that are allowed in the StackSet.
     */
    get capabilities(): Array<string> | undefined;
    /**
     * The capabilities that are allowed in the StackSet.
     */
    set capabilities(value: Array<string> | undefined);
    /**
     * A description of the StackSet.
     */
    get description(): string | undefined;
     ...
     * Describes whether StackSets performs non-conflicting operations concurrently and queues conflicting operations.
     */
    get managedExecution(): any | cdk.IResolvable | undefined;
    /**
     * Describes whether StackSets performs non-conflicting operations concurrently and queues conflicting operations.
     */
    set managedExecution(value: any | cdk.IResolvable | undefined);
    /**
     * The user-specified preferences for how CloudFormation performs a StackSet operation.
     */
    get operationPreferences(): cdk.IResolvable | CfnStackSet.OperationPreferencesProperty | undefined;
    /**
     * The user-specified preferences for how CloudFormation performs a StackSet operation.
     */
    set operationPreferences(value: cdk.IResolvable | CfnStackSet.OperationPreferencesProperty | undefined);
    /**
     * The input parameters for the StackSet template.
     */
    get parameters(): Array<cdk.IResolvable | CfnStackSet.ParameterProperty> | cdk.IResolvable | undefined;
    /**
     * The input parameters for the StackSet template.
     */
    set parameters(value: Array<cdk.IResolvable | CfnStackSet.ParameterProperty> | cdk.IResolvable | undefined);
    /**
     * Describes how the IAM roles required for StackSet operations are created.
     */
     ...
     * A group of stack instances with parameters in some specific accounts and Regions.
     */
    get stackInstancesGroup(): Array<cdk.IResolvable | CfnStackSet.StackInstancesProperty> | cdk.IResolvable | undefined;
    /**
     * A group of stack instances with parameters in some specific accounts and Regions.
     */
    set stackInstancesGroup(value: Array<cdk.IResolvable | CfnStackSet.StackInstancesProperty> | cdk.IResolvable | undefined);
    /**
     * The name to associate with the StackSet.
     */
...
export interface CfnStackSetProps {
     ...
     */
    readonly administrationRoleArn?: iamRefs.IRoleRef | string;
    /**
     * Describes whether StackSets automatically deploys to AWS Organizations accounts that are added to a target organization or organizational unit (OU).
     *
     * For more information, see [Enable or disable automatic deployments for StackSets in AWS Organizations](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-manage-auto-deployment.html) in the *CloudFormation User Guide* .
     ...
     */
    readonly executionRoleName?: iamRefs.IRoleRef | string;
    /**
     * Describes whether StackSets performs non-conflicting operations concurrently and queues conflicting operations.
     *
...
export declare class CfnTypeActivation extends cdk.CfnResource implements cdk.IInspectable, ITypeActivationRef {
     ...
     */
    static isCfnTypeActivation(x: any): x is CfnTypeActivation;
    static arnForTypeActivation(resource: ITypeActivationRef): string;
    /**
     ...
     * Whether to automatically update the extension in this account and Region when a new *minor* version is published by the extension publisher.
     */
    get autoUpdate(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether to automatically update the extension in this account and Region when a new *minor* version is published by the extension publisher.
     */
    set autoUpdate(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the IAM execution role to use to activate the extension.
     */
    get executionRoleArn(): string | undefined;
     ...
     * Specifies logging configuration information for an extension.
     */
    get loggingConfig(): cdk.IResolvable | CfnTypeActivation.LoggingConfigProperty | undefined;
    /**
     * Specifies logging configuration information for an extension.
     */
    set loggingConfig(value: cdk.IResolvable | CfnTypeActivation.LoggingConfigProperty | undefined);
    /**
     * The major version of this extension you want to activate, if multiple major versions are available.
     */
     ...
     * The major version of this extension you want to activate, if multiple major versions are available.
     */
    set majorVersion(value: string | undefined);
    /**
     * The Amazon Resource Number (ARN) of the public extension.
     */
    get publicTypeArn(): string | undefined;
    /**
     * The Amazon Resource Number (ARN) of the public extension.
     */
    set publicTypeArn(value: string | undefined);
    /**
     * The ID of the extension publisher.
     */
     ...
     * The ID of the extension publisher.
     */
    set publisherId(value: string | undefined);
    /**
     * The extension type.
     */
    get type(): string | undefined;
     ...
     * An alias to assign to the public extension in this account and Region.
     */
    get typeNameAlias(): string | undefined;
    /**
     * An alias to assign to the public extension in this account and Region.
     */
    set typeNameAlias(value: string | undefined);
    /**
     * Manually updates a previously-activated type to a new major or minor version, if available.
     */
    get versionBump(): string | undefined;
    /**
     * Manually updates a previously-activated type to a new major or minor version, if available.
     */
    set versionBump(value: string | undefined);
    /**
...
export declare class CfnWaitCondition extends cdk.CfnResource implements cdk.IInspectable, IWaitConditionRef {
     ...
     */
    static isCfnWaitCondition(x: any): x is CfnWaitCondition;
    /**
     ...
     * A reference to the wait condition handle used to signal this wait condition.
     */
    set handle(value: string | undefined);
    /**
     * The length of time (in seconds) to wait for the number of signals that the `Count` property specifies.
     */
...
export declare class CfnWaitConditionHandle extends cdk.CfnResource implements cdk.IInspectable, IWaitConditionHandleRef {
     ...
     */
    static isCfnWaitConditionHandle(x: any): x is CfnWaitConditionHandle;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
 ...
 */
export declare class CfnGeneratedTemplate extends cdk.CfnResource implements cdk.IInspectable, IGeneratedTemplateRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnGeneratedTemplate from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnGeneratedTemplate;
    /**
     * Checks whether the given object is a CfnGeneratedTemplate
     */
    static isCfnGeneratedTemplate(x: any): x is CfnGeneratedTemplate;
    static arnForGeneratedTemplate(resource: IGeneratedTemplateRef): string;
    /**
     * The name assigned to the generated template.
     */
    private _generatedTemplateName;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnGeneratedTemplateProps);
    get generatedTemplateRef(): GeneratedTemplateReference;
    /**
     * The name assigned to the generated template.
     */
    get generatedTemplateName(): string;
    /**
     * The name assigned to the generated template.
     */
    set generatedTemplateName(value: string);
    /**
     * The configuration details of the generated template.
     */
    get templateConfiguration(): cdk.IResolvable | CfnGeneratedTemplate.TemplateConfigurationProperty | undefined;
    /**
     * The configuration details of the generated template.
     */
    set templateConfiguration(value: cdk.IResolvable | CfnGeneratedTemplate.TemplateConfigurationProperty | undefined);
    /**
     ...
     */
    get attrGeneratedTemplateId(): string;
    /**
     ...
     */
    get attrProgress(): cdk.IResolvable;
    /**
...
export declare namespace CfnGeneratedTemplate {
    /**
     * The configuration details of the generated template.
     *
     * @struct
    ...
    interface TemplateProgressProperty {
         ...
         */
        readonly resourcesPending?: number;
        /**
         ...
         */
        readonly resourcesProcessing?: number;
        /**
         ...
         */
        readonly resourcesSucceeded?: number;
    }
}
/**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudformation-generatedtemplate.html
 */
export interface CfnGeneratedTemplateProps {
    /**
     * The name assigned to the generated template.
     *
     ...
     */
    readonly templateConfiguration?: cdk.IResolvable | CfnGeneratedTemplate.TemplateConfigurationProperty;
}
/**
...
export declare class CfnGuardHook extends cdk.CfnResource implements cdk.IInspectable, IGuardHookRef {
     ...
     */
    static isCfnGuardHook(x: any): x is CfnGuardHook;
    /**
     ...
     */
    private _ruleLocation;
    /**
     * Specifies the stack level filters for the Hook.
     */
    private _stackFilters?;
    /**
     * Specifies the target filters for the Hook.
     */
    private _targetFilters?;
    /**
     * Specifies the list of operations the Hook is run against.
     */
    private _targetOperations;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * Specifies how the Hook responds when rules fail their evaluation.
     */
    get failureMode(): string;
    /**
     * Specifies how the Hook responds when rules fail their evaluation.
     */
    set failureMode(value: string);
    /**
     * Specifies if the Hook is `ENABLED` or `DISABLED` .
     */
    get hookStatus(): string;
    /**
     * Specifies if the Hook is `ENABLED` or `DISABLED` .
     */
    set hookStatus(value: string);
    /**
     * Specifies the name of an S3 bucket to store the Guard output report.
     */
    get logBucket(): string | undefined;
    /**
     * Specifies the name of an S3 bucket to store the Guard output report.
     */
    set logBucket(value: string | undefined);
    /**
     * Specifies the S3 location of your input parameters.
     */
    get options(): cdk.IResolvable | CfnGuardHook.OptionsProperty | undefined;
    /**
     * Specifies the S3 location of your input parameters.
     */
    set options(value: cdk.IResolvable | CfnGuardHook.OptionsProperty | undefined);
    /**
     * Specifies the S3 location of your Guard rules.
     */
    get ruleLocation(): cdk.IResolvable | CfnGuardHook.S3LocationProperty;
    /**
     * Specifies the S3 location of your Guard rules.
     */
    set ruleLocation(value: cdk.IResolvable | CfnGuardHook.S3LocationProperty);
    /**
     * Specifies the stack level filters for the Hook.
     */
    get stackFilters(): cdk.IResolvable | CfnGuardHook.StackFiltersProperty | undefined;
    /**
     * Specifies the stack level filters for the Hook.
     */
    set stackFilters(value: cdk.IResolvable | CfnGuardHook.StackFiltersProperty | undefined);
    /**
     * Specifies the target filters for the Hook.
     */
    get targetFilters(): cdk.IResolvable | CfnGuardHook.TargetFiltersProperty | undefined;
    /**
     * Specifies the target filters for the Hook.
     */
    set targetFilters(value: cdk.IResolvable | CfnGuardHook.TargetFiltersProperty | undefined);
    /**
     * Specifies the list of operations the Hook is run against.
     */
    get targetOperations(): Array<string>;
    /**
     * Specifies the list of operations the Hook is run against.
     */
    set targetOperations(value: Array<string>);
    /**
     * Returns the ARN of a Guard Hook.
     *
     * @cloudformationAttribute HookArn
     */
    get attrHookArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnGuardHook {
    ...
    interface OptionsProperty {
         ...
         */
        readonly inputParams?: Array<cdk.IResolvable | CfnGuardHook.S3LocationProperty> | cdk.IResolvable | CfnGuardHook.S3LocationProperty;
    }
}
/**
...
export declare class CfnLambdaHook extends cdk.CfnResource implements cdk.IInspectable, ILambdaHookRef {
     ...
     */
    static isCfnLambdaHook(x: any): x is CfnLambdaHook;
    /**
     * The type name alias for the Hook. This alias must be unique per account and Region.
     */
    private _alias;
     ...
     * Specifies the Lambda function for the Hook. You can use:.
     */
    get lambdaFunction(): string;
    /**
     * Specifies the Lambda function for the Hook. You can use:.
     */
    set lambdaFunction(value: string);
    /**
     * Contains logging configuration information for an extension.
     */
    get loggingConfig(): cdk.IResolvable | CfnLambdaHook.LoggingConfigProperty | undefined;
    /**
     * Contains logging configuration information for an extension.
     */
    set loggingConfig(value: cdk.IResolvable | CfnLambdaHook.LoggingConfigProperty | undefined);
    /**
     * Specifies the stack level filters for the Hook.
     */
    get stackFilters(): cdk.IResolvable | CfnLambdaHook.StackFiltersProperty | undefined;
    /**
     * Specifies the stack level filters for the Hook.
     */
    set stackFilters(value: cdk.IResolvable | CfnLambdaHook.StackFiltersProperty | undefined);
    /**
     * Specifies the target filters for the Hook.
     */
    get targetFilters(): cdk.IResolvable | CfnLambdaHook.TargetFiltersProperty | undefined;
    /**
     * Specifies the target filters for the Hook.
     */
    set targetFilters(value: cdk.IResolvable | CfnLambdaHook.TargetFiltersProperty | undefined);
    /**
     * Specifies the list of operations the Hook is run against.
     */
    get targetOperations(): Array<string>;
...
export interface CfnLambdaHookProps {
     ...
     */
    readonly loggingConfig?: cdk.IResolvable | CfnLambdaHook.LoggingConfigProperty;
    /**
     * Specifies the stack level filters for the Hook.
     *
     * Example stack level filter in JSON:
 ...
 */
export declare class CfnResourceScan extends cdk.CfnResource implements cdk.IInspectable, IResourceScanRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnResourceScan from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnResourceScan;
    /**
     * Checks whether the given object is a CfnResourceScan
     */
    static isCfnResourceScan(x: any): x is CfnResourceScan;
    static arnForResourceScan(resource: IResourceScanRef): string;
    /**
     * The scan filters to use.
     */
    private _scanFilters?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnResourceScanProps);
    get resourceScanRef(): ResourceScanReference;
    /**
     * The scan filters to use.
     */
    get scanFilters(): Array<cdk.IResolvable | CfnResourceScan.ScanFilterProperty> | cdk.IResolvable | undefined;
    /**
     * The scan filters to use.
     */
    set scanFilters(value: Array<cdk.IResolvable | CfnResourceScan.ScanFilterProperty> | cdk.IResolvable | undefined);
    /**
     * The percentage of the resource scan that has been completed.
     *
     * @cloudformationAttribute PercentageCompleted
     */
    get attrPercentageCompleted(): cdk.IResolvable;
    /**
     * The Amazon Resource Name (ARN) of the resource scan.
     *
     * @cloudformationAttribute ResourceScanId
     */
    get attrResourceScanId(): string;
    /**
     * The unique identifier portion of the resource scan ARN.
     *
     * @cloudformationAttribute ScanId
     */
    get attrScanId(): string;
    /**
...
export declare namespace CfnResourceScan {
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudformation-resourcescan.html
 */
export interface CfnResourceScanProps {
    /**
     * The scan filters to use.
     *
     ...
     */
    readonly scanFilters?: Array<cdk.IResolvable | CfnResourceScan.ScanFilterProperty> | cdk.IResolvable;
}
export type { ICustomResourceRef, CustomResourceReference };
export type { IHookDefaultVersionRef, HookDefaultVersionReference };
export type { IHookTypeConfigRef, HookTypeConfigReference };
export type { IHookVersionRef, HookVersionReference };
export type { IMacroRef, MacroReference };
export type { IModuleDefaultVersionRef, ModuleDefaultVersionReference };
export type { IModuleVersionRef, ModuleVersionReference };
export type { IPublicTypeVersionRef, PublicTypeVersionReference };
export type { IPublisherRef, PublisherReference };
export type { IResourceDefaultVersionRef, ResourceDefaultVersionReference };
export type { IResourceVersionRef, ResourceVersionReference };
export type { IStackRef, StackReference };
export type { IStackSetRef, StackSetReference };
export type { ITypeActivationRef, TypeActivationReference };
export type { IWaitConditionRef, WaitConditionReference };
export type { IWaitConditionHandleRef, WaitConditionHandleReference };
export type { IGeneratedTemplateRef, GeneratedTemplateReference };
export type { IGuardHookRef, GuardHookReference };
export type { ILambdaHookRef, LambdaHookReference };
export type { IResourceScanRef, ResourceScanReference };
