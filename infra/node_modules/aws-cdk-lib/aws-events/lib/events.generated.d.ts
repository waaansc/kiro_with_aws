...
import { ApiDestinationReference, ArchiveReference, ConnectionReference, EndpointReference, EventBusPolicyReference, EventBusReference, IApiDestinationRef, IArchiveRef, IConnectionRef, IEndpointRef, IEventBusPolicyRef, IEventBusRef, IReplayRef, IRuleRef, ReplayReference, RuleReference } from "../../interfaces/generated/aws-events-interfaces.generated";
import { aws_events as eventsRefs, aws_iam as iamRefs } from "../../interfaces";
/**
...
export declare class CfnApiDestination extends cdk.CfnResource implements cdk.IInspectable, IApiDestinationRef {
     ...
     */
    static isCfnApiDestination(x: any): x is CfnApiDestination;
    /**
     * Creates a new IApiDestinationRef from an ARN
     */
    static fromApiDestinationArn(scope: constructs.Construct, id: string, arn: string): IApiDestinationRef;
    /**
     * Creates a new IApiDestinationRef from a apiDestinationName
     */
    static fromApiDestinationName(scope: constructs.Construct, id: string, apiDestinationName: string): IApiDestinationRef;
    static arnForApiDestination(resource: IApiDestinationRef): string;
    /**
     ...
     * The maximum number of requests per second to send to the HTTP invocation endpoint.
     */
    get invocationRateLimitPerSecond(): number | undefined;
    /**
     * The maximum number of requests per second to send to the HTTP invocation endpoint.
     */
    set invocationRateLimitPerSecond(value: number | undefined);
    /**
     * The name for the API destination to create.
     */
...
export declare class CfnArchive extends cdk.CfnResource implements cdk.IInspectable, IArchiveRef {
     ...
     */
    static isCfnArchive(x: any): x is CfnArchive;
    /**
     * Creates a new IArchiveRef from an ARN
     */
    static fromArchiveArn(scope: constructs.Construct, id: string, arn: string): IArchiveRef;
    /**
     * Creates a new IArchiveRef from a archiveName
     */
    static fromArchiveName(scope: constructs.Construct, id: string, archiveName: string): IArchiveRef;
    static arnForArchive(resource: IArchiveRef): string;
    /**
     ...
     * The name for the archive to create.
     */
    set archiveName(value: string | undefined);
    /**
     * A description for the archive.
     */
    get description(): string | undefined;
     ...
     * An event pattern to use to filter events sent to the archive.
     */
    get eventPattern(): any | cdk.IResolvable | undefined;
    /**
     * An event pattern to use to filter events sent to the archive.
     */
    set eventPattern(value: any | cdk.IResolvable | undefined);
    /**
     * The identifier of the AWS  customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt this archive.
     */
    get kmsKeyIdentifier(): string | undefined;
    /**
     * The identifier of the AWS  customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt this archive.
     */
    set kmsKeyIdentifier(value: string | undefined);
    /**
     * The number of days to retain events for.
     */
...
export interface CfnArchiveProps {
     ...
     */
    readonly sourceArn: eventsRefs.IEventBusRef | string;
}
/**
...
export declare class CfnConnection extends cdk.CfnResource implements cdk.IInspectable, IConnectionRef {
     ...
     */
    static fromConnectionArn(scope: constructs.Construct, id: string, arn: string): IConnectionRef;
    /**
     * Creates a new IConnectionRef from a connectionName
     */
    static fromConnectionName(scope: constructs.Construct, id: string, connectionName: string): IConnectionRef;
     ...
     * The authorization parameters to use to authorize with the endpoint.
     */
    get authParameters(): CfnConnection.AuthParametersProperty | cdk.IResolvable | undefined;
    /**
     * The authorization parameters to use to authorize with the endpoint.
     */
    set authParameters(value: CfnConnection.AuthParametersProperty | cdk.IResolvable | undefined);
    /**
     * A description for the connection to create.
     */
    get description(): string | undefined;
     ...
     * For connections to private APIs, the parameters to use for invoking the API.
     */
    get invocationConnectivityParameters(): CfnConnection.InvocationConnectivityParametersProperty | cdk.IResolvable | undefined;
    /**
     * For connections to private APIs, the parameters to use for invoking the API.
     */
    set invocationConnectivityParameters(value: CfnConnection.InvocationConnectivityParametersProperty | cdk.IResolvable | undefined);
    /**
     * The identifier of the AWS  customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt this connection.
     */
    get kmsKeyIdentifier(): string | undefined;
     ...
     */
    get attrAuthParametersConnectivityParametersResourceParametersResourceAssociationArn(): string;
    /**
     * For connections to private APIs, the Amazon Resource Name (ARN) of the resource association EventBridge created between the connection and the private API's resource configuration.
     *
     * > The value of this property is set by EventBridge . Any value you specify in your template is ignored.
     ...
     */
    get attrInvocationConnectivityParametersResourceParametersResourceAssociationArn(): string;
    /**
     * The ARN for the secret created for the connection.
     *
     * @cloudformationAttribute SecretArn
     */
    get attrSecretArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnEndpoint extends cdk.CfnResource implements cdk.IInspectable, IEndpointRef {
     ...
     */
    static fromEndpointArn(scope: constructs.Construct, id: string, arn: string): IEndpointRef;
    /**
     * Creates a new IEndpointRef from a endpointName
     */
    static fromEndpointName(scope: constructs.Construct, id: string, endpointName: string): IEndpointRef;
     ...
     * The event buses being used by the endpoint.
     */
    get eventBuses(): Array<CfnEndpoint.EndpointEventBusProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The event buses being used by the endpoint.
     */
    set eventBuses(value: Array<CfnEndpoint.EndpointEventBusProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The name of the endpoint.
     */
    get name(): string | undefined;
     ...
     * Whether event replication was enabled or disabled for this endpoint.
     */
    get replicationConfig(): cdk.IResolvable | CfnEndpoint.ReplicationConfigProperty | undefined;
    /**
     * Whether event replication was enabled or disabled for this endpoint.
     */
    set replicationConfig(value: cdk.IResolvable | CfnEndpoint.ReplicationConfigProperty | undefined);
    /**
     * The ARN of the role used by event replication for the endpoint.
     */
     ...
     * The routing configuration of the endpoint.
     */
    get routingConfig(): cdk.IResolvable | CfnEndpoint.RoutingConfigProperty;
    /**
     * The routing configuration of the endpoint.
     */
    set routingConfig(value: cdk.IResolvable | CfnEndpoint.RoutingConfigProperty);
    /**
...
export declare class CfnEventBus extends cdk.CfnResource implements cdk.IInspectable, IEventBusRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnEventBus(x: any): x is CfnEventBus;
    /**
     * Creates a new IEventBusRef from an ARN
     */
    static fromEventBusArn(scope: constructs.Construct, id: string, arn: string): IEventBusRef;
    /**
     * Creates a new IEventBusRef from a eventBusName
     */
    static fromEventBusName(scope: constructs.Construct, id: string, eventBusName: string): IEventBusRef;
    static arnForEventBus(resource: IEventBusRef): string;
    /**
     ...
     * Configuration details of the Amazon SQS queue for EventBridge to use as a dead-letter queue (DLQ).
     */
    get deadLetterConfig(): CfnEventBus.DeadLetterConfigProperty | cdk.IResolvable | undefined;
    /**
     * Configuration details of the Amazon SQS queue for EventBridge to use as a dead-letter queue (DLQ).
     */
    set deadLetterConfig(value: CfnEventBus.DeadLetterConfigProperty | cdk.IResolvable | undefined);
    /**
     * The event bus description.
     */
    get description(): string | undefined;
     ...
     * If you are creating a partner event bus, this specifies the partner event source that the new event bus will be matched with.
     */
    set eventSourceName(value: string | undefined);
    /**
     * The identifier of the AWS  customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt events on this event bus.
     */
    get kmsKeyIdentifier(): string | undefined;
     ...
     * The logging configuration settings for the event bus.
     */
    get logConfig(): cdk.IResolvable | CfnEventBus.LogConfigProperty | undefined;
    /**
     * The logging configuration settings for the event bus.
     */
    set logConfig(value: cdk.IResolvable | CfnEventBus.LogConfigProperty | undefined);
    /**
     * The name of the new event bus.
     */
    get name(): string;
     ...
     * The permissions policy of the event bus, describing which other AWS accounts can write events to this event bus.
     */
    get policy(): any | cdk.IResolvable | string | undefined;
    /**
     * The permissions policy of the event bus, describing which other AWS accounts can write events to this event bus.
     */
    set policy(value: any | cdk.IResolvable | string | undefined);
    /**
     * Tags to associate with the event bus.
     */
...
export declare class CfnEventBusPolicy extends cdk.CfnResource implements cdk.IInspectable, IEventBusPolicyRef {
     ...
     */
    static isCfnEventBusPolicy(x: any): x is CfnEventBusPolicy;
    /**
     ...
     * @deprecated this property has been deprecated
     */
    get condition(): CfnEventBusPolicy.ConditionProperty | cdk.IResolvable | undefined;
    /**
     * This parameter enables you to limit the permission to accounts that fulfill a certain condition, such as being a member of a certain AWS organization.
     *
     * @deprecated this property has been deprecated
     */
    set condition(value: CfnEventBusPolicy.ConditionProperty | cdk.IResolvable | undefined);
    /**
     * The name of the event bus associated with the rule.
     */
    get eventBusName(): string | undefined;
    /**
     * The name of the event bus associated with the rule.
     */
    set eventBusName(value: string | undefined);
    /**
     * The 12-digit AWS account ID that you are permitting to put events to your default event bus.
     *
     * @deprecated this property has been deprecated
     ...
     * @deprecated this property has been deprecated
     */
    set principal(value: string | undefined);
    /**
     * A JSON string that describes the permission policy statement.
     */
    get statement(): any | cdk.IResolvable | undefined;
    /**
     * A JSON string that describes the permission policy statement.
     */
    set statement(value: any | cdk.IResolvable | undefined);
    /**
     * An identifier string for the external account that you are granting permissions to.
     */
...
export declare class CfnRule extends cdk.CfnResource implements cdk.IInspectable, IRuleRef, cdk.ITaggableV2 {
     ...
     */
    static fromRuleArn(scope: constructs.Construct, id: string, arn: string): IRuleRef;
     ...
     * Adds the specified targets to the specified rule, or updates the targets if they are already associated with the rule.
     */
    get targets(): Array<cdk.IResolvable | CfnRule.TargetProperty> | cdk.IResolvable | undefined;
    /**
     * Adds the specified targets to the specified rule, or updates the targets if they are already associated with the rule.
     */
    set targets(value: Array<cdk.IResolvable | CfnRule.TargetProperty> | cdk.IResolvable | undefined);
    /**
...
export interface CfnRuleProps {
     ...
     */
    readonly eventBusName?: eventsRefs.IEventBusRef | string;
    /**
     * The event pattern of the rule.
     *
 ...
 */
export declare class CfnReplay extends cdk.CfnResource implements cdk.IInspectable, IReplayRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnReplay from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnReplay;
    /**
     * Checks whether the given object is a CfnReplay
     */
    static isCfnReplay(x: any): x is CfnReplay;
    static arnForReplay(resource: IReplayRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnReplayProps);
    get replayRef(): ReplayReference;
    /**
     * A ReplayDestination object that includes details about the destination for the replay.
     */
    get destination(): CfnReplay.DestinationProperty | cdk.IResolvable;
    /**
     * A ReplayDestination object that includes details about the destination for the replay.
     */
    set destination(value: CfnReplay.DestinationProperty | cdk.IResolvable);
    /**
     * A time stamp for the time to stop replaying events.
     */
...
export declare namespace CfnReplay {
    /**
     * A ReplayDestination object that includes details about the destination for the replay.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-events-replay.html
 */
export interface CfnReplayProps {
    /**
     * A ReplayDestination object that includes details about the destination for the replay.
     *
     ...
     */
    readonly destination: CfnReplay.DestinationProperty | cdk.IResolvable;
    /**
     * A time stamp for the time to stop replaying events.
     *
...
export type { IApiDestinationRef, ApiDestinationReference };
export type { IArchiveRef, ArchiveReference };
export type { IConnectionRef, ConnectionReference };
export type { IEndpointRef, EndpointReference };
export type { IEventBusRef, EventBusReference };
export type { IEventBusPolicyRef, EventBusPolicyReference };
export type { IRuleRef, RuleReference };
export type { IReplayRef, ReplayReference };
