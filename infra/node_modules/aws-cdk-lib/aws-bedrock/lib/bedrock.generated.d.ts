...
import { AgentAliasReference, AgentReference, ApplicationInferenceProfileReference, AutomatedReasoningPolicyReference, AutomatedReasoningPolicyVersionReference, BlueprintReference, DataAutomationLibraryReference, DataAutomationProjectReference, DataSourceReference, DefaultPromptRouterReference, EnforcedGuardrailConfigurationReference, FlowAliasReference, FlowReference, FlowVersionReference, GuardrailReference, GuardrailVersionReference, IAgentAliasRef, IAgentRef, IApplicationInferenceProfileRef, IAutomatedReasoningPolicyRef, IAutomatedReasoningPolicyVersionRef, IBlueprintRef, IDataAutomationLibraryRef, IDataAutomationProjectRef, IDataSourceRef, IDefaultPromptRouterRef, IEnforcedGuardrailConfigurationRef, IFlowAliasRef, IFlowRef, IFlowVersionRef, IGuardrailRef, IGuardrailVersionRef, IIntelligentPromptRouterRef, IKnowledgeBasePolicyRef, IKnowledgeBaseRef, IModelInvocationJobRef, IntelligentPromptRouterReference, IPromptRef, IPromptVersionRef, IResourcePolicyRef, KnowledgeBasePolicyReference, KnowledgeBaseReference, ModelInvocationJobReference, PromptReference, PromptVersionReference, ResourcePolicyReference } from "../../interfaces/generated/aws-bedrock-interfaces.generated";
/**
 ...
 */
export declare class CfnDefaultPromptRouter extends cdk.CfnResource implements cdk.IInspectable, IDefaultPromptRouterRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnDefaultPromptRouter from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDefaultPromptRouter;
    /**
     * Checks whether the given object is a CfnDefaultPromptRouter
     */
    static isCfnDefaultPromptRouter(x: any): x is CfnDefaultPromptRouter;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnDefaultPromptRouterProps);
    get defaultPromptRouterRef(): DefaultPromptRouterReference;
    /**
     ...
     */
    get attrFallbackModel(): cdk.IResolvable;
    /**
...
export declare namespace CfnDefaultPromptRouter {
    /**
     * Routing criteria for a prompt router.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrock-defaultpromptrouter.html
 */
export interface CfnDefaultPromptRouterProps {
}
/**
 ...
 */
export declare class CfnKnowledgeBasePolicy extends cdk.CfnResource implements cdk.IInspectable, IKnowledgeBasePolicyRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnKnowledgeBasePolicy from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnKnowledgeBasePolicy;
    /**
     * Checks whether the given object is a CfnKnowledgeBasePolicy
     */
    static isCfnKnowledgeBasePolicy(x: any): x is CfnKnowledgeBasePolicy;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnKnowledgeBasePolicyProps);
    get knowledgeBasePolicyRef(): KnowledgeBasePolicyReference;
    /**
     * The unique identifier of the knowledge base.
     */
    get knowledgeBaseId(): string;
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrock-knowledgebasepolicy.html
 */
export interface CfnKnowledgeBasePolicyProps {
    /**
     * The unique identifier of the knowledge base.
     *
 ...
 */
export declare class CfnModelInvocationJob extends cdk.CfnResource implements cdk.IInspectable, IModelInvocationJobRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnModelInvocationJob from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnModelInvocationJob;
    /**
     * Checks whether the given object is a CfnModelInvocationJob
     */
    static isCfnModelInvocationJob(x: any): x is CfnModelInvocationJob;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnModelInvocationJobProps);
    get modelInvocationJobRef(): ModelInvocationJobReference;
    /**
     * Details about the location of the input to the batch inference job.
     *
     * @cloudformationAttribute InputDataConfig
     */
    get attrInputDataConfig(): cdk.IResolvable;
    /**
     * The Amazon Resource Name (ARN) of the batch inference job.
     *
     * @cloudformationAttribute JobArn
     */
    get attrJobArn(): string;
    /**
     * The time at which the batch inference job times or timed out.
     *
     * @cloudformationAttribute JobExpirationTime
     */
    get attrJobExpirationTime(): string;
    /**
     * A name to give the batch inference job.
     *
     * @cloudformationAttribute JobName
     */
    get attrJobName(): string;
    /**
     ...
     */
    get attrOutputDataConfig(): cdk.IResolvable;
    /**
...
export declare namespace CfnModelInvocationJob {
    /**
     * Details about the location of the input to the batch inference job.
     *
     * @struct
    ...
    interface ModelInvocationJobInputDataConfigProperty {
         ...
         */
        readonly s3InputDataConfig: cdk.IResolvable | CfnModelInvocationJob.ModelInvocationJobS3InputDataConfigProperty;
    }
    /**
     * Contains the configuration of the S3 location of the input data.
     *
    ...
    interface ModelInvocationJobOutputDataConfigProperty {
         ...
         */
        readonly s3OutputDataConfig: cdk.IResolvable | CfnModelInvocationJob.ModelInvocationJobS3OutputDataConfigProperty;
    }
    /**
     * Contains the configuration of the S3 location of the output data.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrock-modelinvocationjob.html
 */
export interface CfnModelInvocationJobProps {
}
/**
...
export type { IDefaultPromptRouterRef, DefaultPromptRouterReference };
...
export type { IKnowledgeBasePolicyRef, KnowledgeBasePolicyReference };
export type { IModelInvocationJobRef, ModelInvocationJobReference };
