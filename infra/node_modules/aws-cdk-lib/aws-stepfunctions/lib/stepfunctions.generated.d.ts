...
import { ActivityReference, IActivityRef, IMapRunRef, IStateMachineAliasRef, IStateMachineRef, IStateMachineVersionRef, MapRunReference, StateMachineAliasReference, StateMachineReference, StateMachineVersionReference } from "../../interfaces/generated/aws-stepfunctions-interfaces.generated";
import { aws_dynamodb as dynamoDbRefs, aws_ecs as ecsRefs, aws_iam as iamRefs, aws_lambda as lambdaRefs, aws_sns as snsRefs, aws_sqs as sqsRefs } from "../../interfaces";
/**
...
export declare class CfnActivity extends cdk.CfnResource implements cdk.IInspectable, IActivityRef, cdk.ITaggable {
     ...
     */
    static isCfnActivity(x: any): x is CfnActivity;
    static arnForActivity(resource: IActivityRef): string;
    /**
     ...
     * Encryption configuration for the activity.
     */
    get encryptionConfiguration(): CfnActivity.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Encryption configuration for the activity.
     */
    set encryptionConfiguration(value: CfnActivity.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The name of the activity.
     */
    get name(): string;
     ...
     * The list of tags to add to a resource.
     */
    get tagsRaw(): Array<CfnActivity.TagsEntryProperty> | undefined;
    /**
     * The list of tags to add to a resource.
     */
    set tagsRaw(value: Array<CfnActivity.TagsEntryProperty> | undefined);
    /**
...
export declare class CfnStateMachine extends cdk.CfnResource implements cdk.IInspectable, IStateMachineRef, cdk.ITaggable {
     ...
     */
    static isCfnStateMachine(x: any): x is CfnStateMachine;
    static arnForStateMachine(resource: IStateMachineRef): string;
    /**
     ...
     * The Amazon States Language definition of the state machine.
     */
    get definition(): any | cdk.IResolvable | undefined;
    /**
     * The Amazon States Language definition of the state machine.
     */
    set definition(value: any | cdk.IResolvable | undefined);
    /**
     * The name of the S3 bucket where the state machine definition is stored.
     */
    get definitionS3Location(): cdk.IResolvable | CfnStateMachine.S3LocationProperty | undefined;
    /**
     * The name of the S3 bucket where the state machine definition is stored.
     */
    set definitionS3Location(value: cdk.IResolvable | CfnStateMachine.S3LocationProperty | undefined);
    /**
     * The Amazon States Language definition of the state machine.
     */
     ...
     * A map (string to string) that specifies the mappings for placeholder variables in the state machine definition.
     */
    get definitionSubstitutions(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * A map (string to string) that specifies the mappings for placeholder variables in the state machine definition.
     */
    set definitionSubstitutions(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * Encryption configuration for the state machine.
     */
    get encryptionConfiguration(): CfnStateMachine.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Encryption configuration for the state machine.
     */
    set encryptionConfiguration(value: CfnStateMachine.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Defines what execution history events are logged and where they are logged.
     */
    get loggingConfiguration(): cdk.IResolvable | CfnStateMachine.LoggingConfigurationProperty | undefined;
    /**
     * Defines what execution history events are logged and where they are logged.
     */
    set loggingConfiguration(value: cdk.IResolvable | CfnStateMachine.LoggingConfigurationProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) of the IAM role to use for this state machine.
     */
    get roleArn(): string;
     ...
     * The name of the state machine.
     */
    get stateMachineName(): string | undefined;
    /**
     * The name of the state machine.
     */
    set stateMachineName(value: string | undefined);
    /**
     * Determines whether a `STANDARD` or `EXPRESS` state machine is created.
     */
    get stateMachineType(): string | undefined;
    /**
     * Determines whether a `STANDARD` or `EXPRESS` state machine is created.
     */
    set stateMachineType(value: string | undefined);
    /**
     * The list of tags to add to a resource.
     */
    get tagsRaw(): Array<CfnStateMachine.TagsEntryProperty> | undefined;
    /**
     * The list of tags to add to a resource.
     */
    set tagsRaw(value: Array<CfnStateMachine.TagsEntryProperty> | undefined);
    /**
     * Selects whether or not the state machine's AWS X-Ray tracing is enabled.
     */
    get tracingConfiguration(): cdk.IResolvable | CfnStateMachine.TracingConfigurationProperty | undefined;
    /**
     * Selects whether or not the state machine's AWS X-Ray tracing is enabled.
     */
    set tracingConfiguration(value: cdk.IResolvable | CfnStateMachine.TracingConfigurationProperty | undefined);
    /**
     * Returns the ARN of the resource.
     *
     * @cloudformationAttribute Arn
     ...
     */
    get attrStateMachineRevisionId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnStateMachineProps {
     ...
     */
    readonly definitionString?: dynamoDbRefs.ITableRef | ecsRefs.ITaskDefinitionRef | lambdaRefs.IFunctionRef | lambdaRefs.IVersionRef | snsRefs.ITopicRef | sqsRefs.IQueueRef | string;
    /**
     * A map (string to string) that specifies the mappings for placeholder variables in the state machine definition.
     *
...
export declare class CfnStateMachineAlias extends cdk.CfnResource implements cdk.IInspectable, IStateMachineAliasRef {
     ...
     */
    static isCfnStateMachineAlias(x: any): x is CfnStateMachineAlias;
    static arnForStateMachineAlias(resource: IStateMachineAliasRef): string;
    /**
     * The settings that enable gradual state machine deployments.
     */
    private _deploymentPreference?;
    /**
     ...
     * The settings that enable gradual state machine deployments.
     */
    get deploymentPreference(): CfnStateMachineAlias.DeploymentPreferenceProperty | cdk.IResolvable | undefined;
    /**
     * The settings that enable gradual state machine deployments.
     */
    set deploymentPreference(value: CfnStateMachineAlias.DeploymentPreferenceProperty | cdk.IResolvable | undefined);
    /**
     * An optional description of the state machine alias.
     */
     ...
     * The routing configuration of an alias.
     */
    get routingConfiguration(): Array<cdk.IResolvable | CfnStateMachineAlias.RoutingConfigurationVersionProperty> | cdk.IResolvable | undefined;
    /**
     * The routing configuration of an alias.
     */
    set routingConfiguration(value: Array<cdk.IResolvable | CfnStateMachineAlias.RoutingConfigurationVersionProperty> | cdk.IResolvable | undefined);
    get stateMachineArn(): string | undefined;
    set stateMachineArn(value: string | undefined);
    /**
...
export declare class CfnStateMachineVersion extends cdk.CfnResource implements cdk.IInspectable, IStateMachineVersionRef {
     ...
     */
    static isCfnStateMachineVersion(x: any): x is CfnStateMachineVersion;
    static arnForStateMachineVersion(resource: IStateMachineVersionRef): string;
    /**
     ...
     * Identifier for a state machine revision, which is an immutable, read-only snapshot of a state machine’s definition and configuration.
     */
    private _stateMachineRevisionId?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * Identifier for a state machine revision, which is an immutable, read-only snapshot of a state machine’s definition and configuration.
     */
    get stateMachineRevisionId(): string | undefined;
    /**
     * Identifier for a state machine revision, which is an immutable, read-only snapshot of a state machine’s definition and configuration.
     */
    set stateMachineRevisionId(value: string | undefined);
    /**
 ...
 */
export declare class CfnMapRun extends cdk.CfnResource implements cdk.IInspectable, IMapRunRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnMapRun from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnMapRun;
    /**
     * Checks whether the given object is a CfnMapRun
     */
    static isCfnMapRun(x: any): x is CfnMapRun;
    static arnForMapRun(resource: IMapRunRef): string;
    /**
     * The Amazon Resource Name (ARN) that identifies the execution in which the Map Run was started.
     */
    private _executionArn?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnMapRunProps);
    get mapRunRef(): MapRunReference;
    /**
     * The Amazon Resource Name (ARN) that identifies the execution in which the Map Run was started.
     */
...
export declare namespace CfnMapRun {
    /**
     * Contains details about items processed in all child workflow executions started by a Map Run.
     *
     * @struct
    ...
    interface MapRunItemCountsProperty {
         ...
         */
        readonly failuresNotRedrivable?: number;
        /**
         ...
         */
        readonly pendingRedrive?: number;
        /**
     ...
     */
    interface MapRunExecutionCountsProperty {
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-stepfunctions-maprun.html
 */
export interface CfnMapRunProps {
    /**
     * The Amazon Resource Name (ARN) that identifies the execution in which the Map Run was started.
     *
...
export type { IActivityRef, ActivityReference };
export type { IStateMachineRef, StateMachineReference };
export type { IStateMachineAliasRef, StateMachineAliasReference };
export type { IStateMachineVersionRef, StateMachineVersionReference };
export type { IMapRunRef, MapRunReference };
