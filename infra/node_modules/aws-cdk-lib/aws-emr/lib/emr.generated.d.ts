...
import { ClusterReference, IClusterRef, IInstanceFleetConfigRef, IInstanceGroupConfigRef, INotebookExecutionRef, InstanceFleetConfigReference, InstanceGroupConfigReference, ISecurityConfigurationRef, IStepRef, IStudioRef, IStudioSessionMappingRef, IWALWorkspaceRef, NotebookExecutionReference, SecurityConfigurationReference, StepReference, StudioReference, StudioSessionMappingReference, WALWorkspaceReference } from "../../interfaces/generated/aws-emr-interfaces.generated";
...
export declare class CfnCluster extends cdk.CfnResource implements cdk.IInspectable, IClusterRef, cdk.ITaggable {
     ...
     */
    private _ebsRootVolumeThroughput?;
    /**
    ...
    private _placementGroupConfigs?;
    /**
     ...
     * A JSON string for selecting additional features.
     */
    get additionalInfo(): any | cdk.IResolvable | undefined;
    /**
     * A JSON string for selecting additional features.
     */
    set additionalInfo(value: any | cdk.IResolvable | undefined);
    /**
     * The applications to install on this cluster, for example, Spark, Flink, Oozie, Zeppelin, and so on.
     */
    get applications(): Array<CfnCluster.ApplicationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The applications to install on this cluster, for example, Spark, Flink, Oozie, Zeppelin, and so on.
     */
    set applications(value: Array<CfnCluster.ApplicationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * An IAM role for automatic scaling policies.
     */
     ...
     * An auto-termination policy for an Amazon EMR cluster.
     */
    get autoTerminationPolicy(): CfnCluster.AutoTerminationPolicyProperty | cdk.IResolvable | undefined;
    /**
     * An auto-termination policy for an Amazon EMR cluster.
     */
    set autoTerminationPolicy(value: CfnCluster.AutoTerminationPolicyProperty | cdk.IResolvable | undefined);
    /**
     * A list of bootstrap actions to run before Hadoop starts on the cluster nodes.
     */
    get bootstrapActions(): Array<CfnCluster.BootstrapActionConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of bootstrap actions to run before Hadoop starts on the cluster nodes.
     */
    set bootstrapActions(value: Array<CfnCluster.BootstrapActionConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Applies only to Amazon EMR releases 4.x and later. The list of configurations that are supplied to the Amazon EMR cluster.
     */
    get configurations(): Array<CfnCluster.ConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Applies only to Amazon EMR releases 4.x and later. The list of configurations that are supplied to the Amazon EMR cluster.
     */
    set configurations(value: Array<CfnCluster.ConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Available only in Amazon EMR releases 5.7.0 and later. The ID of a custom Amazon EBS-backed Linux AMI if the cluster uses a custom AMI.
     */
     ...
     * The IOPS, of the Amazon EBS root device volume of the Linux AMI that is used for each Amazon EC2 instance.
     */
    get ebsRootVolumeIops(): number | undefined;
    /**
     * The IOPS, of the Amazon EBS root device volume of the Linux AMI that is used for each Amazon EC2 instance.
     */
    set ebsRootVolumeIops(value: number | undefined);
    /**
     * The size, in GiB, of the Amazon EBS root device volume of the Linux AMI that is used for each Amazon EC2 instance.
     */
     ...
     * The throughput, in MiB/s, of the Amazon EBS root device volume of the Linux AMI that is used for each Amazon EC2 instance.
     */
    get ebsRootVolumeThroughput(): number | undefined;
    /**
     * The throughput, in MiB/s, of the Amazon EBS root device volume of the Linux AMI that is used for each Amazon EC2 instance.
     */
    set ebsRootVolumeThroughput(value: number | undefined);
    /**
     * A specification of the number and type of Amazon EC2 instances.
     */
    get instances(): cdk.IResolvable | CfnCluster.JobFlowInstancesConfigProperty;
    /**
     * A specification of the number and type of Amazon EC2 instances.
     */
    set instances(value: cdk.IResolvable | CfnCluster.JobFlowInstancesConfigProperty);
    /**
     * Also called instance profile and Amazon EC2 role.
     */
     ...
     * Attributes for Kerberos configuration when Kerberos authentication is enabled using a security configuration.
     */
    get kerberosAttributes(): cdk.IResolvable | CfnCluster.KerberosAttributesProperty | undefined;
    /**
     * Attributes for Kerberos configuration when Kerberos authentication is enabled using a security configuration.
     */
    set kerberosAttributes(value: cdk.IResolvable | CfnCluster.KerberosAttributesProperty | undefined);
    /**
     * The AWS KMS key used for encrypting log files.
     */
    get logEncryptionKmsKeyId(): string | undefined;
    /**
     * The AWS KMS key used for encrypting log files.
     */
    set logEncryptionKmsKeyId(value: string | undefined);
    /**
     * The path to the Amazon S3 location where logs for this cluster are stored.
     */
     ...
     * Creates or updates a managed scaling policy for an Amazon EMR cluster.
     */
    get managedScalingPolicy(): cdk.IResolvable | CfnCluster.ManagedScalingPolicyProperty | undefined;
    /**
     * Creates or updates a managed scaling policy for an Amazon EMR cluster.
     */
    set managedScalingPolicy(value: cdk.IResolvable | CfnCluster.ManagedScalingPolicyProperty | undefined);
    /**
     * The name of the cluster.
     */
    get name(): string;
     ...
     * The Amazon Linux release specified in a cluster launch RunJobFlow request.
     */
    get osReleaseLabel(): string | undefined;
    /**
     * The Amazon Linux release specified in a cluster launch RunJobFlow request.
     */
    set osReleaseLabel(value: string | undefined);
    get placementGroupConfigs(): Array<cdk.IResolvable | CfnCluster.PlacementGroupConfigProperty> | cdk.IResolvable | undefined;
    set placementGroupConfigs(value: Array<cdk.IResolvable | CfnCluster.PlacementGroupConfigProperty> | cdk.IResolvable | undefined);
    /**
     * The Amazon EMR release label, which determines the version of open-source application packages installed on the cluster.
     */
     ...
     * The Amazon EMR release label, which determines the version of open-source application packages installed on the cluster.
     */
    set releaseLabel(value: string | undefined);
    /**
     * The way that individual Amazon EC2 instances terminate when an automatic scale-in activity occurs or an instance group is resized.
     */
     ...
     * A list of steps to run.
     */
    get steps(): Array<cdk.IResolvable | CfnCluster.StepConfigProperty> | cdk.IResolvable | undefined;
    /**
     * A list of steps to run.
     */
    set steps(value: Array<cdk.IResolvable | CfnCluster.StepConfigProperty> | cdk.IResolvable | undefined);
    /**
     * A list of tags associated with a cluster.
     */
     ...
     * Indicates whether the cluster is visible to all IAM users of the AWS account associated with the cluster.
     */
    get visibleToAllUsers(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether the cluster is visible to all IAM users of the AWS account associated with the cluster.
     */
    set visibleToAllUsers(value: boolean | cdk.IResolvable | undefined);
    /**
     ...
     */
    get attrMasterPublicDns(): string;
...
export declare class CfnInstanceFleetConfig extends cdk.CfnResource implements cdk.IInspectable, IInstanceFleetConfigRef {
     ...
     * The node type that the instance fleet hosts.
     */
    get instanceFleetType(): string;
    /**
     * The node type that the instance fleet hosts.
     */
    set instanceFleetType(value: string);
    /**
     * `InstanceTypeConfigs` determine the EC2 instances that Amazon EMR attempts to provision to fulfill On-Demand and Spot target capacities.
     */
    get instanceTypeConfigs(): Array<CfnInstanceFleetConfig.InstanceTypeConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * `InstanceTypeConfigs` determine the EC2 instances that Amazon EMR attempts to provision to fulfill On-Demand and Spot target capacities.
     */
    set instanceTypeConfigs(value: Array<CfnInstanceFleetConfig.InstanceTypeConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The launch specification for the instance fleet.
     */
    get launchSpecifications(): CfnInstanceFleetConfig.InstanceFleetProvisioningSpecificationsProperty | cdk.IResolvable | undefined;
    /**
     * The launch specification for the instance fleet.
     */
    set launchSpecifications(value: CfnInstanceFleetConfig.InstanceFleetProvisioningSpecificationsProperty | cdk.IResolvable | undefined);
    /**
     * The friendly name of the instance fleet.
     */
     ...
     * The resize specification for the instance fleet.
     */
    get resizeSpecifications(): CfnInstanceFleetConfig.InstanceFleetResizingSpecificationsProperty | cdk.IResolvable | undefined;
    /**
     * The resize specification for the instance fleet.
     */
    set resizeSpecifications(value: CfnInstanceFleetConfig.InstanceFleetResizingSpecificationsProperty | cdk.IResolvable | undefined);
    /**
     * The target capacity of On-Demand units for the instance fleet, which determines how many On-Demand instances to provision.
     */
    get targetOnDemandCapacity(): number | undefined;
    /**
     * The target capacity of On-Demand units for the instance fleet, which determines how many On-Demand instances to provision.
     */
    set targetOnDemandCapacity(value: number | undefined);
    /**
     * The target capacity of Spot units for the instance fleet, which determines how many Spot instances to provision.
     */
    get targetSpotCapacity(): number | undefined;
    /**
     * The target capacity of Spot units for the instance fleet, which determines how many Spot instances to provision.
     */
    set targetSpotCapacity(value: number | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnInstanceGroupConfig extends cdk.CfnResource implements cdk.IInspectable, IInstanceGroupConfigRef {
     ...
     * `AutoScalingPolicy` is a subproperty of `InstanceGroupConfig` .
     */
    get autoScalingPolicy(): CfnInstanceGroupConfig.AutoScalingPolicyProperty | cdk.IResolvable | undefined;
    /**
     * `AutoScalingPolicy` is a subproperty of `InstanceGroupConfig` .
     */
    set autoScalingPolicy(value: CfnInstanceGroupConfig.AutoScalingPolicyProperty | cdk.IResolvable | undefined);
    /**
     * If specified, indicates that the instance group uses Spot Instances.
     */
     ...
     * > Amazon EMR releases 4.x or later.
     */
    get configurations(): Array<CfnInstanceGroupConfig.ConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * > Amazon EMR releases 4.x or later.
     */
    set configurations(value: Array<CfnInstanceGroupConfig.ConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The custom AMI ID to use for the provisioned instance group.
     */
    get customAmiId(): string | undefined;
     ...
     * `EbsConfiguration` determines the EBS volumes to attach to EMR cluster instances.
     */
    get ebsConfiguration(): CfnInstanceGroupConfig.EbsConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * `EbsConfiguration` determines the EBS volumes to attach to EMR cluster instances.
     */
    set ebsConfiguration(value: CfnInstanceGroupConfig.EbsConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Target number of instances for the instance group.
     */
     ...
     * The ID of an Amazon EMR cluster that you want to associate this instance group with.
     */
    get jobFlowId(): string;
    /**
     * The ID of an Amazon EMR cluster that you want to associate this instance group with.
     */
    set jobFlowId(value: string);
    /**
     * Market type of the Amazon EC2 instances used to create a cluster node.
     */
     ...
     * Market type of the Amazon EC2 instances used to create a cluster node.
     */
    set market(value: string | undefined);
    /**
     * Friendly name given to the instance group.
     */
    get name(): string | undefined;
...
export declare class CfnSecurityConfiguration extends cdk.CfnResource implements cdk.IInspectable, ISecurityConfigurationRef {
     ...
     * The security configuration details in JSON format.
     */
    get securityConfiguration(): any | cdk.IResolvable;
    /**
     * The security configuration details in JSON format.
     */
    set securityConfiguration(value: any | cdk.IResolvable);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnStep extends cdk.CfnResource implements cdk.IInspectable, IStepRef {
     ...
     * The `HadoopJarStepConfig` property type specifies a job flow step consisting of a JAR file whose main function will be executed.
     */
    get hadoopJarStep(): CfnStep.HadoopJarStepConfigProperty | cdk.IResolvable;
    /**
     * The `HadoopJarStepConfig` property type specifies a job flow step consisting of a JAR file whose main function will be executed.
     */
    set hadoopJarStep(value: CfnStep.HadoopJarStepConfigProperty | cdk.IResolvable);
    /**
     * A string that uniquely identifies the cluster (job flow).
     */
    get jobFlowId(): string;
...
export declare class CfnStudio extends cdk.CfnResource implements cdk.IInspectable, IStudioRef, cdk.ITaggable {
     ...
     */
    private _trustedIdentityPropagationEnabled?;
    /**
     ...
     * The ARN of the IAM Identity Center instance the Studio application belongs to.
     */
    get idcInstanceArn(): string | undefined;
    /**
     * The ARN of the IAM Identity Center instance the Studio application belongs to.
     */
    set idcInstanceArn(value: string | undefined);
    /**
     * Indicates whether the Studio has `REQUIRED` or `OPTIONAL` IAM Identity Center user assignment.
     */
    get idcUserAssignment(): string | undefined;
    /**
     * Indicates whether the Studio has `REQUIRED` or `OPTIONAL` IAM Identity Center user assignment.
     */
    set idcUserAssignment(value: string | undefined);
    /**
     * Your identity provider's authentication endpoint.
     */
    get idpAuthUrl(): string | undefined;
    /**
     * Your identity provider's authentication endpoint.
     */
    set idpAuthUrl(value: string | undefined);
    /**
     * The name of your identity provider's `RelayState` parameter.
     */
    get idpRelayStateParameterName(): string | undefined;
    /**
     * The name of your identity provider's `RelayState` parameter.
     */
    set idpRelayStateParameterName(value: string | undefined);
    /**
     * A descriptive name for the Amazon EMR Studio.
     */
    get name(): string;
     ...
     * Indicates whether the Studio has Trusted identity propagation enabled.
     */
    get trustedIdentityPropagationEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether the Studio has Trusted identity propagation enabled.
     */
    set trustedIdentityPropagationEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the IAM user role that will be assumed by users and groups logged in to a Studio.
     */
...
export declare class CfnWALWorkspace extends cdk.CfnResource implements cdk.IInspectable, IWALWorkspaceRef, cdk.ITaggableV2 {
     ...
     * The name of the emrwal container.
     */
    get walWorkspaceName(): string | undefined;
    /**
     * The name of the emrwal container.
     */
    set walWorkspaceName(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 *
 * @cloudformationResource AWS::EMR::NotebookExecution
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-emr-notebookexecution.html
 */
export declare class CfnNotebookExecution extends cdk.CfnResource implements cdk.IInspectable, INotebookExecutionRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnNotebookExecution from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnNotebookExecution;
    /**
     * Checks whether the given object is a CfnNotebookExecution
     */
    static isCfnNotebookExecution(x: any): x is CfnNotebookExecution;
    static arnForNotebookExecution(resource: INotebookExecutionRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _notebookExecutionName?;
    /**
     ...
     */
    private _notebookS3Location?;
    /**
     * The output format for the notebook execution.
     */
    private _outputNotebookFormat?;
    /**
     * The Amazon S3 location for the notebook execution output.
     */
    private _outputNotebookS3Location?;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnNotebookExecutionProps);
    get notebookExecutionRef(): NotebookExecutionReference;
    /**
     * The environment variables associated with the notebook execution.
     */
     ...
     * Specifies the execution engine (cluster) to run the notebook and perform the notebook execution.
     */
    get executionEngine(): CfnNotebookExecution.ExecutionEngineConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the execution engine (cluster) to run the notebook and perform the notebook execution.
     */
    set executionEngine(value: CfnNotebookExecution.ExecutionEngineConfigProperty | cdk.IResolvable | undefined);
    /**
     * An optional name for the notebook execution.
     */
    get notebookExecutionName(): string | undefined;
    /**
     * An optional name for the notebook execution.
     */
    set notebookExecutionName(value: string | undefined);
    /**
     * Input parameters in JSON format passed to the Amazon EMR Notebook at runtime for execution.
     */
    get notebookParams(): string | undefined;
    /**
     * Input parameters in JSON format passed to the Amazon EMR Notebook at runtime for execution.
     */
    set notebookParams(value: string | undefined);
    /**
     * The Amazon S3 location that stores the notebook execution input.
     */
    get notebookS3Location(): cdk.IResolvable | CfnNotebookExecution.NotebookS3LocationProperty | undefined;
    /**
     * The Amazon S3 location that stores the notebook execution input.
     */
    set notebookS3Location(value: cdk.IResolvable | CfnNotebookExecution.NotebookS3LocationProperty | undefined);
    /**
     * The output format for the notebook execution.
     */
    get outputNotebookFormat(): string | undefined;
    /**
     * The output format for the notebook execution.
     */
    set outputNotebookFormat(value: string | undefined);
    /**
     * The Amazon S3 location for the notebook execution output.
     */
    get outputNotebookS3Location(): cdk.IResolvable | CfnNotebookExecution.OutputNotebookS3LocationProperty | undefined;
    /**
     * The Amazon S3 location for the notebook execution output.
     */
    set outputNotebookS3Location(value: cdk.IResolvable | CfnNotebookExecution.OutputNotebookS3LocationProperty | undefined);
    /**
     * A list of tags associated with a notebook execution.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     *
     * @cloudformationAttribute NotebookExecutionId
     */
    get attrNotebookExecutionId(): string;
    /**
...
export declare namespace CfnNotebookExecution {
    /**
     * Specifies the execution engine (cluster) to run the notebook and perform the notebook execution.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-emr-notebookexecution.html
 */
export interface CfnNotebookExecutionProps {
    /**
     * The environment variables associated with the notebook execution.
     *
     ...
     */
    readonly executionEngine?: CfnNotebookExecution.ExecutionEngineConfigProperty | cdk.IResolvable;
    /**
     * An optional name for the notebook execution.
     *
     ...
     */
    readonly notebookS3Location?: cdk.IResolvable | CfnNotebookExecution.NotebookS3LocationProperty;
    /**
     * The output format for the notebook execution.
     *
     ...
     */
    readonly outputNotebookFormat?: string;
    /**
     * The Amazon S3 location for the notebook execution output.
     *
     ...
     */
    readonly outputNotebookS3Location?: cdk.IResolvable | CfnNotebookExecution.OutputNotebookS3LocationProperty;
    /**
     * A list of tags associated with a notebook execution.
     *
...
export type { INotebookExecutionRef, NotebookExecutionReference };
