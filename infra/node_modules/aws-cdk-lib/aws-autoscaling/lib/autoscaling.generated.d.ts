...
export declare namespace CfnAutoScalingGroup {
    ...
    interface InstanceLifecyclePolicyProperty {
         ...
         */
        readonly retentionTriggers?: cdk.IResolvable | CfnAutoScalingGroup.RetentionTriggersProperty;
    }
    /**
...
export interface CfnAutoScalingGroupProps {
     ...
     */
    readonly availabilityZoneIds?: Array<string>;
    /**
     * The Availability Zone impairment policy for the Auto Scaling group.
     *
     ...
     */
    readonly instanceLifecyclePolicy?: CfnAutoScalingGroup.InstanceLifecyclePolicyProperty | cdk.IResolvable;
    /**
     * An instance maintenance policy.
     *
     ...
     */
    readonly launchConfigurationName?: autoScalingRefs.ILaunchConfigurationRef | string;
    /**
     * Information used to specify the launch template and version to use to launch instances.
     *
     ...
     */
    readonly serviceLinkedRoleArn?: iamRefs.IRoleRef | string;
    /**
     ...
     */
    readonly targetGroupArns?: Array<elasticLoadBalancingV2Refs.ITargetGroupRef | string>;
    /**
     * A policy or a list of policies that are used to select the instance to terminate.
     *
     ...
     */
    readonly vpcZoneIdentifier?: Array<ec2Refs.ISubnetRef | string>;
}
/**
...
export declare class CfnLaunchConfiguration extends cdk.CfnResource implements cdk.IInspectable, ILaunchConfigurationRef {
    ...
    /**
     * Checks whether the given object is a CfnLaunchConfiguration
     */
    static isCfnLaunchConfiguration(x: any): x is CfnLaunchConfiguration;
    /**
     ...
     */
    private _classicLinkVpcId?;
    /**
     * Available for backward compatibility.
     */
    private _classicLinkVpcSecurityGroups?;
    /**
     ...
     * Specifies whether to assign a public IPv4 address to the group's instances.
     */
    get associatePublicIpAddress(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether to assign a public IPv4 address to the group's instances.
     */
    set associatePublicIpAddress(value: boolean | cdk.IResolvable | undefined);
    /**
     * The block device mapping entries that define the block devices to attach to the instances at launch.
     */
    get blockDeviceMappings(): Array<CfnLaunchConfiguration.BlockDeviceMappingProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The block device mapping entries that define the block devices to attach to the instances at launch.
     */
    set blockDeviceMappings(value: Array<CfnLaunchConfiguration.BlockDeviceMappingProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Available for backward compatibility.
     */
    get classicLinkVpcId(): string | undefined;
    /**
     * Available for backward compatibility.
     */
    set classicLinkVpcId(value: string | undefined);
    /**
     * Available for backward compatibility.
     */
    get classicLinkVpcSecurityGroups(): Array<string> | undefined;
    /**
     * Available for backward compatibility.
     */
    set classicLinkVpcSecurityGroups(value: Array<string> | undefined);
    /**
     * Specifies whether the launch configuration is optimized for EBS I/O ( `true` ) or not ( `false` ).
     */
     ...
     * Controls whether instances in this group are launched with detailed ( `true` ) or basic ( `false` ) monitoring.
     */
    get instanceMonitoring(): boolean | cdk.IResolvable | undefined;
    /**
     * Controls whether instances in this group are launched with detailed ( `true` ) or basic ( `false` ) monitoring.
     */
    set instanceMonitoring(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies the instance type of the EC2 instance.
     */
     ...
     * The metadata options for the instances.
     */
    get metadataOptions(): cdk.IResolvable | CfnLaunchConfiguration.MetadataOptionsProperty | undefined;
    /**
     * The metadata options for the instances.
     */
    set metadataOptions(value: cdk.IResolvable | CfnLaunchConfiguration.MetadataOptionsProperty | undefined);
    /**
     * The tenancy of the instance, either `default` or `dedicated` .
     */
...
export interface CfnLaunchConfigurationProps {
     ...
     */
    readonly iamInstanceProfile?: iamRefs.IInstanceProfileRef | string;
    /**
     * The ID of the Amazon Machine Image (AMI) that was assigned during registration.
     *
...
export declare class CfnLifecycleHook extends cdk.CfnResource implements cdk.IInspectable, ILifecycleHookRef {
     ...
     */
    static isCfnLifecycleHook(x: any): x is CfnLifecycleHook;
    /**
     ...
     * The name of the lifecycle hook.
     */
    get lifecycleHookName(): string | undefined;
    /**
     * The name of the lifecycle hook.
     */
    set lifecycleHookName(value: string | undefined);
    /**
     * The lifecycle transition. For Auto Scaling groups, there are two major lifecycle transitions.
     */
...
export interface CfnLifecycleHookProps {
     ...
     */
    readonly autoScalingGroupName: autoScalingRefs.IAutoScalingGroupRef | string;
    /**
     * The action the Auto Scaling group takes when the lifecycle hook timeout elapses or if an unexpected failure occurs.
     *
     * The default value is `ABANDON` .
     ...
     */
    readonly notificationTargetArn?: snsRefs.ITopicRef | sqsRefs.IQueueRef | string;
    /**
     * The ARN of the IAM role that allows the Auto Scaling group to publish to the specified notification target.
     *
     * For information about creating this role, see [Prepare to add a lifecycle hook to your Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/prepare-for-lifecycle-notifications.html) in the *Amazon EC2 Auto Scaling User Guide* .
...
export declare class CfnScalingPolicy extends cdk.CfnResource implements cdk.IInspectable, IScalingPolicyRef {
     ...
     */
    static isCfnScalingPolicy(x: any): x is CfnScalingPolicy;
    static arnForScalingPolicy(resource: IScalingPolicyRef): string;
    /**
     ...
     * A predictive scaling policy. Provides support for predefined and custom metrics.
     */
    get predictiveScalingConfiguration(): cdk.IResolvable | CfnScalingPolicy.PredictiveScalingConfigurationProperty | undefined;
    /**
     * A predictive scaling policy. Provides support for predefined and custom metrics.
     */
    set predictiveScalingConfiguration(value: cdk.IResolvable | CfnScalingPolicy.PredictiveScalingConfigurationProperty | undefined);
    /**
     * The amount by which to scale, based on the specified adjustment type.
     */
     ...
     * A set of adjustments that enable you to scale based on the size of the alarm breach.
     */
    get stepAdjustments(): Array<cdk.IResolvable | CfnScalingPolicy.StepAdjustmentProperty> | cdk.IResolvable | undefined;
    /**
     * A set of adjustments that enable you to scale based on the size of the alarm breach.
     */
    set stepAdjustments(value: Array<cdk.IResolvable | CfnScalingPolicy.StepAdjustmentProperty> | cdk.IResolvable | undefined);
    /**
     * A target tracking scaling policy. Provides support for predefined or custom metrics.
     */
    get targetTrackingConfiguration(): cdk.IResolvable | CfnScalingPolicy.TargetTrackingConfigurationProperty | undefined;
    /**
     * A target tracking scaling policy. Provides support for predefined or custom metrics.
     */
    set targetTrackingConfiguration(value: cdk.IResolvable | CfnScalingPolicy.TargetTrackingConfigurationProperty | undefined);
    /**
...
export declare class CfnScheduledAction extends cdk.CfnResource implements cdk.IInspectable, IScheduledActionRef {
     ...
     */
    static isCfnScheduledAction(x: any): x is CfnScheduledAction;
    /**
     * The name of the Auto Scaling group.
     */
    private _autoScalingGroupName;
     ...
     */
    get attrScheduledActionName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnWarmPool extends cdk.CfnResource implements cdk.IInspectable, IWarmPoolRef {
     ...
     */
    static isCfnWarmPool(x: any): x is CfnWarmPool;
    /**
     * The name of the Auto Scaling group.
     */
    private _autoScalingGroupName;
     ...
     * Indicates whether instances in the Auto Scaling group can be returned to the warm pool on scale in.
     */
    get instanceReusePolicy(): CfnWarmPool.InstanceReusePolicyProperty | cdk.IResolvable | undefined;
    /**
     * Indicates whether instances in the Auto Scaling group can be returned to the warm pool on scale in.
     */
    set instanceReusePolicy(value: CfnWarmPool.InstanceReusePolicyProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the maximum number of instances that are allowed to be in the warm pool or in any state except `Terminated` for the Auto Scaling group.
     */
    get maxGroupPreparedCapacity(): number | undefined;
    /**
     * Specifies the maximum number of instances that are allowed to be in the warm pool or in any state except `Terminated` for the Auto Scaling group.
     */
    set maxGroupPreparedCapacity(value: number | undefined);
    /**
     * Specifies the minimum number of instances to maintain in the warm pool.
     */
    get minSize(): number | undefined;
     ...
     * Sets the instance state to transition to after the lifecycle actions are complete.
     */
    get poolState(): string | undefined;
    /**
     * Sets the instance state to transition to after the lifecycle actions are complete.
     */
    set poolState(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IAutoScalingGroupRef, AutoScalingGroupReference };
export type { ILaunchConfigurationRef, LaunchConfigurationReference };
export type { ILifecycleHookRef, LifecycleHookReference };
export type { IScalingPolicyRef, ScalingPolicyReference };
export type { IScheduledActionRef, ScheduledActionReference };
export type { IWarmPoolRef, WarmPoolReference };
