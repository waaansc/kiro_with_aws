...
export declare function createBackupConfig(scope: Construct, role: iam.IRole, props: DestinationS3BackupProps & {
    mode: NonNullable<DestinationS3BackupProps['mode']>;
