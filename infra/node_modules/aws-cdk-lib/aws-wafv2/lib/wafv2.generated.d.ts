...
export declare class CfnRuleGroup extends cdk.CfnResource implements cdk.IInspectable, IRuleGroupRef, cdk.ITaggable {
     ...
     * Configures monetization for the web ACL or rule group.
     */
    get monetizationConfig(): cdk.IResolvable | CfnRuleGroup.MonetizationConfigProperty | undefined;
    /**
     * Configures monetization for the web ACL or rule group.
     */
    set monetizationConfig(value: cdk.IResolvable | CfnRuleGroup.MonetizationConfigProperty | undefined);
    /**
     * The name of the rule group.
     */
    get name(): string | undefined;
...
export declare namespace CfnRuleGroup {
    ...
    interface RuleActionProperty {
         ...
         */
        readonly monetize?: cdk.IResolvable | CfnRuleGroup.MonetizeActionProperty;
    }
    /**
     * Monetize action for rules.
     *
    ...
    interface MonetizeActionProperty {
         ...
         */
        readonly priceMultiplier?: string;
    }
    /**
    ...
    interface FieldToMatchProperty {
         ...
         */
        readonly headerOrder?: CfnRuleGroup.HeaderOrderProperty | cdk.IResolvable;
        /**
    ...
    interface MonetizationConfigProperty {
         ...
         */
        readonly cryptoConfig?: CfnRuleGroup.CryptoConfigProperty | cdk.IResolvable;
        /**
     ...
     */
    interface CryptoConfigProperty {
        /**
         ...
         */
        readonly paymentNetworks: Array<cdk.IResolvable | CfnRuleGroup.PaymentNetworkProperty> | cdk.IResolvable;
    }
    /**
    ...
    interface PaymentNetworkProperty {
         ...
         */
        readonly prices: Array<cdk.IResolvable | CfnRuleGroup.PriceProperty> | cdk.IResolvable;
        /**
...
export interface CfnRuleGroupProps {
     ...
     */
    readonly monetizationConfig?: cdk.IResolvable | CfnRuleGroup.MonetizationConfigProperty;
    /**
     * The name of the rule group.
     *
...
export declare class CfnWebACL extends cdk.CfnResource implements cdk.IInspectable, IWebACLRef, cdk.ITaggable {
     ...
     */
    static isCfnWebACL(x: any): x is CfnWebACL;
    static arnForWebACL(resource: IWebACLRef): string;
    /**
     ...
     */
    private _onSourceDDoSProtectionConfig?;
    /**
     ...
     * Returns a list of `ApplicationAttribute` s.
     */
    get applicationConfig(): CfnWebACL.ApplicationConfigProperty | cdk.IResolvable | undefined;
    /**
     * Returns a list of `ApplicationAttribute` s.
     */
    set applicationConfig(value: CfnWebACL.ApplicationConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies custom configurations for the associations between the web ACL and protected resources.
     */
    get associationConfig(): CfnWebACL.AssociationConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies custom configurations for the associations between the web ACL and protected resources.
     */
    set associationConfig(value: CfnWebACL.AssociationConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies how AWS WAF should handle `CAPTCHA` evaluations for rules that don't have their own `CaptchaConfig` settings.
     */
    get captchaConfig(): CfnWebACL.CaptchaConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies how AWS WAF should handle `CAPTCHA` evaluations for rules that don't have their own `CaptchaConfig` settings.
     */
    set captchaConfig(value: CfnWebACL.CaptchaConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies how AWS WAF should handle challenge evaluations for rules that don't have their own `ChallengeConfig` settings.
     */
    get challengeConfig(): CfnWebACL.ChallengeConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies how AWS WAF should handle challenge evaluations for rules that don't have their own `ChallengeConfig` settings.
     */
    set challengeConfig(value: CfnWebACL.ChallengeConfigProperty | cdk.IResolvable | undefined);
    /**
     * A map of custom response keys and content bodies.
     */
    get customResponseBodies(): cdk.IResolvable | Record<string, CfnWebACL.CustomResponseBodyProperty | cdk.IResolvable> | undefined;
    /**
     * A map of custom response keys and content bodies.
     */
    set customResponseBodies(value: cdk.IResolvable | Record<string, CfnWebACL.CustomResponseBodyProperty | cdk.IResolvable> | undefined);
    /**
     * Specifies data protection to apply to the web request data for the web ACL.
     */
    get dataProtectionConfig(): CfnWebACL.DataProtectionConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies data protection to apply to the web request data for the web ACL.
     */
    set dataProtectionConfig(value: CfnWebACL.DataProtectionConfigProperty | cdk.IResolvable | undefined);
    /**
     * The action to perform if none of the `Rules` contained in the `WebACL` match.
     */
    get defaultAction(): CfnWebACL.DefaultActionProperty | cdk.IResolvable;
    /**
     * The action to perform if none of the `Rules` contained in the `WebACL` match.
     */
    set defaultAction(value: CfnWebACL.DefaultActionProperty | cdk.IResolvable);
    /**
     * A description of the web ACL that helps with identification.
     */
    get description(): string | undefined;
     ...
     * Configures monetization for the web ACL or rule group.
     */
    get monetizationConfig(): cdk.IResolvable | CfnWebACL.MonetizationConfigProperty | undefined;
    /**
     * Configures monetization for the web ACL or rule group.
     */
    set monetizationConfig(value: cdk.IResolvable | CfnWebACL.MonetizationConfigProperty | undefined);
    /**
     * The name of the web ACL.
     */
    get name(): string | undefined;
     ...
     * Configures the level of DDoS protection that applies to web ACLs associated with Application Load Balancers.
     */
    get onSourceDDoSProtectionConfig(): cdk.IResolvable | CfnWebACL.OnSourceDDoSProtectionConfigProperty | undefined;
    /**
     * Configures the level of DDoS protection that applies to web ACLs associated with Application Load Balancers.
     */
    set onSourceDDoSProtectionConfig(value: cdk.IResolvable | CfnWebACL.OnSourceDDoSProtectionConfigProperty | undefined);
    /**
     * The rule statements used to identify the web requests that you want to manage.
     */
    get rules(): Array<cdk.IResolvable | CfnWebACL.RuleProperty> | cdk.IResolvable | undefined;
    /**
     * The rule statements used to identify the web requests that you want to manage.
     */
    set rules(value: Array<cdk.IResolvable | CfnWebACL.RuleProperty> | cdk.IResolvable | undefined);
    /**
     * Specifies whether this is for an Amazon CloudFront distribution or for a regional application.
     */
    get scope(): string;
     ...
     * Specifies the domains that AWS WAF should accept in a web request token.
     */
    get tokenDomains(): Array<string> | undefined;
    /**
     * Specifies the domains that AWS WAF should accept in a web request token.
     */
    set tokenDomains(value: Array<string> | undefined);
    /**
     * Defines and enables Amazon CloudWatch metrics and web request sample collection.
     */
    get visibilityConfig(): cdk.IResolvable | CfnWebACL.VisibilityConfigProperty;
    /**
     * Defines and enables Amazon CloudWatch metrics and web request sample collection.
     */
    set visibilityConfig(value: cdk.IResolvable | CfnWebACL.VisibilityConfigProperty);
    /**
...
export declare namespace CfnWebACL {
    ...
    interface RuleActionProperty {
         ...
         */
        readonly monetize?: cdk.IResolvable | CfnWebACL.MonetizeActionProperty;
    }
    /**
     * Specifies that AWS WAF should run a `CAPTCHA` check against the request:.
     *
    ...
    interface FieldToMatchProperty {
         ...
         */
        readonly headerOrder?: CfnWebACL.HeaderOrderProperty | cdk.IResolvable;
        /**
         * Inspect the request headers.
         *
         * You must configure scope and pattern matching filters in the `Headers` object, to define the set of headers to and the parts of the headers that AWS WAF inspects.
    ...
    interface ApplicationConfigProperty {
         ...
         */
        readonly attributes: Array<CfnWebACL.ApplicationAttributeProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
    ...
    interface MonetizationConfigProperty {
         ...
         */
        readonly cryptoConfig?: CfnWebACL.CryptoConfigProperty | cdk.IResolvable;
        /**
         * The currency mode for monetization.
         *
         * Use REAL for production payments and TEST for testing with testnet currencies.
    ...
    interface CryptoConfigProperty {
         ...
         */
        readonly paymentNetworks: Array<cdk.IResolvable | CfnWebACL.PaymentNetworkProperty> | cdk.IResolvable;
    }
    /**
     * Configuration for a single payment network.
     *
    ...
    interface PaymentNetworkProperty {
         ...
         */
        readonly prices: Array<cdk.IResolvable | CfnWebACL.PriceProperty> | cdk.IResolvable;
        /**
         * The wallet address for receiving payments.
         *
...
export interface CfnWebACLProps {
     ...
     */
    readonly applicationConfig?: CfnWebACL.ApplicationConfigProperty | cdk.IResolvable;
    /**
     * Specifies custom configurations for the associations between the web ACL and protected resources.
     *
     * Use this to customize the maximum size of the request body that your protected resources forward to AWS WAF for inspection. You can customize this setting for CloudFront, API Gateway, Amazon Cognito, App Runner, or Verified Access resources. The default setting is 16 KB (16,384 bytes).
     ...
     */
    readonly monetizationConfig?: cdk.IResolvable | CfnWebACL.MonetizationConfigProperty;
    /**
     * The name of the web ACL.
     *
...
export declare class CfnWebACLAssociation extends cdk.CfnResource implements cdk.IInspectable, IWebACLAssociationRef {
     ...
     */
    static isCfnWebACLAssociation(x: any): x is CfnWebACLAssociation;
    /**
...
export interface CfnWebACLAssociationProps {
     ...
     */
    readonly resourceArn: appSyncRefs.IGraphQLApiRef | elasticLoadBalancingV2Refs.ILoadBalancerRef | string | waFv2Refs.IWebACLRef;
    /**
     * The Amazon Resource Name (ARN) of the web ACL that you want to associate with the resource.
     *
...
export type { IRegexPatternSetRef, RegexPatternSetReference };
export type { IRuleGroupRef, RuleGroupReference };
export type { IWebACLRef, WebACLReference };
export type { IWebACLAssociationRef, WebACLAssociationReference };
