...
export declare class CfnAppBlock extends cdk.CfnResource implements cdk.IInspectable, IAppBlockRef, cdk.ITaggable {
     ...
     */
    static isCfnAppBlock(x: any): x is CfnAppBlock;
    static arnForAppBlock(resource: IAppBlockRef): string;
    /**
     ...
     */
    private _postSetupScriptDetails?;
    /**
     * The setup script details of the app block.
     */
    private _setupScriptDetails?;
    /**
     * The source S3 location of the app block.
     */
    private _sourceS3Location;
    /**
     ...
     * The packaging type of the app block.
     */
    get packagingType(): string | undefined;
    /**
     * The packaging type of the app block.
     */
    set packagingType(value: string | undefined);
    /**
     * The post setup script details of the app block.
     */
    get postSetupScriptDetails(): cdk.IResolvable | CfnAppBlock.ScriptDetailsProperty | undefined;
    /**
     * The post setup script details of the app block.
     */
    set postSetupScriptDetails(value: cdk.IResolvable | CfnAppBlock.ScriptDetailsProperty | undefined);
    /**
     * The setup script details of the app block.
     */
    get setupScriptDetails(): cdk.IResolvable | CfnAppBlock.ScriptDetailsProperty | undefined;
    /**
     * The setup script details of the app block.
     */
    set setupScriptDetails(value: cdk.IResolvable | CfnAppBlock.ScriptDetailsProperty | undefined);
    /**
     * The source S3 location of the app block.
     */
    get sourceS3Location(): cdk.IResolvable | CfnAppBlock.S3LocationProperty;
    /**
     * The source S3 location of the app block.
     */
    set sourceS3Location(value: cdk.IResolvable | CfnAppBlock.S3LocationProperty);
    /**
     * The tags of the app block.
     */
...
export declare class CfnAppBlockBuilder extends cdk.CfnResource implements cdk.IInspectable, IAppBlockBuilderRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnAppBlockBuilder(x: any): x is CfnAppBlockBuilder;
    /**
     * Creates a new IAppBlockBuilderRef from an ARN
     */
    static fromAppBlockBuilderArn(scope: constructs.Construct, id: string, arn: string): IAppBlockBuilderRef;
    /**
     * Creates a new IAppBlockBuilderRef from a appBlockBuilderName
     */
    static fromAppBlockBuilderName(scope: constructs.Construct, id: string, appBlockBuilderName: string): IAppBlockBuilderRef;
    static arnForAppBlockBuilder(resource: IAppBlockBuilderRef): string;
    /**
     ...
     * The access endpoints of the app block builder.
     */
    get accessEndpoints(): Array<CfnAppBlockBuilder.AccessEndpointProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The access endpoints of the app block builder.
     */
    set accessEndpoints(value: Array<CfnAppBlockBuilder.AccessEndpointProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The ARN of the app block.
     */
    get appBlockArns(): Array<string> | undefined;
    /**
     * The ARN of the app block.
     */
    set appBlockArns(value: Array<string> | undefined);
    /**
     * The description of the app block builder.
     */
    get description(): string | undefined;
     ...
     * Indicates whether default internet access is enabled for the app block builder.
     */
    get enableDefaultInternetAccess(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether default internet access is enabled for the app block builder.
     */
    set enableDefaultInternetAccess(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ARN of the IAM role that is applied to the app block builder.
     */
     ...
     * The VPC configuration for the app block builder.
     */
    get vpcConfig(): cdk.IResolvable | CfnAppBlockBuilder.VpcConfigProperty;
    /**
     * The VPC configuration for the app block builder.
     */
    set vpcConfig(value: cdk.IResolvable | CfnAppBlockBuilder.VpcConfigProperty);
    /**
...
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef, cdk.ITaggable {
     ...
     */
    private _appBlockArn;
    /**
     * A list of attributes to delete from an application.
     */
    private _attributesToDelete?;
    /**
     ...
     * The app block ARN with which the application should be associated.
     */
    set appBlockArn(value: string);
    /**
     * A list of attributes to delete from an application.
     */
    get attributesToDelete(): Array<string> | undefined;
    /**
     * A list of attributes to delete from an application.
     */
    set attributesToDelete(value: Array<string> | undefined);
    /**
     * The description of the application.
     */
    get description(): string | undefined;
     ...
     * The icon S3 location of the application.
     */
    get iconS3Location(): cdk.IResolvable | CfnApplication.S3LocationProperty;
    /**
     * The icon S3 location of the application.
     */
    set iconS3Location(value: cdk.IResolvable | CfnApplication.S3LocationProperty);
    /**
     * The instance families the application supports.
     */
    get instanceFamilies(): Array<string>;
    /**
     * The instance families the application supports.
     */
    set instanceFamilies(value: Array<string>);
    /**
     * The launch parameters of the application.
     */
    get launchParameters(): string | undefined;
    /**
     * The launch parameters of the application.
     */
    set launchParameters(value: string | undefined);
    /**
     * The launch path of the application.
     */
...
export declare class CfnApplicationEntitlementAssociation extends cdk.CfnResource implements cdk.IInspectable, IApplicationEntitlementAssociationRef {
     ...
     */
    static isCfnApplicationEntitlementAssociation(x: any): x is CfnApplicationEntitlementAssociation;
    /**
     ...
     * The name of the entitlement.
     */
    get entitlementName(): string;
    /**
     * The name of the entitlement.
     */
    set entitlementName(value: string);
    /**
     * The name of the stack.
     */
...
export declare class CfnApplicationFleetAssociation extends cdk.CfnResource implements cdk.IInspectable, IApplicationFleetAssociationRef {
     ...
     */
    static isCfnApplicationFleetAssociation(x: any): x is CfnApplicationFleetAssociation;
    /**
     * The ARN of the application.
     */
...
export declare class CfnDirectoryConfig extends cdk.CfnResource implements cdk.IInspectable, IDirectoryConfigRef {
     ...
     */
    static isCfnDirectoryConfig(x: any): x is CfnDirectoryConfig;
    /**
     ...
     * The certificate-based authentication properties used to authenticate SAML 2.0 Identity Provider (IdP) user identities to Active Directory domain-joined streaming instances.
     */
    get certificateBasedAuthProperties(): CfnDirectoryConfig.CertificateBasedAuthPropertiesProperty | cdk.IResolvable | undefined;
    /**
     * The certificate-based authentication properties used to authenticate SAML 2.0 Identity Provider (IdP) user identities to Active Directory domain-joined streaming instances.
     */
    set certificateBasedAuthProperties(value: CfnDirectoryConfig.CertificateBasedAuthPropertiesProperty | cdk.IResolvable | undefined);
    /**
     * The fully qualified name of the directory (for example, corp.example.com).
     */
     ...
     * The distinguished names of the organizational units for computer accounts.
     */
    get organizationalUnitDistinguishedNames(): Array<string>;
    /**
     * The distinguished names of the organizational units for computer accounts.
     */
    set organizationalUnitDistinguishedNames(value: Array<string>);
    /**
     * The credentials for the service account used by the streaming instance to connect to the directory.
     */
    get serviceAccountCredentials(): cdk.IResolvable | CfnDirectoryConfig.ServiceAccountCredentialsProperty;
    /**
     * The credentials for the service account used by the streaming instance to connect to the directory.
     */
    set serviceAccountCredentials(value: cdk.IResolvable | CfnDirectoryConfig.ServiceAccountCredentialsProperty);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnEntitlement extends cdk.CfnResource implements cdk.IInspectable, IEntitlementRef {
     ...
     */
    static isCfnEntitlement(x: any): x is CfnEntitlement;
    /**
     * Specifies whether to entitle all apps or only selected apps.
     */
    private _appVisibility;
    /**
     ...
     * Specifies whether to entitle all apps or only selected apps.
     */
    get appVisibility(): string;
    /**
     * Specifies whether to entitle all apps or only selected apps.
     */
    set appVisibility(value: string);
    /**
     * The attributes of the entitlement.
     */
    get attributes(): Array<CfnEntitlement.AttributeProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The attributes of the entitlement.
     */
    set attributes(value: Array<CfnEntitlement.AttributeProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The description of the entitlement.
     */
    get description(): string | undefined;
...
export declare class CfnFleet extends cdk.CfnResource implements cdk.IInspectable, IFleetRef, cdk.ITaggable {
     ...
     */
    private _maxConcurrentSessions?;
    /**
     ...
     */
    private _usbDeviceFilterStrings?;
    /**
     ...
     * The desired capacity for the fleet.
     */
    get computeCapacity(): CfnFleet.ComputeCapacityProperty | cdk.IResolvable | undefined;
    /**
     * The desired capacity for the fleet.
     */
    set computeCapacity(value: CfnFleet.ComputeCapacityProperty | cdk.IResolvable | undefined);
    /**
     * The description to display.
     */
    get description(): string | undefined;
     ...
     */
    set description(value: string | undefined);
    get disableImdsv1(): boolean | cdk.IResolvable | undefined;
    set disableImdsv1(value: boolean | cdk.IResolvable | undefined);
    /**
     * The amount of time that a streaming session remains active after users disconnect.
     */
    get disconnectTimeoutInSeconds(): number | undefined;
    /**
     * The amount of time that a streaming session remains active after users disconnect.
     */
    set disconnectTimeoutInSeconds(value: number | undefined);
    /**
     * The fleet name to display.
     */
    get displayName(): string | undefined;
     ...
     * The name of the directory and organizational unit (OU) to use to join the fleet to a Microsoft Active Directory domain.
     */
    get domainJoinInfo(): CfnFleet.DomainJoinInfoProperty | cdk.IResolvable | undefined;
    /**
     * The name of the directory and organizational unit (OU) to use to join the fleet to a Microsoft Active Directory domain.
     */
    set domainJoinInfo(value: CfnFleet.DomainJoinInfoProperty | cdk.IResolvable | undefined);
    /**
     * Enables or disables default internet access for the fleet.
     */
    get enableDefaultInternetAccess(): boolean | cdk.IResolvable | undefined;
     ...
     * The amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the `DisconnectTimeoutInSeconds` time interval begins.
     */
    get idleDisconnectTimeoutInSeconds(): number | undefined;
    /**
     * The amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the `DisconnectTimeoutInSeconds` time interval begins.
     */
    set idleDisconnectTimeoutInSeconds(value: number | undefined);
    /**
     * The ARN of the public, private, or shared image to use.
     */
    get imageArn(): string | undefined;
    /**
     * The ARN of the public, private, or shared image to use.
     */
    set imageArn(value: string | undefined);
    /**
     * The name of the image used to create the fleet.
     */
     ...
     * The maximum number of concurrent sessions that can be run on an Elastic fleet.
     */
    get maxConcurrentSessions(): number | undefined;
    /**
     * The maximum number of concurrent sessions that can be run on an Elastic fleet.
     */
    set maxConcurrentSessions(value: number | undefined);
    /**
     * Max number of user sessions on an instance.
     */
    get maxSessionsPerInstance(): number | undefined;
    /**
     * Max number of user sessions on an instance.
     */
    set maxSessionsPerInstance(value: number | undefined);
    /**
     * The maximum amount of time that a streaming session can remain active, in seconds.
     */
    get maxUserDurationInSeconds(): number | undefined;
    /**
     * The maximum amount of time that a streaming session can remain active, in seconds.
     */
    set maxUserDurationInSeconds(value: number | undefined);
    /**
     * A unique name for the fleet.
     */
    get name(): string;
    ...
    get rootVolumeConfig(): cdk.IResolvable | CfnFleet.VolumeConfigProperty | undefined;
    set rootVolumeConfig(value: cdk.IResolvable | CfnFleet.VolumeConfigProperty | undefined);
    /**
     * The S3 location of the session scripts configuration zip file.
     */
    get sessionScriptS3Location(): cdk.IResolvable | CfnFleet.S3LocationProperty | undefined;
    /**
     * The S3 location of the session scripts configuration zip file.
     */
    set sessionScriptS3Location(value: cdk.IResolvable | CfnFleet.S3LocationProperty | undefined);
    /**
     * The WorkSpaces Applications view that is displayed to your users when they stream from the fleet.
     */
    get streamView(): string | undefined;
    /**
     * The WorkSpaces Applications view that is displayed to your users when they stream from the fleet.
     */
    set streamView(value: string | undefined);
    /**
     * An array of key-value pairs.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The USB device filter strings that specify which USB devices a user can redirect to the fleet streaming session, when using the Windows native client.
     */
    get usbDeviceFilterStrings(): Array<string> | undefined;
    /**
     * The USB device filter strings that specify which USB devices a user can redirect to the fleet streaming session, when using the Windows native client.
     */
    set usbDeviceFilterStrings(value: Array<string> | undefined);
    /**
     * The VPC configuration for the fleet.
     */
    get vpcConfig(): cdk.IResolvable | CfnFleet.VpcConfigProperty | undefined;
    /**
     * The VPC configuration for the fleet.
     */
    set vpcConfig(value: cdk.IResolvable | CfnFleet.VpcConfigProperty | undefined);
    /**
...
export declare namespace CfnFleet {
     ...
     */
    interface VolumeConfigProperty {
        /**
...
export interface CfnFleetProps {
     ...
     */
    readonly disableImdsv1?: boolean | cdk.IResolvable;
    /**
     * The amount of time that a streaming session remains active after users disconnect.
     *
     ...
     */
    readonly rootVolumeConfig?: cdk.IResolvable | CfnFleet.VolumeConfigProperty;
    /**
     * The S3 location of the session scripts configuration zip file.
     *
...
export declare class CfnImageBuilder extends cdk.CfnResource implements cdk.IInspectable, IImageBuilderRef, cdk.ITaggable {
     ...
     */
    static isCfnImageBuilder(x: any): x is CfnImageBuilder;
    /**
     * Creates a new IImageBuilderRef from a imageBuilderName
     */
    static fromImageBuilderName(scope: constructs.Construct, id: string, imageBuilderName: string): IImageBuilderRef;
    static arnForImageBuilder(resource: IImageBuilderRef): string;
    /**
    ...
    private _name;
    private _rootVolumeConfig?;
    private _softwaresToInstall?;
    private _softwaresToUninstall?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * The list of virtual private cloud (VPC) interface endpoint objects.
     */
    get accessEndpoints(): Array<CfnImageBuilder.AccessEndpointProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of virtual private cloud (VPC) interface endpoint objects.
     */
    set accessEndpoints(value: Array<CfnImageBuilder.AccessEndpointProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The version of the WorkSpaces Applications agent to use for this image builder.
     */
    get appstreamAgentVersion(): string | undefined;
    /**
     * The version of the WorkSpaces Applications agent to use for this image builder.
     */
    set appstreamAgentVersion(value: string | undefined);
    /**
     * The description to display.
     */
    get description(): string | undefined;
     ...
     * The name of the directory and organizational unit (OU) to use to join the image builder to a Microsoft Active Directory domain.
     */
    get domainJoinInfo(): CfnImageBuilder.DomainJoinInfoProperty | cdk.IResolvable | undefined;
    /**
     * The name of the directory and organizational unit (OU) to use to join the image builder to a Microsoft Active Directory domain.
     */
    set domainJoinInfo(value: CfnImageBuilder.DomainJoinInfoProperty | cdk.IResolvable | undefined);
    /**
     * Enables or disables default internet access for the image builder.
     */
    get enableDefaultInternetAccess(): boolean | cdk.IResolvable | undefined;
     ...
     */
    set name(value: string);
    get rootVolumeConfig(): cdk.IResolvable | CfnImageBuilder.VolumeConfigProperty | undefined;
    set rootVolumeConfig(value: cdk.IResolvable | CfnImageBuilder.VolumeConfigProperty | undefined);
    get softwaresToInstall(): Array<string> | undefined;
    set softwaresToInstall(value: Array<string> | undefined);
    get softwaresToUninstall(): Array<string> | undefined;
    set softwaresToUninstall(value: Array<string> | undefined);
    /**
     * An array of key-value pairs.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The VPC configuration for the image builder.
     */
    get vpcConfig(): cdk.IResolvable | CfnImageBuilder.VpcConfigProperty | undefined;
    /**
     * The VPC configuration for the image builder.
     */
    set vpcConfig(value: cdk.IResolvable | CfnImageBuilder.VpcConfigProperty | undefined);
    /**
     * The URL to start an image builder streaming session, returned as a string.
     *
     * @cloudformationAttribute StreamingUrl
     */
    get attrStreamingUrl(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnImageBuilderProps {
     ...
     */
    readonly rootVolumeConfig?: cdk.IResolvable | CfnImageBuilder.VolumeConfigProperty;
    /**
     ...
     */
    readonly softwaresToInstall?: Array<string>;
    /**
     ...
     */
    readonly softwaresToUninstall?: Array<string>;
    /**
     * An array of key-value pairs.
     *
...
export declare class CfnStack extends cdk.CfnResource implements cdk.IInspectable, IStackRef, cdk.ITaggable {
     ...
     */
    static fromStackName(scope: constructs.Construct, id: string, stackName: string): IStackRef;
     ...
     */
    private _contentRedirection?;
    /**
     * *This parameter has been deprecated.*.
     */
    private _deleteStorageConnectors?;
    /**
     * The description to display.
     */
    private _description?;
     ...
     * The list of virtual private cloud (VPC) interface endpoint objects.
     */
    get accessEndpoints(): Array<CfnStack.AccessEndpointProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of virtual private cloud (VPC) interface endpoint objects.
     */
    set accessEndpoints(value: Array<CfnStack.AccessEndpointProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The configuration for agent access on a stack.
     */
    get agentAccessConfig(): CfnStack.AgentAccessConfigProperty | cdk.IResolvable | undefined;
    /**
     * The configuration for agent access on a stack.
     */
    set agentAccessConfig(value: CfnStack.AgentAccessConfigProperty | cdk.IResolvable | undefined);
    /**
     * The persistent application settings for users of the stack.
     */
    get applicationSettings(): CfnStack.ApplicationSettingsProperty | cdk.IResolvable | undefined;
    /**
     * The persistent application settings for users of the stack.
     */
    set applicationSettings(value: CfnStack.ApplicationSettingsProperty | cdk.IResolvable | undefined);
    /**
     * The stack attributes to delete.
     */
    get attributesToDelete(): Array<string> | undefined;
     ...
     * The content redirection settings for the stack.
     */
    get contentRedirection(): CfnStack.ContentRedirectionProperty | cdk.IResolvable | undefined;
    /**
     * The content redirection settings for the stack.
     */
    set contentRedirection(value: CfnStack.ContentRedirectionProperty | cdk.IResolvable | undefined);
    /**
     * *This parameter has been deprecated.*.
     */
    get deleteStorageConnectors(): boolean | cdk.IResolvable | undefined;
    /**
     * *This parameter has been deprecated.*.
     */
    set deleteStorageConnectors(value: boolean | cdk.IResolvable | undefined);
    /**
     * The description to display.
     */
    get description(): string | undefined;
     ...
     * The domains where WorkSpaces Applications streaming sessions can be embedded in an iframe.
     */
    get embedHostDomains(): Array<string> | undefined;
    /**
     * The domains where WorkSpaces Applications streaming sessions can be embedded in an iframe.
     */
    set embedHostDomains(value: Array<string> | undefined);
    /**
     * The URL that users are redirected to after they click the Send Feedback link.
     */
     ...
     * The URL that users are redirected to after they click the Send Feedback link.
     */
    set feedbackUrl(value: string | undefined);
    /**
     * The name of the stack.
     */
     ...
     * The storage connectors to enable.
     */
    get storageConnectors(): Array<cdk.IResolvable | CfnStack.StorageConnectorProperty> | cdk.IResolvable | undefined;
    /**
     * The storage connectors to enable.
     */
    set storageConnectors(value: Array<cdk.IResolvable | CfnStack.StorageConnectorProperty> | cdk.IResolvable | undefined);
    /**
     * The streaming protocol that you want your stack to prefer.
     */
    get streamingExperienceSettings(): cdk.IResolvable | CfnStack.StreamingExperienceSettingsProperty | undefined;
    /**
     * The streaming protocol that you want your stack to prefer.
     */
    set streamingExperienceSettings(value: cdk.IResolvable | CfnStack.StreamingExperienceSettingsProperty | undefined);
    /**
     * An array of key-value pairs.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The actions that are enabled or disabled for users during their streaming sessions.
     */
    get userSettings(): Array<cdk.IResolvable | CfnStack.UserSettingProperty> | cdk.IResolvable | undefined;
    /**
     * The actions that are enabled or disabled for users during their streaming sessions.
     */
    set userSettings(value: Array<cdk.IResolvable | CfnStack.UserSettingProperty> | cdk.IResolvable | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnStack {
    ...
    interface ContentRedirectionProperty {
         ...
         */
        readonly hostToClient?: cdk.IResolvable | CfnStack.UrlRedirectionConfigProperty;
    }
    /**
     * The configuration for URL redirection.
     *
    ...
    interface UrlRedirectionConfigProperty {
         ...
         */
        readonly deniedUrls?: Array<string>;
        /**
     ...
     */
    interface AgentAccessConfigProperty {
        /**
         ...
         */
        readonly screenshotsUploadEnabled?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly settings: Array<CfnStack.AgentAccessSettingProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
     ...
     */
    interface AgentAccessSettingProperty {
        /**
...
export interface CfnStackProps {
     ...
     */
    readonly agentAccessConfig?: CfnStack.AgentAccessConfigProperty | cdk.IResolvable;
    /**
     * The persistent application settings for users of the stack.
     *
     ...
     */
    readonly contentRedirection?: CfnStack.ContentRedirectionProperty | cdk.IResolvable;
    /**
     * *This parameter has been deprecated.*.
     *
...
export declare class CfnStackFleetAssociation extends cdk.CfnResource implements cdk.IInspectable, IStackFleetAssociationRef {
     ...
     */
    static isCfnStackFleetAssociation(x: any): x is CfnStackFleetAssociation;
    /**
     * The name of the fleet.
     */
    private _fleetName;
...
export declare class CfnStackUserAssociation extends cdk.CfnResource implements cdk.IInspectable, IStackUserAssociationRef {
     ...
     */
    static isCfnStackUserAssociation(x: any): x is CfnStackUserAssociation;
    /**
     ...
     * Specifies whether a welcome email is sent to a user after the user is created in the user pool.
     */
    get sendEmailNotification(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether a welcome email is sent to a user after the user is created in the user pool.
     */
    set sendEmailNotification(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the stack that is associated with the user.
     */
    get stackName(): string;
...
export type { IAppBlockRef, AppBlockReference };
export type { IAppBlockBuilderRef, AppBlockBuilderReference };
export type { IApplicationRef, ApplicationReference };
export type { IApplicationEntitlementAssociationRef, ApplicationEntitlementAssociationReference };
export type { IApplicationFleetAssociationRef, ApplicationFleetAssociationReference };
export type { IDirectoryConfigRef, DirectoryConfigReference };
export type { IEntitlementRef, EntitlementReference };
export type { IFleetRef, FleetReference };
export type { IImageBuilderRef, ImageBuilderReference };
export type { IStackRef, StackReference };
export type { IStackFleetAssociationRef, StackFleetAssociationReference };
export type { IStackUserAssociationRef, StackUserAssociationReference };
