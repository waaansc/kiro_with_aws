...
export declare class CfnAgreement extends cdk.CfnResource implements cdk.IInspectable, IAgreementRef, cdk.ITaggable {
     ...
     */
    private _enforceMessageSigning?;
    /**
     ...
     * The landing directory (folder) for files that are transferred by using the AS2 protocol.
     */
    get baseDirectory(): string | undefined;
    /**
     * The landing directory (folder) for files that are transferred by using the AS2 protocol.
     */
    set baseDirectory(value: string | undefined);
    /**
     * A `CustomDirectoriesType` structure.
     */
    get customDirectories(): CfnAgreement.CustomDirectoriesProperty | cdk.IResolvable | undefined;
    /**
     * A `CustomDirectoriesType` structure.
     */
    set customDirectories(value: CfnAgreement.CustomDirectoriesProperty | cdk.IResolvable | undefined);
    /**
     * The name or short description that's used to identify the agreement.
     */
     ...
     * Determines whether or not unsigned messages from your trading partners will be accepted.
     */
    get enforceMessageSigning(): string | undefined;
    /**
     * Determines whether or not unsigned messages from your trading partners will be accepted.
     */
    set enforceMessageSigning(value: string | undefined);
    /**
     * A unique identifier for the AS2 local profile.
     */
     ...
     * Determines whether or not Transfer Family appends a unique string of characters to the end of the AS2 message payload filename when saving it.
     */
    get preserveFilename(): string | undefined;
    /**
     * Determines whether or not Transfer Family appends a unique string of characters to the end of the AS2 message payload filename when saving it.
     */
    set preserveFilename(value: string | undefined);
    /**
     * A system-assigned unique identifier for a server instance.
     */
    get serverId(): string;
...
export declare class CfnCertificate extends cdk.CfnResource implements cdk.IInspectable, ICertificateRef, cdk.ITaggable {
     ...
     * An optional date that specifies when the certificate becomes active.
     */
    set activeDate(value: string | undefined);
    /**
     * The file name for the certificate.
     */
     ...
     * An optional date that specifies when the certificate becomes inactive.
     */
    get inactiveDate(): string | undefined;
    /**
     * An optional date that specifies when the certificate becomes inactive.
     */
    set inactiveDate(value: string | undefined);
    /**
     * The file that contains the private key for the certificate that's being imported.
     */
...
export declare class CfnConnector extends cdk.CfnResource implements cdk.IInspectable, IConnectorRef, cdk.ITaggable {
     ...
     * A structure that contains the parameters for an AS2 connector object.
     */
    get as2Config(): any | cdk.IResolvable | undefined;
    /**
     * A structure that contains the parameters for an AS2 connector object.
     */
    set as2Config(value: any | cdk.IResolvable | undefined);
    /**
     * Current egress configuration of the connector, showing how traffic is routed to the SFTP server.
     */
    get egressConfig(): CfnConnector.ConnectorEgressConfigProperty | cdk.IResolvable | undefined;
    /**
     * Current egress configuration of the connector, showing how traffic is routed to the SFTP server.
     */
    set egressConfig(value: CfnConnector.ConnectorEgressConfigProperty | cdk.IResolvable | undefined);
    /**
     * Type of egress configuration for the connector.
     */
    get egressType(): string | undefined;
    /**
     * Type of egress configuration for the connector.
     */
    set egressType(value: string | undefined);
    /**
     * IP address type for Connector.
     */
     ...
     * The text name of the security policy for the specified connector.
     */
    get securityPolicyName(): string | undefined;
    /**
     * The text name of the security policy for the specified connector.
     */
    set securityPolicyName(value: string | undefined);
    /**
     * A structure that contains the parameters for an SFTP connector object.
     */
    get sftpConfig(): cdk.IResolvable | CfnConnector.SftpConfigProperty | undefined;
    /**
     * A structure that contains the parameters for an SFTP connector object.
     */
    set sftpConfig(value: cdk.IResolvable | CfnConnector.SftpConfigProperty | undefined);
    /**
     * Key-value pairs that can be used to group and search for connectors.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrServiceManagedEgressIpAddresses(): Array<string>;
    /**
...
export declare namespace CfnConnector {
    ...
    interface As2ConfigProperty {
         ...
         */
        readonly asyncMdnConfig?: CfnConnector.ConnectorAsyncMdnConfigProperty | cdk.IResolvable;
        /**
    ...
    interface ConnectorAsyncMdnConfigProperty {
         ...
         */
        readonly serverIds: Array<string>;
        /**
...
export declare class CfnProfile extends cdk.CfnResource implements cdk.IInspectable, IProfileRef, cdk.ITaggable {
     ...
     * An array of identifiers for the imported certificates.
     */
    get certificateIds(): Array<string> | undefined;
    /**
     * An array of identifiers for the imported certificates.
     */
    set certificateIds(value: Array<string> | undefined);
    /**
     * Indicates whether to list only `LOCAL` type profiles or only `PARTNER` type profiles.
     */
...
export declare class CfnServer extends cdk.CfnResource implements cdk.IInspectable, IServerRef, cdk.ITaggable {
     ...
     * The virtual private cloud (VPC) endpoint settings that are configured for your server.
     */
    get endpointDetails(): CfnServer.EndpointDetailsProperty | cdk.IResolvable | undefined;
    /**
     * The virtual private cloud (VPC) endpoint settings that are configured for your server.
     */
    set endpointDetails(value: CfnServer.EndpointDetailsProperty | cdk.IResolvable | undefined);
    /**
     * The type of endpoint that you want your server to use.
     */
     ...
     * Required when `IdentityProviderType` is set to `AWS_DIRECTORY_SERVICE` , `AWS _LAMBDA` or `API_GATEWAY` .
     */
    get identityProviderDetails(): CfnServer.IdentityProviderDetailsProperty | cdk.IResolvable | undefined;
    /**
     * Required when `IdentityProviderType` is set to `AWS_DIRECTORY_SERVICE` , `AWS _LAMBDA` or `API_GATEWAY` .
     */
    set identityProviderDetails(value: CfnServer.IdentityProviderDetailsProperty | cdk.IResolvable | undefined);
    /**
     * The mode of authentication for a server.
     */
     ...
     * Specifies a string to display when users connect to a server. This string is displayed after the user authenticates.
     */
    get postAuthenticationLoginBanner(): string | undefined;
    /**
     * Specifies a string to display when users connect to a server. This string is displayed after the user authenticates.
     */
    set postAuthenticationLoginBanner(value: string | undefined);
    /**
     * Specifies a string to display when users connect to a server.
     */
    get preAuthenticationLoginBanner(): string | undefined;
    /**
     * Specifies a string to display when users connect to a server.
     */
    set preAuthenticationLoginBanner(value: string | undefined);
    /**
     * The protocol settings that are configured for your server.
     */
    get protocolDetails(): cdk.IResolvable | CfnServer.ProtocolDetailsProperty | undefined;
    /**
     * The protocol settings that are configured for your server.
     */
    set protocolDetails(value: cdk.IResolvable | CfnServer.ProtocolDetailsProperty | undefined);
    /**
     * Specifies the file transfer protocol or protocols over which your file transfer protocol client can connect to your server's endpoint.
     */
     ...
     * Specifies whether or not performance for your Amazon S3 directories is optimized.
     */
    get s3StorageOptions(): cdk.IResolvable | CfnServer.S3StorageOptionsProperty | undefined;
    /**
     * Specifies whether or not performance for your Amazon S3 directories is optimized.
     */
    set s3StorageOptions(value: cdk.IResolvable | CfnServer.S3StorageOptionsProperty | undefined);
    /**
     * Specifies the name of the security policy for the server.
     */
    get securityPolicyName(): string | undefined;
     ...
     * Specifies the log groups to which your server logs are sent.
     */
    get structuredLogDestinations(): Array<string> | undefined;
    /**
     * Specifies the log groups to which your server logs are sent.
     */
    set structuredLogDestinations(value: Array<string> | undefined);
    /**
     * Key-value pairs that can be used to group and search for servers.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * Specifies the workflow ID for the workflow to assign and the execution role that's used for executing the workflow.
     */
    get workflowDetails(): cdk.IResolvable | CfnServer.WorkflowDetailsProperty | undefined;
    /**
     * Specifies the workflow ID for the workflow to assign and the execution role that's used for executing the workflow.
     */
    set workflowDetails(value: cdk.IResolvable | CfnServer.WorkflowDetailsProperty | undefined);
    /**
     ...
     */
    get attrAs2ServiceManagedEgressIpAddresses(): Array<string>;
    /**
     * Specifies the unique system-assigned identifier for a server that you instantiate.
     *
     * @cloudformationAttribute ServerId
     */
    get attrServerId(): string;
    /**
...
export declare class CfnUser extends cdk.CfnResource implements cdk.IInspectable, IUserRef, cdk.ITaggable {
     ...
     * Logical directory mappings that specify what Amazon S3 or Amazon EFS paths and keys should be visible to your user and how you want to make them visible.
     */
    get homeDirectoryMappings(): Array<CfnUser.HomeDirectoryMapEntryProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Logical directory mappings that specify what Amazon S3 or Amazon EFS paths and keys should be visible to your user and how you want to make them visible.
     */
    set homeDirectoryMappings(value: Array<CfnUser.HomeDirectoryMapEntryProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The type of landing directory (folder) that you want your users' home directory to be when they log in to the server.
     */
    get homeDirectoryType(): string | undefined;
    /**
     * The type of landing directory (folder) that you want your users' home directory to be when they log in to the server.
     */
    set homeDirectoryType(value: string | undefined);
    /**
     * A session policy for your user so you can use the same IAM role across multiple users.
     */
     ...
     * Specifies the full POSIX identity, including user ID ( `Uid` ), group ID ( `Gid` ), and any secondary groups IDs ( `SecondaryGids` ), that controls your users' access to your Amazon Elastic File System (Amazon EFS) file systems.
     */
    get posixProfile(): cdk.IResolvable | CfnUser.PosixProfileProperty | undefined;
    /**
     * Specifies the full POSIX identity, including user ID ( `Uid` ), group ID ( `Gid` ), and any secondary groups IDs ( `SecondaryGids` ), that controls your users' access to your Amazon Elastic File System (Amazon EFS) file systems.
     */
    set posixProfile(value: cdk.IResolvable | CfnUser.PosixProfileProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that controls your users' access to your Amazon S3 bucket or Amazon EFS file system.
     */
    get role(): string;
     ...
     * Specifies the public key portion of the Secure Shell (SSH) keys stored for the described user.
     */
    get sshPublicKeys(): Array<string> | undefined;
    /**
     * Specifies the public key portion of the Secure Shell (SSH) keys stored for the described user.
     */
    set sshPublicKeys(value: Array<string> | undefined);
    /**
     * Key-value pairs that can be used to group and search for users.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnWorkflow extends cdk.CfnResource implements cdk.IInspectable, IWorkflowRef, cdk.ITaggable {
     ...
     * Specifies the steps (actions) to take if errors are encountered during execution of the workflow.
     */
    get onExceptionSteps(): Array<cdk.IResolvable | CfnWorkflow.WorkflowStepProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies the steps (actions) to take if errors are encountered during execution of the workflow.
     */
    set onExceptionSteps(value: Array<cdk.IResolvable | CfnWorkflow.WorkflowStepProperty> | cdk.IResolvable | undefined);
    /**
     * Specifies the details for the steps that are in the specified workflow.
     */
    get steps(): Array<cdk.IResolvable | CfnWorkflow.WorkflowStepProperty> | cdk.IResolvable;
    /**
     * Specifies the details for the steps that are in the specified workflow.
     */
    set steps(value: Array<cdk.IResolvable | CfnWorkflow.WorkflowStepProperty> | cdk.IResolvable);
    /**
     * Key-value pairs that can be used to group and search for workflows.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnWebApp extends cdk.CfnResource implements cdk.IInspectable, IWebAppRef, cdk.ITaggableV2 {
     ...
     * The `AccessEndpoint` is the URL that you provide to your users for them to interact with the Transfer Family web app.
     */
    get accessEndpoint(): string | undefined;
    /**
     * The `AccessEndpoint` is the URL that you provide to your users for them to interact with the Transfer Family web app.
     */
    set accessEndpoint(value: string | undefined);
    get endpointDetails(): CfnWebApp.EndpointDetailsProperty | cdk.IResolvable | undefined;
    set endpointDetails(value: CfnWebApp.EndpointDetailsProperty | cdk.IResolvable | undefined);
    /**
     * You can provide a structure that contains the details for the identity provider to use with your web app.
     */
    get identityProviderDetails(): CfnWebApp.IdentityProviderDetailsProperty | cdk.IResolvable;
    /**
     * You can provide a structure that contains the details for the identity provider to use with your web app.
     */
    set identityProviderDetails(value: CfnWebApp.IdentityProviderDetailsProperty | cdk.IResolvable);
    /**
     * Key-value pairs that can be used to group and search for web apps.
     */
     ...
     * A structure that contains the customization fields for the web app.
     */
    get webAppCustomization(): cdk.IResolvable | CfnWebApp.WebAppCustomizationProperty | undefined;
    /**
     * A structure that contains the customization fields for the web app.
     */
    set webAppCustomization(value: cdk.IResolvable | CfnWebApp.WebAppCustomizationProperty | undefined);
    /**
     * Setting for the type of endpoint policy for the web app. The default value is `STANDARD` .
     */
    get webAppEndpointPolicy(): string | undefined;
    /**
     * Setting for the type of endpoint policy for the web app. The default value is `STANDARD` .
     */
    set webAppEndpointPolicy(value: string | undefined);
    /**
     * A union that contains the value for number of concurrent connections or the user sessions on your web app.
     */
    get webAppUnits(): cdk.IResolvable | CfnWebApp.WebAppUnitsProperty | undefined;
    /**
     * A union that contains the value for number of concurrent connections or the user sessions on your web app.
     */
    set webAppUnits(value: cdk.IResolvable | CfnWebApp.WebAppUnitsProperty | undefined);
    /**
     ...
     */
    get attrIdentityProviderDetailsApplicationArn(): string;
    /**
     * @cloudformationAttribute VpcEndpointId
     */
    get attrVpcEndpointId(): string;
    /**
     * The unique identifier for the web app.
     *
     * @cloudformationAttribute WebAppId
     */
    get attrWebAppId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnWebApp {
    ...
    interface EndpointDetailsProperty {
         ...
         */
        readonly vpc?: cdk.IResolvable | CfnWebApp.VpcProperty;
    }
    /**
     * You can provide a structure that contains the details for the VPC endpoint to use with your web app.
     *
...
export interface CfnWebAppProps {
     ...
     */
    readonly endpointDetails?: CfnWebApp.EndpointDetailsProperty | cdk.IResolvable;
    /**
     * You can provide a structure that contains the details for the identity provider to use with your web app.
     *
