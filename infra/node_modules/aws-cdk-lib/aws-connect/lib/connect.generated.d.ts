 ...
 */
export declare class CfnDataLakeAssociation extends cdk.CfnResource implements cdk.IInspectable, IDataLakeAssociationRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnDataLakeAssociation from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDataLakeAssociation;
    /**
     * Checks whether the given object is a CfnDataLakeAssociation
     */
    static isCfnDataLakeAssociation(x: any): x is CfnDataLakeAssociation;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnDataLakeAssociationProps);
    get dataLakeAssociationRef(): DataLakeAssociationReference;
    /**
     * The identifier of the analytics data set.
     */
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-datalakeassociation.html
 */
export interface CfnDataLakeAssociationProps {
    /**
     * The identifier of the analytics data set.
     *
...
export declare class CfnDataTable extends cdk.CfnResource implements cdk.IInspectable, IDataTableRef, cdk.ITaggableV2 {
     ...
     * The data level that concurrent value edits are locked on.
     */
    get valueLockLevel(): string;
    /**
     * The data level that concurrent value edits are locked on.
     */
    set valueLockLevel(value: string);
    /**
...
export declare class CfnDataTableRecord extends cdk.CfnResource implements cdk.IInspectable, IDataTableRecordRef {
     ...
     */
    set dataTableArn(value: string);
    get dataTableRecord(): CfnDataTableRecord.DataTableRecordProperty | cdk.IResolvable;
    set dataTableRecord(value: CfnDataTableRecord.DataTableRecordProperty | cdk.IResolvable);
    /**
     * The Amazon Resource Name (ARN) of the instance.
     */
    get instanceArn(): string;
...
export type { IDataLakeAssociationRef, DataLakeAssociationReference };
