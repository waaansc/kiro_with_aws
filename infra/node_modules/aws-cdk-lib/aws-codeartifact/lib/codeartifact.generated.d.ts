...
import { DomainReference, IDomainRef, IPackageGroupRef, IPackageRef, IRepositoryRef, PackageGroupReference, PackageReference, RepositoryReference } from "../../interfaces/generated/aws-codeartifact-interfaces.generated";
/**
 ...
 */
export declare class CfnPackage extends cdk.CfnResource implements cdk.IInspectable, IPackageRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    get attrOriginConfiguration(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnPackage {
    ...
    interface OriginConfigurationProperty {
         ...
         */
        readonly restrictions?: cdk.IResolvable | CfnPackage.RestrictionsProperty;
    }
    /**
     * The origin restrictions for the package.
     *
