 ...
 */
export declare class ControlPlaneScalingTier {
    /**
     * Standard control plane. This is the EKS service default and incurs no additional cost.
     */
    static readonly STANDARD: ControlPlaneScalingTier;
    /**
     * Extra-large provisioned control plane tier.
     */
    static readonly TIER_XL: ControlPlaneScalingTier;
    /**
     * 2x extra-large provisioned control plane tier.
     */
    static readonly TIER_2XL: ControlPlaneScalingTier;
    /**
     * 4x extra-large provisioned control plane tier.
     */
    static readonly TIER_4XL: ControlPlaneScalingTier;
    /**
     * 8x extra-large provisioned control plane tier.
     */
    static readonly TIER_8XL: ControlPlaneScalingTier;
    /**
     ...
     */
    static of(tier: string): ControlPlaneScalingTier;
    /**
