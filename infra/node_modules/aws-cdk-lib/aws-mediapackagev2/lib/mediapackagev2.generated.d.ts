...
export declare class CfnChannel extends cdk.CfnResource implements cdk.IInspectable, IChannelRef, cdk.ITaggableV2 {
     ...
     */
    private _inputSwitchConfiguration?;
    /**
     ...
     */
    private _outputHeaderConfiguration?;
    private _tags?;
     ...
     * The name of the channel group associated with the channel configuration.
     */
    get channelGroupName(): string;
    /**
     * The name of the channel group associated with the channel configuration.
     */
    set channelGroupName(value: string);
    /**
     * The name of the channel.
     */
     ...
     * The configuration for input switching based on the media quality confidence score (MQCS) as provided from AWS Elemental MediaLive.
     */
    get inputSwitchConfiguration(): CfnChannel.InputSwitchConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration for input switching based on the media quality confidence score (MQCS) as provided from AWS Elemental MediaLive.
     */
    set inputSwitchConfiguration(value: CfnChannel.InputSwitchConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The input type will be an immutable field which will be used to define whether the channel will allow CMAF ingest or HLS ingest.
     */
     ...
     * The settings for what common media server data (CMSD) headers AWS Elemental MediaPackage includes in responses to the CDN.
     */
    get outputHeaderConfiguration(): cdk.IResolvable | CfnChannel.OutputHeaderConfigurationProperty | undefined;
    /**
     * The settings for what common media server data (CMSD) headers AWS Elemental MediaPackage includes in responses to the CDN.
     */
    set outputHeaderConfiguration(value: cdk.IResolvable | CfnChannel.OutputHeaderConfigurationProperty | undefined);
     ...
     */
    get attrIngestEndpoints(): cdk.IResolvable;
    /**
...
export declare class CfnOriginEndpoint extends cdk.CfnResource implements cdk.IInspectable, IOriginEndpointRef, cdk.ITaggableV2 {
     ...
     * A DASH manifest configuration.
     */
    get dashManifests(): Array<CfnOriginEndpoint.DashManifestConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A DASH manifest configuration.
     */
    set dashManifests(value: Array<CfnOriginEndpoint.DashManifestConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The description associated with the origin endpoint.
     */
    get description(): string | undefined;
     ...
     * The failover settings for the endpoint.
     */
    get forceEndpointErrorConfiguration(): CfnOriginEndpoint.ForceEndpointErrorConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The failover settings for the endpoint.
     */
    set forceEndpointErrorConfiguration(value: CfnOriginEndpoint.ForceEndpointErrorConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The HLS manifests associated with the origin endpoint configuration.
     */
    get hlsManifests(): Array<CfnOriginEndpoint.HlsManifestConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The HLS manifests associated with the origin endpoint configuration.
     */
    set hlsManifests(value: Array<CfnOriginEndpoint.HlsManifestConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The low-latency HLS (LL-HLS) manifests associated with the origin endpoint.
     */
    get lowLatencyHlsManifests(): Array<cdk.IResolvable | CfnOriginEndpoint.LowLatencyHlsManifestConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * The low-latency HLS (LL-HLS) manifests associated with the origin endpoint.
     */
    set lowLatencyHlsManifests(value: Array<cdk.IResolvable | CfnOriginEndpoint.LowLatencyHlsManifestConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * A list of Microsoft Smooth Streaming (MSS) manifest configurations associated with the origin endpoint.
     */
    get mssManifests(): Array<cdk.IResolvable | CfnOriginEndpoint.MssManifestConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * A list of Microsoft Smooth Streaming (MSS) manifest configurations associated with the origin endpoint.
     */
    set mssManifests(value: Array<cdk.IResolvable | CfnOriginEndpoint.MssManifestConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * The name of the origin endpoint associated with the origin endpoint configuration.
     */
    get originEndpointName(): string;
    /**
     * The name of the origin endpoint associated with the origin endpoint configuration.
     */
    set originEndpointName(value: string);
    /**
     * The segment associated with the origin endpoint.
     */
    get segment(): cdk.IResolvable | CfnOriginEndpoint.SegmentProperty | undefined;
    /**
     * The segment associated with the origin endpoint.
     */
    set segment(value: cdk.IResolvable | CfnOriginEndpoint.SegmentProperty | undefined);
    /**
     * The size of the window (in seconds) to specify a window of the live stream that's available for on-demand viewing.
     */
     ...
     */
    set tags(value: Array<cdk.CfnTag> | undefined);
    get uriSeparator(): string | undefined;
    set uriSeparator(value: string | undefined);
    /**
     ...
     */
    get attrDashManifestUrls(): Array<string>;
    /**
     * The egress domain URL for stream delivery from MediaPackage.
     *
     * @cloudformationAttribute HlsManifestUrls
     */
    get attrHlsManifestUrls(): Array<string>;
    /**
     * The egress domain URL for stream delivery from MediaPackage.
     *
     * @cloudformationAttribute LowLatencyHlsManifestUrls
     */
    get attrLowLatencyHlsManifestUrls(): Array<string>;
    /**
     ...
     */
    get attrMssManifestUrls(): Array<string>;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnOriginEndpoint {
    ...
    interface ScteProperty {
         ...
         */
        readonly customAdTypes?: Array<string>;
        /**
    ...
    interface DashManifestConfigurationProperty {
         ...
         */
        readonly availabilityStartTimeConfiguration?: CfnOriginEndpoint.DashAvailabilityStartTimeConfigurationProperty | cdk.IResolvable;
        /**
...
export declare class CfnOriginEndpointPolicy extends cdk.CfnResource implements cdk.IInspectable, IOriginEndpointPolicyRef {
     ...
     * The settings to enable CDN authorization headers in MediaPackage.
     */
    get cdnAuthConfiguration(): CfnOriginEndpointPolicy.CdnAuthConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The settings to enable CDN authorization headers in MediaPackage.
     */
    set cdnAuthConfiguration(value: CfnOriginEndpointPolicy.CdnAuthConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The name of the channel group associated with the origin endpoint policy.
     */
    get channelGroupName(): string;
