...
import { AssociationReference, DocumentReference, IAssociationRef, IDocumentRef, IMaintenanceWindowRef, IMaintenanceWindowTargetRef, IMaintenanceWindowTaskRef, IOpsItemRef, IParameterRef, IPatchBaselineRef, IResourceDataSyncRef, IResourcePolicyRef, ISessionRef, MaintenanceWindowReference, MaintenanceWindowTargetReference, MaintenanceWindowTaskReference, OpsItemReference, ParameterReference, PatchBaselineReference, ResourceDataSyncReference, ResourcePolicyReference, SessionReference } from "../../interfaces/generated/aws-ssm-interfaces.generated";
/**
 ...
 */
export declare class CfnOpsItem extends cdk.CfnResource implements cdk.IInspectable, IOpsItemRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnOpsItem from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnOpsItem;
    /**
     * Checks whether the given object is a CfnOpsItem
     */
    static isCfnOpsItem(x: any): x is CfnOpsItem;
    static arnForOpsItem(resource: IOpsItemRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnOpsItemProps);
    get opsItemRef(): OpsItemReference;
    /**
     * The category of the OpsItem.
     */
     ...
     */
    get attrOpsItemArn(): string;
    /**
     * The ID of the OpsItem.
     *
     * @cloudformationAttribute OpsItemId
     */
    get attrOpsItemId(): string;
    /**
     * The type of OpsItem.
     *
     * @cloudformationAttribute OpsItemType
     */
    get attrOpsItemType(): string;
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ssm-opsitem.html
 */
export interface CfnOpsItemProps {
    /**
     * The category of the OpsItem.
     *
...
export declare class CfnSession extends cdk.CfnResource implements cdk.IInspectable, ISessionRef {
     ...
     */
    static isCfnSession(x: any): x is CfnSession;
    static arnForSession(resource: ISessionRef): string;
    /**
...
export type { IOpsItemRef, OpsItemReference };
export type { ISessionRef, SessionReference };
