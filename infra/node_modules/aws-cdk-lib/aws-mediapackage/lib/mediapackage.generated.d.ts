...
import { AssetReference, ChannelReference, HarvestJobReference, IAssetRef, IChannelRef, IHarvestJobRef, IOriginEndpointRef, IPackagingConfigurationRef, IPackagingGroupRef, OriginEndpointReference, PackagingConfigurationReference, PackagingGroupReference } from "../../interfaces/generated/aws-mediapackage-interfaces.generated";
/**
...
export declare class CfnPackagingConfiguration extends cdk.CfnResource implements cdk.IInspectable, IPackagingConfigurationRef, cdk.ITaggable {
     ...
     */
    static isCfnPackagingConfiguration(x: any): x is CfnPackagingConfiguration;
    static arnForPackagingConfiguration(resource: IPackagingConfigurationRef): string;
    /**
     ...
     * Parameters for CMAF packaging.
     */
    get cmafPackage(): CfnPackagingConfiguration.CmafPackageProperty | cdk.IResolvable | undefined;
    /**
     * Parameters for CMAF packaging.
     */
    set cmafPackage(value: CfnPackagingConfiguration.CmafPackageProperty | cdk.IResolvable | undefined);
    /**
     * Parameters for DASH-ISO packaging.
     */
    get dashPackage(): CfnPackagingConfiguration.DashPackageProperty | cdk.IResolvable | undefined;
    /**
     * Parameters for DASH-ISO packaging.
     */
    set dashPackage(value: CfnPackagingConfiguration.DashPackageProperty | cdk.IResolvable | undefined);
    /**
     * Parameters for Apple HLS packaging.
     */
    get hlsPackage(): CfnPackagingConfiguration.HlsPackageProperty | cdk.IResolvable | undefined;
    /**
     * Parameters for Apple HLS packaging.
     */
    set hlsPackage(value: CfnPackagingConfiguration.HlsPackageProperty | cdk.IResolvable | undefined);
    /**
     * Unique identifier that you assign to the packaging configuration.
     */
    get id(): string;
     ...
     * Parameters for Microsoft Smooth Streaming packaging.
     */
    get mssPackage(): cdk.IResolvable | CfnPackagingConfiguration.MssPackageProperty | undefined;
    /**
     * Parameters for Microsoft Smooth Streaming packaging.
     */
    set mssPackage(value: cdk.IResolvable | CfnPackagingConfiguration.MssPackageProperty | undefined);
    /**
     * The ID of the packaging group associated with this packaging configuration.
     */
    get packagingGroupId(): string;
...
export declare class CfnPackagingGroup extends cdk.CfnResource implements cdk.IInspectable, IPackagingGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnPackagingGroup(x: any): x is CfnPackagingGroup;
    static arnForPackagingGroup(resource: IPackagingGroupRef): string;
    /**
     * Parameters for CDN authorization.
     */
    private _authorization?;
     ...
     * Parameters for CDN authorization.
     */
    get authorization(): CfnPackagingGroup.AuthorizationProperty | cdk.IResolvable | undefined;
    /**
     * Parameters for CDN authorization.
     */
    set authorization(value: CfnPackagingGroup.AuthorizationProperty | cdk.IResolvable | undefined);
    /**
     * The configuration parameters for egress access logging.
     */
    get egressAccessLogs(): cdk.IResolvable | CfnPackagingGroup.LogConfigurationProperty | undefined;
    /**
     * The configuration parameters for egress access logging.
     */
    set egressAccessLogs(value: cdk.IResolvable | CfnPackagingGroup.LogConfigurationProperty | undefined);
    /**
     * Unique identifier that you assign to the packaging group.
     */
    get id(): string;
 ...
 */
export declare class CfnHarvestJob extends cdk.CfnResource implements cdk.IInspectable, IHarvestJobRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnHarvestJob from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnHarvestJob;
    /**
     * Checks whether the given object is a CfnHarvestJob
     */
    static isCfnHarvestJob(x: any): x is CfnHarvestJob;
    static arnForHarvestJob(resource: IHarvestJobRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnHarvestJobProps);
    get harvestJobRef(): HarvestJobReference;
    /**
     * The end of the time-window which will be harvested.
     */
    get endTime(): string;
     ...
     * The ID of the OriginEndpoint that the HarvestJob will harvest from.
     */
    get originEndpointId(): string;
    /**
     * The ID of the OriginEndpoint that the HarvestJob will harvest from.
     */
    set originEndpointId(value: string);
    /**
     * Configuration parameters for where in an S3 bucket to place the harvested content.
     */
    get s3Destination(): cdk.IResolvable | CfnHarvestJob.S3DestinationProperty;
    /**
     * Configuration parameters for where in an S3 bucket to place the harvested content.
     */
    set s3Destination(value: cdk.IResolvable | CfnHarvestJob.S3DestinationProperty);
    /**
     * The start of the time-window which will be harvested.
     */
...
export declare namespace CfnHarvestJob {
    /**
     * Configuration parameters for where in an S3 bucket to place the harvested content.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediapackage-harvestjob.html
 */
export interface CfnHarvestJobProps {
    /**
     * The end of the time-window which will be harvested.
     *
     ...
     */
    readonly s3Destination: cdk.IResolvable | CfnHarvestJob.S3DestinationProperty;
    /**
     * The start of the time-window which will be harvested.
     *
...
export type { IPackagingConfigurationRef, PackagingConfigurationReference };
export type { IPackagingGroupRef, PackagingGroupReference };
export type { IHarvestJobRef, HarvestJobReference };
